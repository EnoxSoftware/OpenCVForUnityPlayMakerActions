...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void softNMSBoxes(MatOfRect bboxes, MatOfFloat scores, MatOfFloat updated_scores, float score_threshold, float nms_threshold, MatOfInt indices, long top_k, float sigma)")]
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.Long), "top_k")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "sigma")]
    public class Dnn_softNMSBoxes : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.ActionSection("[arg7] long(Long)")]
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.UIHint(HutongGames.PlayMaker.UIHint.Variable)]
        [HutongGames.PlayMaker.ObjectType(typeof(OpenCVForUnityPlayMakerActions.Long))]
        public HutongGames.PlayMaker.FsmObject top_k;
        ...
        void DoProcess()
        {
            ...
            if (!(top_k.Value is OpenCVForUnityPlayMakerActions.Long))
            {
                LogError("top_k is not initialized. Add Action \"newLong\".");
                return;
            }
            System.Int64 wrapped_top_k = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Long, System.Int64>(top_k);

            OpenCVForUnity.DnnModule.Dnn.softNMSBoxes(wrapped_bboxes, wrapped_scores, wrapped_updated_scores, score_threshold.Value, nms_threshold.Value, wrapped_indices, wrapped_top_k, sigma.Value);
