...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void NMSBoxesBatched(MatOfRect2d bboxes, MatOfFloat scores, MatOfInt class_ids, float score_threshold, float nms_threshold, MatOfInt indices)")]
    ...
    public class Dnn_NMSBoxesBatched_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.DnnModule.Dnn.NMSBoxesBatched(wrapped_bboxes, wrapped_scores, wrapped_class_ids, score_threshold.Value, nms_threshold.Value, wrapped_indices);
