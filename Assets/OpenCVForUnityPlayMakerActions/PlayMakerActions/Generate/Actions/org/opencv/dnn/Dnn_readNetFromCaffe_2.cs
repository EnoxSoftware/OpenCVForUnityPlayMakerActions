...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Dnn_readNetFromCaffe_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Net)storeResult.Value).wrappedObject = OpenCVForUnity.DnnModule.Dnn.readNetFromCaffe (wrapped_bufferProto, wrapped_bufferModel);
