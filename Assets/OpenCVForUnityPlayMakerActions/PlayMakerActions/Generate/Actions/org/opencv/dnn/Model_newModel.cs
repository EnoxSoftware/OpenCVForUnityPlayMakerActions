...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public Model(string model, string config)")]
    ...
    public class Model_newModel : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Model)storeResult.Value).wrappedObject = new OpenCVForUnity.DnnModule.Model(model.Value, config.Value);
