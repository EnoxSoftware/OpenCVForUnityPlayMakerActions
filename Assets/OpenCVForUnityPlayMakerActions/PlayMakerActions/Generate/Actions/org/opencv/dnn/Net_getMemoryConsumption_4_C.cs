...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Net_getMemoryConsumption_4_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.getMemoryConsumption (wrapped_netInputShapes, casted_weights, casted_blobs);
