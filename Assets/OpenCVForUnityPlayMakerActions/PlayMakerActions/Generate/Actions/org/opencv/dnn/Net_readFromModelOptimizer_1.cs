...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static Net readFromModelOptimizer(MatOfByte bufferModelConfig, MatOfByte bufferWeights)")]
    ...
    public class Net_readFromModelOptimizer_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Net)storeResult.Value).wrappedObject = OpenCVForUnity.DnnModule.Net.readFromModelOptimizer(wrapped_bufferModelConfig, wrapped_bufferWeights);
