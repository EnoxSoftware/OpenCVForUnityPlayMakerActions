...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public TextDetectionModel_EAST setNMSThreshold(float nmsThreshold)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TextDetectionModel_EAST), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "nmsThreshold")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TextDetectionModel_EAST), "storeResult")]
    public class TextDetectionModel_EAST_setNMSThreshold : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat nmsThreshold;
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TextDetectionModel_EAST)storeResult.Value).wrappedObject = wrapped_owner.setNMSThreshold(nmsThreshold.Value);
