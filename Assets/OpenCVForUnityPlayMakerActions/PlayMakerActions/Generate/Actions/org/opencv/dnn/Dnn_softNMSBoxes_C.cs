...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Dnn_softNMSBoxes_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.ActionSection("[arg7] long(int)")]
        [HutongGames.PlayMaker.RequiredField]
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.DnnModule.Dnn.softNMSBoxes(wrapped_bboxes, wrapped_scores, wrapped_updated_scores, score_threshold.Value, nms_threshold.Value, wrapped_indices, (int)top_k.Value, sigma.Value);
