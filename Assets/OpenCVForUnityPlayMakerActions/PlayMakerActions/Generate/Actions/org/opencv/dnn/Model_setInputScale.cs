...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Model_setInputScale : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Model)storeResult.Value).wrappedObject = wrapped_owner.setInputScale(wrapped_scale);
