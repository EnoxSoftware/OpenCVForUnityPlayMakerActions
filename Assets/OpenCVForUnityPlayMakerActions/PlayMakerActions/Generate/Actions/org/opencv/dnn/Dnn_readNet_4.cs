...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Dnn_readNet_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Net)storeResult.Value).wrappedObject = OpenCVForUnity.Dnn.readNet (model.Value);
