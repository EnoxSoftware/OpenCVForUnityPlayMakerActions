...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setParam(string layerName, int numParam, Mat blob)")]
    ...
    public class Net_setParam_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setParam(layerName.Value, numParam.Value, wrapped_blob);
