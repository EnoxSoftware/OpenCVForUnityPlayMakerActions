...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void NMSBoxes (MatOfRect2d bboxes, MatOfFloat scores, float score_threshold, float nms_threshold, MatOfInt indices)")]
    ...
    public class Dnn_NMSBoxes_5 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.DnnModule.Dnn.NMSBoxes (wrapped_bboxes, wrapped_scores, score_threshold.Value, nms_threshold.Value, wrapped_indices);
