...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Model_setInputParams_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setInputParams((float)scale.Value, wrapped_size, wrapped_mean, swapRB.Value, crop.Value);
