...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void shrinkCaffeModel(string src, string dst)")]
    ...
    public class Dnn_shrinkCaffeModel_1 : HutongGames.PlayMaker.FsmStateAction
    {
