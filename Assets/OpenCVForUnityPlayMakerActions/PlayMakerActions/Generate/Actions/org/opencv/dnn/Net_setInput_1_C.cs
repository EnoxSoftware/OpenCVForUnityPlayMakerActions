...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setInput(Mat blob, string name, double scalefactor)")]
    ...
    public class Net_setInput_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setInput(wrapped_blob, name.Value, (float)scalefactor.Value);
