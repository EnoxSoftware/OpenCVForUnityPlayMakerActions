...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Dnn_blobFromImage : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.DnnModule.Dnn.blobFromImage(wrapped_image, wrapped_scalefactor, wrapped_size, wrapped_mean, swapRB.Value, crop.Value, ddepth.Value);
