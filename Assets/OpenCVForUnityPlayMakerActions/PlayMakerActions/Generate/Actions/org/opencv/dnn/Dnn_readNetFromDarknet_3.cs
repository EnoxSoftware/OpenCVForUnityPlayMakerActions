...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static Net readNetFromDarknet (MatOfByte bufferCfg)")]
    ...
    public class Dnn_readNetFromDarknet_3 : HutongGames.PlayMaker.FsmStateAction
    {
