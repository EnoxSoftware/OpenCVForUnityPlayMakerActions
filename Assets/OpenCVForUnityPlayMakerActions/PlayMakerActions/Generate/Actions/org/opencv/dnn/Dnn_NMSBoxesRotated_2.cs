...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void NMSBoxesRotated(MatOfRotatedRect bboxes, MatOfFloat scores, float score_threshold, float nms_threshold, MatOfInt indices)")]
    ...
    public class Dnn_NMSBoxesRotated_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.DnnModule.Dnn.NMSBoxesRotated(wrapped_bboxes, wrapped_scores, score_threshold.Value, nms_threshold.Value, wrapped_indices);
