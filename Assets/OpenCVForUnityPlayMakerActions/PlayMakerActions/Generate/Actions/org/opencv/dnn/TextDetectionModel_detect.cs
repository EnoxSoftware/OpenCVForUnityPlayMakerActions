...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void detect(Mat frame, List<MatOfPoint> detections, MatOfFloat confidences)")]
    ...
    public class TextDetectionModel_detect : HutongGames.PlayMaker.FsmStateAction
    {
