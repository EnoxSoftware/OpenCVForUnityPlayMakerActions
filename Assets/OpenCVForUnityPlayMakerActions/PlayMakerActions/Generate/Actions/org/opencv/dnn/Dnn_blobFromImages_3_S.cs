...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Dnn_blobFromImages_3_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Dnn.blobFromImages (wrapped_images, wrapped_scalefactor, new OpenCVForUnity.Size ((double)size_width.Value, (double)size_height.Value));
