...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Model_setInputParams_3_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setInputParams((float)scale.Value, new OpenCVForUnity.CoreModule.Size((double)size_width.Value, (double)size_height.Value));
