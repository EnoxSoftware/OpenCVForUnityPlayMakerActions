...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Dnn_readNetFromTorch_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Net)storeResult.Value).wrappedObject = OpenCVForUnity.DnnModule.Dnn.readNetFromTorch(model.Value);
