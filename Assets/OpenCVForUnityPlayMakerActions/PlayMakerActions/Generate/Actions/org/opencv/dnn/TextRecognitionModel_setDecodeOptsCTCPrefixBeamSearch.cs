...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public TextRecognitionModel setDecodeOptsCTCPrefixBeamSearch(int beamSize, int vocPruneSize)")]
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "vocPruneSize")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TextRecognitionModel), "storeResult")]
    public class TextRecognitionModel_setDecodeOptsCTCPrefixBeamSearch : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.ObjectType(typeof(HutongGames.PlayMaker.FsmInt))]
        public HutongGames.PlayMaker.FsmInt vocPruneSize;
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TextRecognitionModel)storeResult.Value).wrappedObject = wrapped_owner.setDecodeOptsCTCPrefixBeamSearch(beamSize.Value, vocPruneSize.Value);
