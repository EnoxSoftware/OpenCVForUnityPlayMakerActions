...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Dnn_blobFromImages : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Dnn.blobFromImages (wrapped_images, wrapped_scalefactor, wrapped_size, wrapped_mean, swapRB.Value, crop.Value);
