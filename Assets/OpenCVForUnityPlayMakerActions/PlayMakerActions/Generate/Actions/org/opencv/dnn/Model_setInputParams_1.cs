...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Model_setInputParams_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setInputParams(wrapped_scale, wrapped_size, wrapped_mean, swapRB.Value);
