...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public MatOfPoint2f estimate(Mat frame, float thresh)")]
    ...
    public class KeypointsModel_estimate : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MatOfPoint2f)storeResult.Value).wrappedObject = wrapped_owner.estimate(wrapped_frame, thresh.Value);
