...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setPreferableTarget (int targetId)")]
    ...
    public class Net_setPreferableTarget : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setPreferableTarget (targetId.Value);
