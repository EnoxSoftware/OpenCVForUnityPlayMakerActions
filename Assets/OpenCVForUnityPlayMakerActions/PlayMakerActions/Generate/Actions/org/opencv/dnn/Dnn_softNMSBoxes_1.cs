...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void softNMSBoxes(MatOfRect bboxes, MatOfFloat scores, MatOfFloat updated_scores, float score_threshold, float nms_threshold, MatOfInt indices, long top_k)")]
    ...
    public class Dnn_softNMSBoxes_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.DnnModule.Dnn.softNMSBoxes(wrapped_bboxes, wrapped_scores, wrapped_updated_scores, score_threshold.Value, nms_threshold.Value, wrapped_indices, wrapped_top_k);
