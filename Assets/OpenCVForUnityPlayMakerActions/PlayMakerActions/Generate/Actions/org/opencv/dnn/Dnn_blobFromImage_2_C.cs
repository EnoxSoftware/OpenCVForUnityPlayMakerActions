...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Dnn_blobFromImage_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.DnnModule.Dnn.blobFromImage(wrapped_image, (float)scalefactor.Value, wrapped_size, wrapped_mean, swapRB.Value);
