...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static Net readFromModelOptimizer(string xml, string bin)")]
    ...
    public class Net_readFromModelOptimizer : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Net)storeResult.Value).wrappedObject = OpenCVForUnity.DnnModule.Net.readFromModelOptimizer(xml.Value, bin.Value);
