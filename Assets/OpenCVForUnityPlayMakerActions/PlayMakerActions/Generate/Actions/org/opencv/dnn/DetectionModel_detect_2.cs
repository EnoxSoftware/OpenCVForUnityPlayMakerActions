...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void detect(Mat frame, MatOfInt classIds, MatOfFloat confidences, MatOfRect boxes)")]
    ...
    public class DetectionModel_detect_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.detect(wrapped_frame, wrapped_classIds, wrapped_confidences, wrapped_boxes);
