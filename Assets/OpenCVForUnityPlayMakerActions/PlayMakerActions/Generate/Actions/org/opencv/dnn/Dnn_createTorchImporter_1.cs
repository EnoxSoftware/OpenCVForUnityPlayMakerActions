...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static Importer createTorchImporter (string filename)")]
    ...
    public class Dnn_createTorchImporter_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Importer)storeResult.Value).wrappedObject = OpenCVForUnity.Dnn.createTorchImporter (filename.Value);
