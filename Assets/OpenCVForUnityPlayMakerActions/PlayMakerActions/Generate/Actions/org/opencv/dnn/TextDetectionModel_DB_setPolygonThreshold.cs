...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public TextDetectionModel_DB setPolygonThreshold(float polygonThreshold)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TextDetectionModel_DB), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "polygonThreshold")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TextDetectionModel_DB), "storeResult")]
    public class TextDetectionModel_DB_setPolygonThreshold : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat polygonThreshold;
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TextDetectionModel_DB)storeResult.Value).wrappedObject = wrapped_owner.setPolygonThreshold(polygonThreshold.Value);
