...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Dnn_readNetFromTensorflow_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Net)storeResult.Value).wrappedObject = OpenCVForUnity.DnnModule.Dnn.readNetFromTensorflow(model.Value);
