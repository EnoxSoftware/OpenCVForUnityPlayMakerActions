...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_samplerTrackMaxPosNum(int samplerTrackMaxPosNum)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerMIL_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "samplerTrackMaxPosNum")]
    public class TrackerMIL_Params_set_samplerTrackMaxPosNum : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt samplerTrackMaxPosNum;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_samplerTrackMaxPosNum(samplerTrackMaxPosNum.Value);
