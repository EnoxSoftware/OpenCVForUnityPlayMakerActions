...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Video_computeECC : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = OpenCVForUnity.VideoModule.Video.computeECC(wrapped_templateImage, wrapped_inputImage, wrapped_inputMask);
