...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Video_createBackgroundSubtractorMOG2_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.BackgroundSubtractorMOG2)storeResult.Value).wrappedObject = OpenCVForUnity.VideoModule.Video.createBackgroundSubtractorMOG2();
