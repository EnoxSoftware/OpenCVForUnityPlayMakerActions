...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public virtual void apply (Mat image, Mat fgmask)")]
    ...
    public class BackgroundSubtractor_apply_1 : HutongGames.PlayMaker.FsmStateAction
    {
