...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Video_createBackgroundSubtractorKNN_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.BackgroundSubtractorKNN)storeResult.Value).wrappedObject = OpenCVForUnity.Video.createBackgroundSubtractorKNN (history.Value, (float)dist2Threshold.Value, detectShadows.Value);
