...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Video_buildOpticalFlowPyramid_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Video.buildOpticalFlowPyramid (wrapped_img, wrapped_pyramid, wrapped_winSize, maxLevel.Value, withDerivatives.Value, pyrBorder.Value);
