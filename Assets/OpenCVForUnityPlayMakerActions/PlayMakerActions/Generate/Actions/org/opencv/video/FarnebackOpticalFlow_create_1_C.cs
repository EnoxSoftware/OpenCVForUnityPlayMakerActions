...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class FarnebackOpticalFlow_create_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.FarnebackOpticalFlow)storeResult.Value).wrappedObject = OpenCVForUnity.FarnebackOpticalFlow.create (numLevels.Value, (float)pyrScale.Value, fastPyramids.Value, winSize.Value, numIters.Value, polyN.Value, (float)polySigma.Value);
