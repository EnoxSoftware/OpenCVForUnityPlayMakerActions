...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class SparsePyrLKOpticalFlow_create_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SparsePyrLKOpticalFlow)storeResult.Value).wrappedObject = OpenCVForUnity.SparsePyrLKOpticalFlow.create (wrapped_winSize, maxLevel.Value, wrapped_crit);
