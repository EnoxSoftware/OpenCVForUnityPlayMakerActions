...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_samplerTrackMaxNegNum(int samplerTrackMaxNegNum)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerMIL_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "samplerTrackMaxNegNum")]
    public class TrackerMIL_Params_set_samplerTrackMaxNegNum : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt samplerTrackMaxNegNum;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_samplerTrackMaxNegNum(samplerTrackMaxNegNum.Value);
