...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static Mat estimateRigidTransform (Mat src, Mat dst, bool fullAffine)")]
    ...
    public class Video_estimateRigidTransform_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Video.estimateRigidTransform (wrapped_src, wrapped_dst, fullAffine.Value);
