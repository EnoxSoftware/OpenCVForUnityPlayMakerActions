...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class KalmanFilter_set_errorCovPost : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Mat wrapped_errorCovPost = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.CoreModule.Mat>(errorCovPost);
