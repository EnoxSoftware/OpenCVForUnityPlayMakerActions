...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setScaleStep (double val)")]
    ...
    public class DualTVL1OpticalFlow_setScaleStep_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setScaleStep ((float)val.Value);
