...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class BackgroundSubtractorMOG2_getVarThresholdGen_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = (float)wrapped_owner.getVarThresholdGen ();
