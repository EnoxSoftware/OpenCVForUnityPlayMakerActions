...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Video_createBackgroundSubtractorMOG2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.BackgroundSubtractorMOG2)storeResult.Value).wrappedObject = OpenCVForUnity.Video.createBackgroundSubtractorMOG2 (history.Value, wrapped_varThreshold, detectShadows.Value);
