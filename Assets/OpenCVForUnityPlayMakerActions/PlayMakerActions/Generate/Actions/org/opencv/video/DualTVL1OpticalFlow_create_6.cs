...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class DualTVL1OpticalFlow_create_6 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.DualTVL1OpticalFlow)storeResult.Value).wrappedObject = OpenCVForUnity.DualTVL1OpticalFlow.create (wrapped_tau, wrapped_lambda, wrapped_theta, nscales.Value, warps.Value, wrapped_epsilon);
