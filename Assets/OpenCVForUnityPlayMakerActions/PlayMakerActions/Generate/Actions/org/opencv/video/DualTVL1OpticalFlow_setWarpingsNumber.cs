...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setWarpingsNumber (int val)")]
    ...
    public class DualTVL1OpticalFlow_setWarpingsNumber : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setWarpingsNumber (val.Value);
