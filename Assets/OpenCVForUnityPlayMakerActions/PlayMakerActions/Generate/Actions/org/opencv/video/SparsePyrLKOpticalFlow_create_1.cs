...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class SparsePyrLKOpticalFlow_create_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SparsePyrLKOpticalFlow)storeResult.Value).wrappedObject = OpenCVForUnity.VideoModule.SparsePyrLKOpticalFlow.create (wrapped_winSize, maxLevel.Value, wrapped_crit, flags.Value);
