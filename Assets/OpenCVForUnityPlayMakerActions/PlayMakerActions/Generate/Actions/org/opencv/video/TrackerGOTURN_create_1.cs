...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class TrackerGOTURN_create_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TrackerGOTURN)storeResult.Value).wrappedObject = OpenCVForUnity.VideoModule.TrackerGOTURN.create();
