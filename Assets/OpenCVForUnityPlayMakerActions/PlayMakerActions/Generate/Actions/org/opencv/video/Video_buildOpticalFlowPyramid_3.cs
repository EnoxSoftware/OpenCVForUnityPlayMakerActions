...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static int buildOpticalFlowPyramid(Mat img, List<Mat> pyramid, Size winSize, int maxLevel, bool withDerivatives)")]
    ...
    public class Video_buildOpticalFlowPyramid_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.VideoModule.Video.buildOpticalFlowPyramid(wrapped_img, wrapped_pyramid, wrapped_winSize, maxLevel.Value, withDerivatives.Value);
