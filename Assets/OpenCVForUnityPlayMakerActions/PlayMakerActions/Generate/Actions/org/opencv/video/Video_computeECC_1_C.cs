...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Video_computeECC_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.VideoModule.Video.computeECC(wrapped_templateImage, wrapped_inputImage);
