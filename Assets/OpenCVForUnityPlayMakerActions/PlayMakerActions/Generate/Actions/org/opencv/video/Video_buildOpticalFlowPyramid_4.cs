...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Video_buildOpticalFlowPyramid_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.VideoModule.Video.buildOpticalFlowPyramid(wrapped_img, wrapped_pyramid, wrapped_winSize, maxLevel.Value);
