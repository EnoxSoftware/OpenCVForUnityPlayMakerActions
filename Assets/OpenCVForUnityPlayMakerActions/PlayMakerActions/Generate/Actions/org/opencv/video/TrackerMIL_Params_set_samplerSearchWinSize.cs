...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_samplerSearchWinSize(float samplerSearchWinSize)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerMIL_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "samplerSearchWinSize")]
    public class TrackerMIL_Params_set_samplerSearchWinSize : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat samplerSearchWinSize;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_samplerSearchWinSize(samplerSearchWinSize.Value);
