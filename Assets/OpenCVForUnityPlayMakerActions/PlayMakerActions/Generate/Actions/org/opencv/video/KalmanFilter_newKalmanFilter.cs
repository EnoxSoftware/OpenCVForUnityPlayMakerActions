...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class KalmanFilter_newKalmanFilter : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.KalmanFilter)storeResult.Value).wrappedObject = new OpenCVForUnity.KalmanFilter (dynamParams.Value, measureParams.Value, controlParams.Value, type.Value);
