...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public  void setMedianFiltering (int val)")]
    ...
    public class DualTVL1OpticalFlow_setMedianFiltering : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setMedianFiltering (val.Value);
