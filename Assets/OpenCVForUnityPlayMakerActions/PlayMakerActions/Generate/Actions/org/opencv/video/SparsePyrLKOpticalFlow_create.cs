...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class SparsePyrLKOpticalFlow_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SparsePyrLKOpticalFlow)storeResult.Value).wrappedObject = OpenCVForUnity.SparsePyrLKOpticalFlow.create (wrapped_winSize, maxLevel.Value, wrapped_crit, flags.Value, wrapped_minEigThreshold);
