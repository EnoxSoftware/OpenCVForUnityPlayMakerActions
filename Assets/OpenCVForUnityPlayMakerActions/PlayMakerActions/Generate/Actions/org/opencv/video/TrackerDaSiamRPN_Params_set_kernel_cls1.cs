...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_kernel_cls1(string kernel_cls1)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerDaSiamRPN_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmString), "kernel_cls1")]
    public class TrackerDaSiamRPN_Params_set_kernel_cls1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmString kernel_cls1;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_kernel_cls1(kernel_cls1.Value);
