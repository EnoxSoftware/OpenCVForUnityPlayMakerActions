...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class DualTVL1OpticalFlow_create_6_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.DualTVL1OpticalFlow)storeResult.Value).wrappedObject = OpenCVForUnity.DualTVL1OpticalFlow.create ((float)tau.Value, (float)lambda.Value, (float)theta.Value, nscales.Value, warps.Value, (float)epsilon.Value);
