...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class SparsePyrLKOpticalFlow_create_2_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SparsePyrLKOpticalFlow)storeResult.Value).wrappedObject = OpenCVForUnity.SparsePyrLKOpticalFlow.create (new OpenCVForUnity.Size ((double)winSize_width.Value, (double)winSize_height.Value), maxLevel.Value, new OpenCVForUnity.TermCriteria ((int)crit_type.Value, (int)crit_maxCount.Value, (double)crit_epsilon.Value));
