...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class KalmanFilter_set_transitionMatrix : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Mat wrapped_transitionMatrix = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.Mat> (transitionMatrix);
