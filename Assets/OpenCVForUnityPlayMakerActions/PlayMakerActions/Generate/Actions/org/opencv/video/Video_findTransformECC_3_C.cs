...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Video_findTransformECC_3_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.VideoModule.Video.findTransformECC(wrapped_templateImage, wrapped_inputImage, wrapped_warpMatrix, motionType.Value);
