...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Video_buildOpticalFlowPyramid_2_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Video.buildOpticalFlowPyramid (wrapped_img, wrapped_pyramid, new OpenCVForUnity.Size ((double)winSize_width.Value, (double)winSize_height.Value), maxLevel.Value, withDerivatives.Value, pyrBorder.Value);
