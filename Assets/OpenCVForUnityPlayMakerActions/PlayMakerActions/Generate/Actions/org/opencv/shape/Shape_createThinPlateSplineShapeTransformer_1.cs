...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createThinPlateSplineShapeTransformer_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ThinPlateSplineShapeTransformer)storeResult.Value).wrappedObject = OpenCVForUnity.Shape.createThinPlateSplineShapeTransformer ();
