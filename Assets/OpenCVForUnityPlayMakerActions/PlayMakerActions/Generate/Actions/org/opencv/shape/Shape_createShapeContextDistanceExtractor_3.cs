...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createShapeContextDistanceExtractor_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ShapeContextDistanceExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.Shape.createShapeContextDistanceExtractor (nAngularBins.Value, nRadialBins.Value, innerRadius.Value, outerRadius.Value);
