...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createEMDL1HistogramCostExtractor_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HistogramCostExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.Shape.createEMDL1HistogramCostExtractor (nDummies.Value);
