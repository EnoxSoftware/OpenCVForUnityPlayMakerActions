...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createChiHistogramCostExtractor : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HistogramCostExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.Shape.createChiHistogramCostExtractor (nDummies.Value, defaultCost.Value);
