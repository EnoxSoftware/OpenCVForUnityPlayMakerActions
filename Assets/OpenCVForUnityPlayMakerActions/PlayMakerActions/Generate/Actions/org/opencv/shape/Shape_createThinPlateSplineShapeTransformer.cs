...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createThinPlateSplineShapeTransformer : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ThinPlateSplineShapeTransformer)storeResult.Value).wrappedObject = OpenCVForUnity.Shape.createThinPlateSplineShapeTransformer (wrapped_regularizationParameter);
