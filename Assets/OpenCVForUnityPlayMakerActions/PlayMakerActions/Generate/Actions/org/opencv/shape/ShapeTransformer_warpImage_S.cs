...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class ShapeTransformer_warpImage_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.warpImage (wrapped_transformingImage, wrapped_output, flags.Value, borderMode.Value, new OpenCVForUnity.Scalar ((double)borderValue_v0.Value, (double)borderValue_v1.Value, (double)borderValue_v2.Value, (double)borderValue_v3.Value));
