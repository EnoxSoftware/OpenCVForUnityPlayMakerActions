...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createEMDHistogramCostExtractor : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HistogramCostExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.Shape.createEMDHistogramCostExtractor (flag.Value, nDummies.Value, defaultCost.Value);
