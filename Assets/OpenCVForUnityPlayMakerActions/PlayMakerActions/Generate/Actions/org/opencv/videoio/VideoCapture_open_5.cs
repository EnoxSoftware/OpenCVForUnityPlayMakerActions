...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool open(int index, int apiPreference, MatOfInt _params)")]
    ...
    public class VideoCapture_open_5 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.open(index.Value, apiPreference.Value, wrapped__params);
