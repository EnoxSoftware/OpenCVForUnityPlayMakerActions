...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class VideoWriter_newVideoWriter_3_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.VideoWriter)storeResult.Value).wrappedObject = new OpenCVForUnity.VideoioModule.VideoWriter(filename.Value, apiPreference.Value, fourcc.Value, (float)fps.Value, wrapped_frameSize, isColor.Value);
