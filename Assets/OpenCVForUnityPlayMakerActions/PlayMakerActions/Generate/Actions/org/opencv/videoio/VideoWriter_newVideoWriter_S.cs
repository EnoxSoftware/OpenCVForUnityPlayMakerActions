...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class VideoWriter_newVideoWriter_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.VideoWriter)storeResult.Value).wrappedObject = new OpenCVForUnity.VideoWriter (filename.Value, apiPreference.Value, fourcc.Value, wrapped_fps, new OpenCVForUnity.Size ((double)frameSize_width.Value, (double)frameSize_height.Value), isColor.Value);
