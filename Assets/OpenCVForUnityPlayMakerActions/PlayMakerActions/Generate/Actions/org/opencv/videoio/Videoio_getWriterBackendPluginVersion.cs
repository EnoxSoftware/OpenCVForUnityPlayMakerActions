...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static string getWriterBackendPluginVersion(int api, int[] version_ABI, int[] version_API)")]
    ...
    public class Videoio_getWriterBackendPluginVersion : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.VideoioModule.Videoio.getWriterBackendPluginVersion(api.Value, version_ABI.intValues, version_API.intValues);
