...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class VideoWriter_open_3_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = wrapped_owner.open (filename.Value, fourcc.Value, (float)fps.Value, new OpenCVForUnity.Size ((double)frameSize_width.Value, (double)frameSize_height.Value));
