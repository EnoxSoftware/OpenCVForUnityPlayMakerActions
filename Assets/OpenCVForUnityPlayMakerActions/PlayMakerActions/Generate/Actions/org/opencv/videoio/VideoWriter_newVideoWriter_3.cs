...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class VideoWriter_newVideoWriter_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.VideoWriter)storeResult.Value).wrappedObject = new OpenCVForUnity.VideoWriter (filename.Value, fourcc.Value, wrapped_fps, wrapped_frameSize);
