...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class VideoWriter_open_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.open(filename.Value, fourcc.Value, wrapped_fps, wrapped_frameSize, wrapped__params);
