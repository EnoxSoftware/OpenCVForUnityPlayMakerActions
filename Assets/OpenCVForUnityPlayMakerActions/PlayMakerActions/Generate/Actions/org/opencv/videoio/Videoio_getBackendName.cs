...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static string getBackendName (int api)")]
    ...
    public class Videoio_getBackendName : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.VideoioModule.Videoio.getBackendName (api.Value);
