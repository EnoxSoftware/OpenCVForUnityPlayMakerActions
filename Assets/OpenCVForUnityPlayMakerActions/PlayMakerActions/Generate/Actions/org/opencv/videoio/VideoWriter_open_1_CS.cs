...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool open(string filename, int apiPreference, int fourcc, double fps, Size frameSize)")]
    ...
    public class VideoWriter_open_1_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.open(filename.Value, apiPreference.Value, fourcc.Value, (float)fps.Value, new OpenCVForUnity.CoreModule.Size((double)frameSize_width.Value, (double)frameSize_height.Value));
