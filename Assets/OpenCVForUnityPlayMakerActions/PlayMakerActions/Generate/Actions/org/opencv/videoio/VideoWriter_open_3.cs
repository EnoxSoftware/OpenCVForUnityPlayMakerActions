...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class VideoWriter_open_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.open(filename.Value, apiPreference.Value, fourcc.Value, wrapped_fps, wrapped_frameSize);
