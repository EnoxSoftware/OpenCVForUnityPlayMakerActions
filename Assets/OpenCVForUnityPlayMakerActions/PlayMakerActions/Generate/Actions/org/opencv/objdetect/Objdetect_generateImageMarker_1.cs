...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void generateImageMarker(Dictionary dictionary, int id, int sidePixels, Mat img)")]
    ...
    public class Objdetect_generateImageMarker_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ObjdetectModule.Objdetect.generateImageMarker(wrapped_dictionary, id.Value, sidePixels.Value, wrapped_img);
