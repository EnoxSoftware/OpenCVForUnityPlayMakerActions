...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Objdetect_drawDetectedCornersCharuco_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ObjdetectModule.Objdetect.drawDetectedCornersCharuco(wrapped_image, wrapped_charucoCorners, wrapped_charucoIds, new OpenCVForUnity.CoreModule.Scalar((double)cornerColor_v0.Value, (double)cornerColor_v1.Value, (double)cornerColor_v2.Value, (double)cornerColor_v3.Value));
