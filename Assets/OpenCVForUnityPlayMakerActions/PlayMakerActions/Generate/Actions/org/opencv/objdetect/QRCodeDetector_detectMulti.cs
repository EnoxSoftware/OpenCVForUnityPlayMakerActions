...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool detectMulti(Mat img, Mat points)")]
    ...
    public class QRCodeDetector_detectMulti : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.detectMulti(wrapped_img, wrapped_points);
