...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class HOGDescriptor_computeGradient_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.computeGradient (wrapped_img, wrapped_grad, wrapped_angleOfs, new OpenCVForUnity.CoreModule.Size ((double)paddingTL_width.Value, (double)paddingTL_height.Value), new OpenCVForUnity.CoreModule.Size ((double)paddingBR_width.Value, (double)paddingBR_height.Value));
