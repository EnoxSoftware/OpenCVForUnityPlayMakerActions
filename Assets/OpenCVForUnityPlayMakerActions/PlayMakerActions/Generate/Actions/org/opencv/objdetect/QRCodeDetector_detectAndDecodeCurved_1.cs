...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public string detectAndDecodeCurved(Mat img, Mat points)")]
    ...
    public class QRCodeDetector_detectAndDecodeCurved_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.detectAndDecodeCurved(wrapped_img, wrapped_points);
