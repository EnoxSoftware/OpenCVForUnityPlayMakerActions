...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_minSideLengthCanonicalImg(int minSideLengthCanonicalImg)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.DetectorParameters), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "minSideLengthCanonicalImg")]
    public class DetectorParameters_set_minSideLengthCanonicalImg : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt minSideLengthCanonicalImg;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_minSideLengthCanonicalImg(minSideLengthCanonicalImg.Value);
