...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class HOGDescriptor_detect_2_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.detect (wrapped_img, wrapped_foundLocations, wrapped_weights, wrapped_hitThreshold, new OpenCVForUnity.CoreModule.Size ((double)winStride_width.Value, (double)winStride_height.Value));
