...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class HOGDescriptor_detect_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.detect(wrapped_img, wrapped_foundLocations, wrapped_weights, (float)hitThreshold.Value, wrapped_winStride, wrapped_padding);
