...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class CascadeClassifier_detectMultiScale2_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.detectMultiScale2(wrapped_image, wrapped_objects, wrapped_numDetections, wrapped_scaleFactor, minNeighbors.Value, flags.Value);
