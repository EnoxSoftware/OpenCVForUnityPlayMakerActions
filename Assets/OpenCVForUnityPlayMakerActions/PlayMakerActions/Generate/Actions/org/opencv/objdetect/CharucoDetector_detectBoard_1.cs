...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void detectBoard(Mat image, Mat charucoCorners, Mat charucoIds, List<Mat> markerCorners)")]
    ...
    public class CharucoDetector_detectBoard_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.detectBoard(wrapped_image, wrapped_charucoCorners, wrapped_charucoIds, wrapped_markerCorners);
