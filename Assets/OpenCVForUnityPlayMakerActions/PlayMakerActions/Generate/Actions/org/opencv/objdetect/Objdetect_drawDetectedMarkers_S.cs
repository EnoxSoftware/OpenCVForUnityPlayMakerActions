...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Objdetect_drawDetectedMarkers_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ObjdetectModule.Objdetect.drawDetectedMarkers(wrapped_image, wrapped_corners, wrapped_ids, new OpenCVForUnity.CoreModule.Scalar((double)borderColor_v0.Value, (double)borderColor_v1.Value, (double)borderColor_v2.Value, (double)borderColor_v3.Value));
