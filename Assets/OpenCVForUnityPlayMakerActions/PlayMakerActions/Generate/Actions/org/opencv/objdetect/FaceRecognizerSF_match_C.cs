...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class FaceRecognizerSF_match_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (float)wrapped_owner.match(wrapped__face_feature1, wrapped__face_feature2, dis_type.Value);
