...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void generateImageMarker(int id, int sidePixels, Mat _img, int borderBits)")]
    ...
    public class Dictionary_generateImageMarker : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.generateImageMarker(id.Value, sidePixels.Value, wrapped__img, borderBits.Value);
