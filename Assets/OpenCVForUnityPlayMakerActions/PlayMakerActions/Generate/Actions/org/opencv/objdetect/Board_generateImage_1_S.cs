...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Board_generateImage_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.generateImage(new OpenCVForUnity.CoreModule.Size((double)outSize_width.Value, (double)outSize_height.Value), wrapped_img, marginSize.Value);
