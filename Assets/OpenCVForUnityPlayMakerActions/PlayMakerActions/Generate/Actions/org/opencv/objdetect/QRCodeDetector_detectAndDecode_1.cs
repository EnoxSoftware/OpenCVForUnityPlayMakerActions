...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public string detectAndDecode(Mat img, Mat points)")]
    ...
    public class QRCodeDetector_detectAndDecode_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.detectAndDecode(wrapped_img, wrapped_points);
