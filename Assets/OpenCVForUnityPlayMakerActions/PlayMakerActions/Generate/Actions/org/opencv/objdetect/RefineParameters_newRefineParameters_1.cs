...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public RefineParameters(float minRepDistance, float errorCorrectionRate)")]
    ...
    public class RefineParameters_newRefineParameters_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.RefineParameters)storeResult.Value).wrappedObject = new OpenCVForUnity.ObjdetectModule.RefineParameters(minRepDistance.Value, errorCorrectionRate.Value);
