...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class CascadeClassifier_detectMultiScale2_1_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.detectMultiScale2 (wrapped_image, wrapped_objects, wrapped_numDetections, (float)scaleFactor.Value, minNeighbors.Value, flags.Value, new OpenCVForUnity.Size ((double)minSize_width.Value, (double)minSize_height.Value));
