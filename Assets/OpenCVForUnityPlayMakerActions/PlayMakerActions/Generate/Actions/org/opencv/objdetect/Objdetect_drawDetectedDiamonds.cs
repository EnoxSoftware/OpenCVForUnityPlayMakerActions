...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Objdetect_drawDetectedDiamonds : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ObjdetectModule.Objdetect.drawDetectedDiamonds(wrapped_image, wrapped_diamondCorners, wrapped_diamondIds, wrapped_borderColor);
