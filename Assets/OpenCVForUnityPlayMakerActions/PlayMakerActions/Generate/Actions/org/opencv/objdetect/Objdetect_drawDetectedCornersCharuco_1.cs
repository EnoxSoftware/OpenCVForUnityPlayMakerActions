...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Objdetect_drawDetectedCornersCharuco_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ObjdetectModule.Objdetect.drawDetectedCornersCharuco(wrapped_image, wrapped_charucoCorners, wrapped_charucoIds);
