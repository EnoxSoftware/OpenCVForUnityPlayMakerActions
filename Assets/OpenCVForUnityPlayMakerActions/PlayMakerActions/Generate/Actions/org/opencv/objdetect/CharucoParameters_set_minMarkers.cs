...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_minMarkers(int minMarkers)")]
    ...
    public class CharucoParameters_set_minMarkers : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_minMarkers(minMarkers.Value);
