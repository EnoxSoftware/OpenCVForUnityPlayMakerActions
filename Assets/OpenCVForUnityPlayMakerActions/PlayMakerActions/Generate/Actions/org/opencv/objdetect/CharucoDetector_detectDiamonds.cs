...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void detectDiamonds(Mat image, List<Mat> diamondCorners, Mat diamondIds, List<Mat> markerCorners, List<Mat> markerIds)")]
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmArray), "markerIds")]
    public class CharucoDetector_detectDiamonds : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.UIHint(HutongGames.PlayMaker.UIHint.Variable)]
        [HutongGames.PlayMaker.ArrayEditor(typeof(OpenCVForUnityPlayMakerActions.Mat))]
        public HutongGames.PlayMaker.FsmArray markerIds;
        ...
        void DoProcess()
        {
            ...
            List<OpenCVForUnity.CoreModule.Mat> wrapped_markerIds = new List<OpenCVForUnity.CoreModule.Mat>();
            OpenCVForUnityPlayMakerActionsUtils.ConvertFsmArrayToList<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.CoreModule.Mat>(markerIds, wrapped_markerIds);

            wrapped_owner.detectDiamonds(wrapped_image, wrapped_diamondCorners, wrapped_diamondIds, wrapped_markerCorners, wrapped_markerIds);
            ...
            OpenCVForUnityPlayMakerActionsUtils.ConvertListToFsmArray<OpenCVForUnity.CoreModule.Mat, OpenCVForUnityPlayMakerActions.Mat>(wrapped_markerIds, markerIds);
