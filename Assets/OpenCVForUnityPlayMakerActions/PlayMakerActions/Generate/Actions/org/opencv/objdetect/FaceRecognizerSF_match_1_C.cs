...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public double match(Mat face_feature1, Mat face_feature2)")]
    ...
    public class FaceRecognizerSF_match_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (float)wrapped_owner.match(wrapped_face_feature1, wrapped_face_feature2);
