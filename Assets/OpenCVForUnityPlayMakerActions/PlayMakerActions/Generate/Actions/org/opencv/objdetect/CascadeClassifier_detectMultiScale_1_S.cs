...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class CascadeClassifier_detectMultiScale_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.detectMultiScale (wrapped_image, wrapped_objects, wrapped_scaleFactor, minNeighbors.Value, flags.Value, new OpenCVForUnity.Size ((double)minSize_width.Value, (double)minSize_height.Value));
