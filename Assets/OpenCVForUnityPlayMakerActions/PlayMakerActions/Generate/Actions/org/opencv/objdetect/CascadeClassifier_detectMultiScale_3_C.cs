...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void detectMultiScale(Mat image, MatOfRect objects, double scaleFactor, int minNeighbors)")]
    ...
    public class CascadeClassifier_detectMultiScale_3_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.detectMultiScale(wrapped_image, wrapped_objects, (float)scaleFactor.Value, minNeighbors.Value);
