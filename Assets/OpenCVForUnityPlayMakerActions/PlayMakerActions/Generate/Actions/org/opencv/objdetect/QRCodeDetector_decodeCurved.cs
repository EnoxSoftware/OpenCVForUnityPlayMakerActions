...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public string decodeCurved(Mat img, Mat points, Mat straight_qrcode)")]
    ...
    public class QRCodeDetector_decodeCurved : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.decodeCurved(wrapped_img, wrapped_points, wrapped_straight_qrcode);
