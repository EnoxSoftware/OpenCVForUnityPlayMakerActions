...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void detectMarkers(Mat image, List<Mat> corners, Mat ids)")]
    ...
    public class ArucoDetector_detectMarkers_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.detectMarkers(wrapped_image, wrapped_corners, wrapped_ids);
