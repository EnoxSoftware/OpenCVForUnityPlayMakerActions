...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool detectAndDecodeMulti(Mat img, List<string> decoded_info, Mat points, List<Mat> straight_qrcode)")]
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmArray), "straight_qrcode")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmEvent), "trueEvent")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmEvent), "falseEvent")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "storeResult")]
    public class QRCodeDetector_detectAndDecodeMulti : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmArray straight_qrcode;
        ...
        void DoProcess()
        {
            ...
            List<OpenCVForUnity.CoreModule.Mat> wrapped_straight_qrcode = new List<OpenCVForUnity.CoreModule.Mat>();
            OpenCVForUnityPlayMakerActionsUtils.ConvertFsmArrayToList<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.CoreModule.Mat>(straight_qrcode, wrapped_straight_qrcode);

            storeResult.Value = wrapped_owner.detectAndDecodeMulti(wrapped_img, wrapped_decoded_info, wrapped_points, wrapped_straight_qrcode);
