...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public Board(List<Mat> objPoints, Dictionary dictionary, Mat ids)")]
    ...
    public class Board_newBoard : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Board)storeResult.Value).wrappedObject = new OpenCVForUnity.ObjdetectModule.Board(wrapped_objPoints, wrapped_dictionary, wrapped_ids);
