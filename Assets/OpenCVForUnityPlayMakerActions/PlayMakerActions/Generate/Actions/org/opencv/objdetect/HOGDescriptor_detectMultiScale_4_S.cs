...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class HOGDescriptor_detectMultiScale_4_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.detectMultiScale (wrapped_img, wrapped_foundLocations, wrapped_foundWeights, wrapped_hitThreshold, new OpenCVForUnity.Size ((double)winStride_width.Value, (double)winStride_height.Value));
