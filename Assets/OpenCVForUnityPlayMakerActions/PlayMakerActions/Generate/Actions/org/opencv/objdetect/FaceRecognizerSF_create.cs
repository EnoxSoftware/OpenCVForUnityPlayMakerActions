...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static FaceRecognizerSF create(string model, string config, int backend_id, int target_id)")]
    ...
    public class FaceRecognizerSF_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.FaceRecognizerSF)storeResult.Value).wrappedObject = OpenCVForUnity.ObjdetectModule.FaceRecognizerSF.create(model.Value, config.Value, backend_id.Value, target_id.Value);
