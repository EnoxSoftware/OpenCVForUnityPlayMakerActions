...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_errorCorrectionRate(float errorCorrectionRate)")]
    ...
    public class RefineParameters_set_errorCorrectionRate : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_errorCorrectionRate(errorCorrectionRate.Value);
