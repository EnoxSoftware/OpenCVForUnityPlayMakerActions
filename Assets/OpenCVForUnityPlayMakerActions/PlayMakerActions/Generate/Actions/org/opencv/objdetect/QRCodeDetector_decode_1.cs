...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public string decode(Mat img, Mat points)")]
    ...
    public class QRCodeDetector_decode_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.decode(wrapped_img, wrapped_points);
