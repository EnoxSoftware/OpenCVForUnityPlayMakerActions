...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static FaceDetectorYN create(string model, string config, Size input_size, float score_threshold, float nms_threshold)")]
    ...
    public class FaceDetectorYN_create_3_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.FaceDetectorYN)storeResult.Value).wrappedObject = OpenCVForUnity.ObjdetectModule.FaceDetectorYN.create(model.Value, config.Value, new OpenCVForUnity.CoreModule.Size((double)input_size_width.Value, (double)input_size_height.Value), score_threshold.Value, nms_threshold.Value);
