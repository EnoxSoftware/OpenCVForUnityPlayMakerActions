...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setUseAlignmentMarkers(bool useAlignmentMarkers)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.QRCodeDetector), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "useAlignmentMarkers")]
    public class QRCodeDetector_setUseAlignmentMarkers : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool useAlignmentMarkers;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setUseAlignmentMarkers(useAlignmentMarkers.Value);
