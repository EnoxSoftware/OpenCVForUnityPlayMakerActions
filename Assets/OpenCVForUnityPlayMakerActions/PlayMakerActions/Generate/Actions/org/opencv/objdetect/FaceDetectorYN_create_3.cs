...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class FaceDetectorYN_create_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.FaceDetectorYN)storeResult.Value).wrappedObject = OpenCVForUnity.ObjdetectModule.FaceDetectorYN.create(model.Value, config.Value, wrapped_input_size, score_threshold.Value, nms_threshold.Value);
