...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void detectMultiScale3 (Mat image, MatOfRect objects, MatOfInt rejectLevels, MatOfDouble levelWeights, double scaleFactor, int minNeighbors, int flags, Size minSize)")]
    ...
    public class CascadeClassifier_detectMultiScale3_2_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.detectMultiScale3 (wrapped_image, wrapped_objects, wrapped_rejectLevels, wrapped_levelWeights, (float)scaleFactor.Value, minNeighbors.Value, flags.Value, new OpenCVForUnity.CoreModule.Size ((double)minSize_width.Value, (double)minSize_height.Value));
