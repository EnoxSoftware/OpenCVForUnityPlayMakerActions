...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class HOGDescriptor_compute_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.compute (wrapped_img, wrapped_descriptors, new OpenCVForUnity.Size ((double)winStride_width.Value, (double)winStride_height.Value), new OpenCVForUnity.Size ((double)padding_width.Value, (double)padding_height.Value));
