...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Objdetect_drawDetectedMarkers_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ObjdetectModule.Objdetect.drawDetectedMarkers(wrapped_image, wrapped_corners, wrapped_ids);
