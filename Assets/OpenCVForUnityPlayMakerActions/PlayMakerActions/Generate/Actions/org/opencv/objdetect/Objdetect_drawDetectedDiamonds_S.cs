...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Objdetect_drawDetectedDiamonds_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ObjdetectModule.Objdetect.drawDetectedDiamonds(wrapped_image, wrapped_diamondCorners, wrapped_diamondIds, new OpenCVForUnity.CoreModule.Scalar((double)borderColor_v0.Value, (double)borderColor_v1.Value, (double)borderColor_v2.Value, (double)borderColor_v3.Value));
