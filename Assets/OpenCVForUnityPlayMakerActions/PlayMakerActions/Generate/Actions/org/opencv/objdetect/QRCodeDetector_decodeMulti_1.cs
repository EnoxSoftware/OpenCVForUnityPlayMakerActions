...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool decodeMulti(Mat img, Mat points, List<string> decoded_info)")]
    ...
    public class QRCodeDetector_decodeMulti_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.decodeMulti(wrapped_img, wrapped_points, wrapped_decoded_info);
