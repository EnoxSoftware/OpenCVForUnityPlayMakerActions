...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public string detectAndDecode (Mat img, Mat points, Mat straight_qrcode)")]
    ...
    public class QRCodeDetector_detectAndDecode : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = wrapped_owner.detectAndDecode (wrapped_img, wrapped_points, wrapped_straight_qrcode);
