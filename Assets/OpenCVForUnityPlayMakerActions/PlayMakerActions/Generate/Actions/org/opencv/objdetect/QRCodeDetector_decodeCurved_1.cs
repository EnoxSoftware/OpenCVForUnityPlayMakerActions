...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public string decodeCurved(Mat img, Mat points)")]
    ...
    public class QRCodeDetector_decodeCurved_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.decodeCurved(wrapped_img, wrapped_points);
