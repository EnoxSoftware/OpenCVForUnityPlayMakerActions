...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Dictionary_getBitsFromByteList : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.ObjdetectModule.Dictionary.getBitsFromByteList(wrapped_byteList, markerSize.Value);
