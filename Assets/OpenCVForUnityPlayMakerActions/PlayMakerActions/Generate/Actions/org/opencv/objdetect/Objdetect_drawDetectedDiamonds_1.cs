...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Objdetect_drawDetectedDiamonds_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ObjdetectModule.Objdetect.drawDetectedDiamonds(wrapped_image, wrapped_diamondCorners, wrapped_diamondIds);
