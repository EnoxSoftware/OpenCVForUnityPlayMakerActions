...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public Dictionary(Mat bytesList, int _markerSize)")]
    ...
    public class Dictionary_newDictionary_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Dictionary)storeResult.Value).wrappedObject = new OpenCVForUnity.ObjdetectModule.Dictionary(wrapped_bytesList, _markerSize.Value);
