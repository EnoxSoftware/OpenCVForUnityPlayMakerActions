...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class CascadeClassifier_detectMultiScale_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.detectMultiScale (wrapped_image, wrapped_objects, (float)scaleFactor.Value, minNeighbors.Value, flags.Value, new OpenCVForUnity.CoreModule.Size ((double)minSize_width.Value, (double)minSize_height.Value), new OpenCVForUnity.CoreModule.Size ((double)maxSize_width.Value, (double)maxSize_height.Value));
