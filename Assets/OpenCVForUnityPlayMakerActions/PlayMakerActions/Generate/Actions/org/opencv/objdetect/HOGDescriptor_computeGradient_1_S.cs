...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class HOGDescriptor_computeGradient_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.computeGradient (wrapped_img, wrapped_grad, wrapped_angleOfs, new OpenCVForUnity.Size ((double)paddingTL_width.Value, (double)paddingTL_height.Value));
