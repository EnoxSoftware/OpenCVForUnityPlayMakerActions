...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool detectAndDecodeMulti(Mat img, List<string> decoded_info)")]
    ...
    public class QRCodeDetector_detectAndDecodeMulti_2 : HutongGames.PlayMaker.FsmStateAction
    {
