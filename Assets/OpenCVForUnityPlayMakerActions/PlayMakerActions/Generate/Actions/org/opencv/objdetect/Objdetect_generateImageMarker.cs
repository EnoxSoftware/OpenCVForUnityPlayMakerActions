...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void generateImageMarker(Dictionary dictionary, int id, int sidePixels, Mat img, int borderBits)")]
    ...
    public class Objdetect_generateImageMarker : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ObjdetectModule.Objdetect.generateImageMarker(wrapped_dictionary, id.Value, sidePixels.Value, wrapped_img, borderBits.Value);
