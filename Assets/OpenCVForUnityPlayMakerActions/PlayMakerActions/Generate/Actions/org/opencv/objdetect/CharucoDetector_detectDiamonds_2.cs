...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void detectDiamonds(Mat image, List<Mat> diamondCorners, Mat diamondIds)")]
    ...
    public class CharucoDetector_detectDiamonds_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.detectDiamonds(wrapped_image, wrapped_diamondCorners, wrapped_diamondIds);
