...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool detectAndDecodeMulti(Mat img, List<string> decoded_info, Mat points)")]
    ...
    public class QRCodeDetector_detectAndDecodeMulti_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.detectAndDecodeMulti(wrapped_img, wrapped_decoded_info, wrapped_points);
