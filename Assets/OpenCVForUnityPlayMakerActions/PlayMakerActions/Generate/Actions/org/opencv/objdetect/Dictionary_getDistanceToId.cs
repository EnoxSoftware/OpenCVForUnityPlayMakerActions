...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public int getDistanceToId(Mat bits, int id, bool allRotations)")]
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "allRotations")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "storeResult")]
    public class Dictionary_getDistanceToId : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool allRotations;
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.getDistanceToId(wrapped_bits, id.Value, allRotations.Value);
