...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Objdetect_drawDetectedCornersCharuco : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ObjdetectModule.Objdetect.drawDetectedCornersCharuco(wrapped_image, wrapped_charucoCorners, wrapped_charucoIds, wrapped_cornerColor);
