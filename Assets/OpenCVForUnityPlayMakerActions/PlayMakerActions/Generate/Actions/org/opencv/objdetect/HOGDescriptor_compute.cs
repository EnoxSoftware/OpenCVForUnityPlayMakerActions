...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void compute (Mat img, MatOfFloat descriptors, Size winStride, Size padding, MatOfPoint locations)")]
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (OpenCVForUnityPlayMakerActions.MatOfPoint), "locations")]
    public class HOGDescriptor_compute : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.ActionSection ("[arg5] MatOfPoint")]
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.UIHint (HutongGames.PlayMaker.UIHint.Variable)]
        [HutongGames.PlayMaker.ObjectType (typeof (OpenCVForUnityPlayMakerActions.MatOfPoint))]
        public HutongGames.PlayMaker.FsmObject locations;
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.compute (wrapped_img, wrapped_descriptors, wrapped_winStride, wrapped_padding, wrapped_locations);
