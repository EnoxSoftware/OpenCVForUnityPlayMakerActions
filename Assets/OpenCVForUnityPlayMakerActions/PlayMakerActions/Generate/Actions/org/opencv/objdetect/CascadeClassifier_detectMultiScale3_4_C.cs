...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class CascadeClassifier_detectMultiScale3_4_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.detectMultiScale3 (wrapped_image, wrapped_objects, wrapped_rejectLevels, wrapped_levelWeights, (float)scaleFactor.Value, minNeighbors.Value);
