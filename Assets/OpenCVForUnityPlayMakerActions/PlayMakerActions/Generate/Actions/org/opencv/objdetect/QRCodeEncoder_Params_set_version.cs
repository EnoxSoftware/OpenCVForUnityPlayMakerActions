...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_version(int version)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.QRCodeEncoder_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "version")]
    public class QRCodeEncoder_Params_set_version : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt version;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_version(version.Value);
