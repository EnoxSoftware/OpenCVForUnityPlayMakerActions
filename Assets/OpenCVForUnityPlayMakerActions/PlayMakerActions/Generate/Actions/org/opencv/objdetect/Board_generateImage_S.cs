...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void generateImage(Size outSize, Mat img, int marginSize, int borderBits)")]
    ...
    public class Board_generateImage_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.generateImage(new OpenCVForUnity.CoreModule.Size((double)outSize_width.Value, (double)outSize_height.Value), wrapped_img, marginSize.Value, borderBits.Value);
