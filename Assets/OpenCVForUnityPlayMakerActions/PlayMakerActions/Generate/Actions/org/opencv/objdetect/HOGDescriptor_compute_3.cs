...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void compute (Mat img, MatOfFloat descriptors)")]
    ...
    public class HOGDescriptor_compute_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.compute (wrapped_img, wrapped_descriptors);
