...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class HOGDescriptor_detectMultiScale_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.detectMultiScale (wrapped_img, wrapped_foundLocations, wrapped_foundWeights, (float)hitThreshold.Value, wrapped_winStride, wrapped_padding, (float)scale.Value, (float)finalThreshold.Value, useMeanshiftGrouping.Value);
