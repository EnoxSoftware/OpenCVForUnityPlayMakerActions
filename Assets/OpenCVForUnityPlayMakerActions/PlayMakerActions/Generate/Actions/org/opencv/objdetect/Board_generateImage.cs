...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Board_generateImage : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.generateImage(wrapped_outSize, wrapped_img, marginSize.Value, borderBits.Value);
