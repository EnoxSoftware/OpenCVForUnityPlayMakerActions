...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool decodeMulti(Mat img, Mat points, List<string> decoded_info, List<Mat> straight_qrcode)")]
    ...
    public class QRCodeDetector_decodeMulti : HutongGames.PlayMaker.FsmStateAction
    {
