...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void edgePreservingFilter(Mat src, Mat dst, int flags, float sigma_s, float sigma_r)")]
    ...
    public class Photo_edgePreservingFilter : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.PhotoModule.Photo.edgePreservingFilter(wrapped_src, wrapped_dst, flags.Value, sigma_s.Value, sigma_r.Value);
