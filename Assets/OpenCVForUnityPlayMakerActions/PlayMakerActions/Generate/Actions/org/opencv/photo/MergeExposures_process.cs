...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class MergeExposures_process : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.MergeExposures wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.MergeExposures, OpenCVForUnity.MergeExposures> (owner);
