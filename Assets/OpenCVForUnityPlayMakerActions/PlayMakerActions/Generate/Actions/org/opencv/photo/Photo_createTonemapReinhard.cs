...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Photo_createTonemapReinhard : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TonemapReinhard)storeResult.Value).wrappedObject = OpenCVForUnity.Photo.createTonemapReinhard (gamma.Value, intensity.Value, light_adapt.Value, color_adapt.Value);
