...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Photo_pencilSketch_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.PhotoModule.Photo.pencilSketch(wrapped_src, wrapped_dst1, wrapped_dst2);
