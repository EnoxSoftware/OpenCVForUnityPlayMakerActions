...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static TonemapReinhard createTonemapReinhard (float gamma)")]
    ...
    public class Photo_createTonemapReinhard_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TonemapReinhard)storeResult.Value).wrappedObject = OpenCVForUnity.PhotoModule.Photo.createTonemapReinhard (gamma.Value);
