...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmFloat), "shift_x")]
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmFloat), "shift_y")]
    public class AlignMTB_shiftMat_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat shift_x;

        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.ObjectType (typeof (HutongGames.PlayMaker.FsmFloat))]
        public HutongGames.PlayMaker.FsmFloat shift_y;
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.shiftMat (wrapped_src, wrapped_dst, new OpenCVForUnity.CoreModule.Point ((double)shift_x.Value, (double)shift_y.Value));
