...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void illuminationChange(Mat src, Mat mask, Mat dst, float alpha, float beta)")]
    ...
    public class Photo_illuminationChange : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.PhotoModule.Photo.illuminationChange(wrapped_src, wrapped_mask, wrapped_dst, alpha.Value, beta.Value);
