...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Photo_createCalibrateDebevec_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.CalibrateDebevec)storeResult.Value).wrappedObject = OpenCVForUnity.PhotoModule.Photo.createCalibrateDebevec(samples.Value, lambda.Value);
