...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class CalibrateCRF_process : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.CalibrateCRF wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.CalibrateCRF, OpenCVForUnity.CalibrateCRF> (owner);
