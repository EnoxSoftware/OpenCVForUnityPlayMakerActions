...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void stylization(Mat src, Mat dst, float sigma_s, float sigma_r)")]
    ...
    public class Photo_stylization : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.PhotoModule.Photo.stylization(wrapped_src, wrapped_dst, sigma_s.Value, sigma_r.Value);
