...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void detailEnhance(Mat src, Mat dst, float sigma_s, float sigma_r)")]
    ...
    public class Photo_detailEnhance : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.PhotoModule.Photo.detailEnhance(wrapped_src, wrapped_dst, sigma_s.Value, sigma_r.Value);
