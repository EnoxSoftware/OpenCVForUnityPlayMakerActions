...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Photo_createMergeMertens_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MergeMertens)storeResult.Value).wrappedObject = OpenCVForUnity.PhotoModule.Photo.createMergeMertens (contrast_weight.Value, saturation_weight.Value);
