...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Photo_createTonemapDrago : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TonemapDrago)storeResult.Value).wrappedObject = OpenCVForUnity.PhotoModule.Photo.createTonemapDrago(gamma.Value, saturation.Value, bias.Value);
