...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class MergeDebevec_process_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.PhotoModule.MergeDebevec wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.MergeDebevec, OpenCVForUnity.PhotoModule.MergeDebevec> (owner);
