...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static TonemapMantiuk createTonemapMantiuk(float gamma)")]
    ...
    public class Photo_createTonemapMantiuk_2 : HutongGames.PlayMaker.FsmStateAction
    {
