...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Photo_createTonemapDrago_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TonemapDrago)storeResult.Value).wrappedObject = OpenCVForUnity.PhotoModule.Photo.createTonemapDrago();
