...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Photo_fastNlMeansDenoisingMulti : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Photo.fastNlMeansDenoisingMulti (wrapped_srcImgs, wrapped_dst, imgToDenoiseIndex.Value, temporalWindowSize.Value, h.Value, templateWindowSize.Value, searchWindowSize.Value);
