...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Photo_createTonemapDurand_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TonemapDurand)storeResult.Value).wrappedObject = OpenCVForUnity.PhotoModule.Photo.createTonemapDurand (gamma.Value, contrast.Value, saturation.Value, sigma_space.Value);
