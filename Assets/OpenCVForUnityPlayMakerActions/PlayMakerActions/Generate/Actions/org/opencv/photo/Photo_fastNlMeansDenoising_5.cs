...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void fastNlMeansDenoising(Mat src, Mat dst, MatOfFloat h, int templateWindowSize, int searchWindowSize)")]
    ...
    public class Photo_fastNlMeansDenoising_5 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.PhotoModule.Photo.fastNlMeansDenoising(wrapped_src, wrapped_dst, wrapped_h, templateWindowSize.Value, searchWindowSize.Value);
