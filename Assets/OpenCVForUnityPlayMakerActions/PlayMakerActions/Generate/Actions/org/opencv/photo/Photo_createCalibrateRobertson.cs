...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static CalibrateRobertson createCalibrateRobertson(int max_iter, float threshold)")]
    ...
    public class Photo_createCalibrateRobertson : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.CalibrateRobertson)storeResult.Value).wrappedObject = OpenCVForUnity.PhotoModule.Photo.createCalibrateRobertson(max_iter.Value, threshold.Value);
