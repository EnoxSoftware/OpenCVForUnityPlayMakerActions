...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Photo_createCalibrateRobertson : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.CalibrateRobertson)storeResult.Value).wrappedObject = OpenCVForUnity.Photo.createCalibrateRobertson (max_iter.Value, threshold.Value);
