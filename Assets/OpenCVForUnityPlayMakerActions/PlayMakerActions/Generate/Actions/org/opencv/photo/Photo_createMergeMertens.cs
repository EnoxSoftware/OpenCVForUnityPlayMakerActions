...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Photo_createMergeMertens : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MergeMertens)storeResult.Value).wrappedObject = OpenCVForUnity.Photo.createMergeMertens (contrast_weight.Value, saturation_weight.Value, exposure_weight.Value);
