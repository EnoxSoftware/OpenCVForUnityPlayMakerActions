...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static bool findChessboardCorners (Mat image, Size patternSize, MatOfPoint2f corners)")]
    ...
    public class Calib3d_findChessboardCorners_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3dModule.Calib3d.findChessboardCorners (wrapped_image, wrapped_patternSize, wrapped_corners);
