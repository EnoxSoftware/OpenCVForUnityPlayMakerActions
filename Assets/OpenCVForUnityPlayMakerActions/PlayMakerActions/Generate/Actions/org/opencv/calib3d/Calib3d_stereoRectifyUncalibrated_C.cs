...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_stereoRectifyUncalibrated_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3d.stereoRectifyUncalibrated (wrapped_points1, wrapped_points2, wrapped_F, wrapped_imgSize, wrapped_H1, wrapped_H2, (float)threshold.Value);
