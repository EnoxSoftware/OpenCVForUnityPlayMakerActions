...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void drawFrameAxes (Mat image, Mat cameraMatrix, Mat distCoeffs, Mat rvec, Mat tvec, float length)")]
    ...
    public class Calib3d_drawFrameAxes_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.drawFrameAxes (wrapped_image, wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_rvec, wrapped_tvec, length.Value);
