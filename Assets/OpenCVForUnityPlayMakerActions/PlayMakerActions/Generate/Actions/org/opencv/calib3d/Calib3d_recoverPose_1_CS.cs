...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_recoverPose_1_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3d.recoverPose (wrapped_E, wrapped_points1, wrapped_points2, wrapped_R, wrapped_t, (float)focal.Value, new OpenCVForUnity.Point ((double)pp_x.Value, (double)pp_y.Value));
