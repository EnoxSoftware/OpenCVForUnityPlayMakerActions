...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_initCameraMatrix2D_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.initCameraMatrix2D(wrapped_objectPoints, wrapped_imagePoints, wrapped_imageSize);
