...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_fisheye_stereoCalibrate_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.Calib3d.fisheye_stereoCalibrate (wrapped_objectPoints, wrapped_imagePoints1, wrapped_imagePoints2, wrapped_K1, wrapped_D1, wrapped_K2, wrapped_D2, wrapped_imageSize, wrapped_R, wrapped_T, flags.Value);
