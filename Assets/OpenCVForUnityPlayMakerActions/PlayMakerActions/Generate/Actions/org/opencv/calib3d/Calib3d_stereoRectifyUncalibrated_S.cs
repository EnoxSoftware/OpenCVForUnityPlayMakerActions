...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_stereoRectifyUncalibrated_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3dModule.Calib3d.stereoRectifyUncalibrated(wrapped_points1, wrapped_points2, wrapped_F, new OpenCVForUnity.CoreModule.Size((double)imgSize_width.Value, (double)imgSize_height.Value), wrapped_H1, wrapped_H2, wrapped_threshold);
