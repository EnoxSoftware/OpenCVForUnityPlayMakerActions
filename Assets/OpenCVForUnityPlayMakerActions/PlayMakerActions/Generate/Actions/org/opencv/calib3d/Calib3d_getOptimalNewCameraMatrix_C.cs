...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_getOptimalNewCameraMatrix_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Rect wrapped_validPixROI = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Rect, OpenCVForUnity.CoreModule.Rect>(validPixROI);

            if (!(storeResult.Value is OpenCVForUnityPlayMakerActions.Mat)) storeResult.Value = new OpenCVForUnityPlayMakerActions.Mat();
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.getOptimalNewCameraMatrix(wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_imageSize, (float)alpha.Value, wrapped_newImgSize, wrapped_validPixROI, centerPrincipalPoint.Value);
