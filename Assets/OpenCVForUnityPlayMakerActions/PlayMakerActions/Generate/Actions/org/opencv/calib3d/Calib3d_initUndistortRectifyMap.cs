...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_initUndistortRectifyMap : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.initUndistortRectifyMap(wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_R, wrapped_newCameraMatrix, wrapped_size, m1type.Value, wrapped_map1, wrapped_map2);
