...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_getDefaultNewCameraMatrix_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.getDefaultNewCameraMatrix(wrapped_cameraMatrix, new OpenCVForUnity.CoreModule.Size((double)imgsize_width.Value, (double)imgsize_height.Value));
