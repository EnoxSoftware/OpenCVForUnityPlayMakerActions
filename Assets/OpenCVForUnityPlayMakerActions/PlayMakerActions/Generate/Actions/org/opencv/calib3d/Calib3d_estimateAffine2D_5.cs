...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static Mat estimateAffine2D(Mat from, Mat to, Mat inliers)")]
    ...
    public class Calib3d_estimateAffine2D_5 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.estimateAffine2D(wrapped_from, wrapped_to, wrapped_inliers);
