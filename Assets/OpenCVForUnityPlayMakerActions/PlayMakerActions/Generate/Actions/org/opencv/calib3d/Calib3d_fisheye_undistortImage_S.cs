...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_fisheye_undistortImage_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.fisheye_undistortImage(wrapped_distorted, wrapped_undistorted, wrapped_K, wrapped_D, wrapped_Knew, new OpenCVForUnity.CoreModule.Size((double)new_size_width.Value, (double)new_size_height.Value));
