...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_findFundamentalMat_4_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.findFundamentalMat(wrapped_points1, wrapped_points2, method.Value, (float)ransacReprojThreshold.Value, (float)confidence.Value);
