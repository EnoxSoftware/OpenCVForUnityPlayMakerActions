...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void estimateNewCameraMatrixForUndistortRectify (Mat K, Mat D, Size image_size, Mat R, Mat P, double balance, Size new_size, double fov_scale)")]
    ...
    public class Calib3d_estimateNewCameraMatrixForUndistortRectify_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3d.estimateNewCameraMatrixForUndistortRectify (wrapped_K, wrapped_D, new OpenCVForUnity.Size ((double)image_size_width.Value, (double)image_size_height.Value), wrapped_R, wrapped_P, (float)balance.Value, new OpenCVForUnity.Size ((double)new_size_width.Value, (double)new_size_height.Value), (float)fov_scale.Value);
