...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_recoverPose : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3dModule.Calib3d.recoverPose(wrapped_points1, wrapped_points2, wrapped_cameraMatrix1, wrapped_distCoeffs1, wrapped_cameraMatrix2, wrapped_distCoeffs2, wrapped_E, wrapped_R, wrapped_t, method.Value, wrapped_prob, wrapped_threshold, wrapped_mask);
