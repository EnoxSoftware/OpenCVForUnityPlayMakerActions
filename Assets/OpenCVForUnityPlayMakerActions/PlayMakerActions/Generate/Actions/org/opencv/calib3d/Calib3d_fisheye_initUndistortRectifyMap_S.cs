...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void fisheye_initUndistortRectifyMap(Mat K, Mat D, Mat R, Mat P, Size size, int m1type, Mat map1, Mat map2)")]
    ...
    public class Calib3d_fisheye_initUndistortRectifyMap_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.fisheye_initUndistortRectifyMap(wrapped_K, wrapped_D, wrapped_R, wrapped_P, new OpenCVForUnity.CoreModule.Size((double)size_width.Value, (double)size_height.Value), m1type.Value, wrapped_map1, wrapped_map2);
