...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_fisheye_initUndistortRectifyMap_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3d.fisheye_initUndistortRectifyMap (wrapped_K, wrapped_D, wrapped_R, wrapped_P, new OpenCVForUnity.Size ((double)size_width.Value, (double)size_height.Value), m1type.Value, wrapped_map1, wrapped_map2);
