...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static int estimateTranslation3D(Mat src, Mat dst, Mat _out, Mat inliers, double ransacThreshold)")]
    ...
    public class Calib3d_estimateTranslation3D_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3dModule.Calib3d.estimateTranslation3D(wrapped_src, wrapped_dst, wrapped__out, wrapped_inliers, (float)ransacThreshold.Value);
