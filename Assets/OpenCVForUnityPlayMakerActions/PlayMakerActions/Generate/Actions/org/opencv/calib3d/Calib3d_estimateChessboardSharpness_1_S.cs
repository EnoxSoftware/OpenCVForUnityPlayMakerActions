...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_estimateChessboardSharpness_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Scalar)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.estimateChessboardSharpness(wrapped_image, new OpenCVForUnity.CoreModule.Size((double)patternSize_width.Value, (double)patternSize_height.Value), wrapped_corners, rise_distance.Value, vertical.Value);
