...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_RQDecomp3x3_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            double[] casted_storeResult = OpenCVForUnity.Calib3dModule.Calib3d.RQDecomp3x3(wrapped_src, wrapped_mtxR, wrapped_mtxQ, wrapped_Qx, wrapped_Qy);
