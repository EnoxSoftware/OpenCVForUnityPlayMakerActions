...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_findChessboardCorners_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3d.findChessboardCorners (wrapped_image, new OpenCVForUnity.Size ((double)patternSize_width.Value, (double)patternSize_height.Value), wrapped_corners, flags.Value);
