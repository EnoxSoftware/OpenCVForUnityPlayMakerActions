...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_getOptimalNewCameraMatrix_3_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.getOptimalNewCameraMatrix(wrapped_cameraMatrix, wrapped_distCoeffs, new OpenCVForUnity.CoreModule.Size((double)imageSize_width.Value, (double)imageSize_height.Value), (float)alpha.Value);
