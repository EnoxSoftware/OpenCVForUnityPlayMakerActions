...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_initInverseRectificationMap_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.initInverseRectificationMap(wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_R, wrapped_newCameraMatrix, new OpenCVForUnity.CoreModule.Size((double)size_width.Value, (double)size_height.Value), m1type.Value, wrapped_map1, wrapped_map2);
