...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_RQDecomp3x3_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.DoubleArray)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.RQDecomp3x3 (wrapped_src, wrapped_mtxR, wrapped_mtxQ, wrapped_Qx, wrapped_Qy);
