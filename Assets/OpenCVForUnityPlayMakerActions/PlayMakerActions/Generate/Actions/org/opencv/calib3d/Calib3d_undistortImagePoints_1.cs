...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void undistortImagePoints(Mat src, Mat dst, Mat cameraMatrix, Mat distCoeffs)")]
    ...
    public class Calib3d_undistortImagePoints_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.undistortImagePoints(wrapped_src, wrapped_dst, wrapped_cameraMatrix, wrapped_distCoeffs);
