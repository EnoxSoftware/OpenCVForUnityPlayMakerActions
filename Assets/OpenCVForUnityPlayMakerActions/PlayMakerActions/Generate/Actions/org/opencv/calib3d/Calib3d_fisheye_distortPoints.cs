...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_fisheye_distortPoints : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.fisheye_distortPoints(wrapped_undistorted, wrapped_distorted, wrapped_K, wrapped_D, wrapped_alpha);
