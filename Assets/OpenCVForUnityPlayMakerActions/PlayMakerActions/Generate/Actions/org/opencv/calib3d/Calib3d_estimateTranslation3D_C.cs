...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static int estimateTranslation3D(Mat src, Mat dst, Mat _out, Mat inliers, double ransacThreshold, double confidence)")]
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "ransacThreshold")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "confidence")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "storeResult")]
    public class Calib3d_estimateTranslation3D_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat ransacThreshold;
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3dModule.Calib3d.estimateTranslation3D(wrapped_src, wrapped_dst, wrapped__out, wrapped_inliers, (float)ransacThreshold.Value, (float)confidence.Value);
