...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_projectPoints_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3d.projectPoints (wrapped_objectPoints, wrapped_imagePoints, wrapped_rvec, wrapped_tvec, wrapped_K, wrapped_D, (float)alpha.Value, wrapped_jacobian);
