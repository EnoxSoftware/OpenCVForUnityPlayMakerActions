...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_estimateAffinePartial2D_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3d.estimateAffinePartial2D (wrapped_from, wrapped_to, wrapped_inliers, method.Value, wrapped_ransacReprojThreshold);
