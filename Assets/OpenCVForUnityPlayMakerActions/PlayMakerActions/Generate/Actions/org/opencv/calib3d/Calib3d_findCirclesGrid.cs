...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_findCirclesGrid : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3dModule.Calib3d.findCirclesGrid(wrapped_image, wrapped_patternSize, wrapped_centers, flags.Value);
