...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void calibrateHandEye(List<Mat> R_gripper2base, List<Mat> t_gripper2base, List<Mat> R_target2cam, List<Mat> t_target2cam, Mat R_cam2gripper, Mat t_cam2gripper)")]
    ...
    public class Calib3d_calibrateHandEye_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.calibrateHandEye(wrapped_R_gripper2base, wrapped_t_gripper2base, wrapped_R_target2cam, wrapped_t_target2cam, wrapped_R_cam2gripper, wrapped_t_cam2gripper);
