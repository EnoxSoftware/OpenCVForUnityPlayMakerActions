...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_recoverPose_7 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3d.recoverPose (wrapped_E, wrapped_points1, wrapped_points2, wrapped_cameraMatrix, wrapped_R, wrapped_t, wrapped_distanceThresh, wrapped_mask);
