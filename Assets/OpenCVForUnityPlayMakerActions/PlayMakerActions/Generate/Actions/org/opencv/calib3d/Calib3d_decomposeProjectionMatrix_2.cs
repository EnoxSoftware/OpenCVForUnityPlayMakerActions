...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void decomposeProjectionMatrix(Mat projMatrix, Mat cameraMatrix, Mat rotMatrix, Mat transVect, Mat rotMatrixX, Mat rotMatrixY)")]
    ...
    public class Calib3d_decomposeProjectionMatrix_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.decomposeProjectionMatrix(wrapped_projMatrix, wrapped_cameraMatrix, wrapped_rotMatrix, wrapped_transVect, wrapped_rotMatrixX, wrapped_rotMatrixY);
