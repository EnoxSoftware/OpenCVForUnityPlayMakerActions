...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_loSampleSize(int loSampleSize)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.UsacParams), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "loSampleSize")]
    public class UsacParams_set_loSampleSize : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt loSampleSize;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_loSampleSize(loSampleSize.Value);
