...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_getDefaultNewCameraMatrix_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.getDefaultNewCameraMatrix (wrapped_cameraMatrix);
