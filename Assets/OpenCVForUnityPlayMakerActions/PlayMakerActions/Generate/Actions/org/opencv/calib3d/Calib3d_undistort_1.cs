...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void undistort(Mat src, Mat dst, Mat cameraMatrix, Mat distCoeffs)")]
    ...
    public class Calib3d_undistort_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.undistort(wrapped_src, wrapped_dst, wrapped_cameraMatrix, wrapped_distCoeffs);
