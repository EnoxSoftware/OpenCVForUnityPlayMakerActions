...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_fisheye_estimateNewCameraMatrixForUndistortRectify_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3d.fisheye_estimateNewCameraMatrixForUndistortRectify (wrapped_K, wrapped_D, new OpenCVForUnity.Size ((double)image_size_width.Value, (double)image_size_height.Value), wrapped_R, wrapped_P, (float)balance.Value, new OpenCVForUnity.Size ((double)new_size_width.Value, (double)new_size_height.Value), (float)fov_scale.Value);
