...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TermCriteria), "arg1")]
    public class Calib3d_undistortImagePoints : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmObject arg1;
        ...
        void DoProcess()
        {
            ...
            if (!(arg1.Value is OpenCVForUnityPlayMakerActions.TermCriteria))
            {
                LogError("arg1 is not initialized. Add Action \"newTermCriteria\".");
                return;
            }
            OpenCVForUnity.CoreModule.TermCriteria wrapped_arg1 = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.TermCriteria, OpenCVForUnity.CoreModule.TermCriteria>(arg1);

            OpenCVForUnity.Calib3dModule.Calib3d.undistortImagePoints(wrapped_src, wrapped_dst, wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_arg1);
