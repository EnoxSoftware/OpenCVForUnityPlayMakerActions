...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void validateDisparity(Mat disparity, Mat cost, int minDisparity, int numberOfDisparities)")]
    ...
    public class Calib3d_validateDisparity_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.validateDisparity(wrapped_disparity, wrapped_cost, minDisparity.Value, numberOfDisparities.Value);
