...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_findEssentialMat_5_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3d.findEssentialMat (wrapped_points1, wrapped_points2, (float)focal.Value, wrapped_pp, method.Value, (float)prob.Value, (float)threshold.Value, wrapped_mask);
