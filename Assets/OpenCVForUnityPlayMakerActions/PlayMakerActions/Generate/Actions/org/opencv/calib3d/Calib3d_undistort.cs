...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_undistort : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.undistort(wrapped_src, wrapped_dst, wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_newCameraMatrix);
