...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_solvePnPRansac_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3d.solvePnPRansac (wrapped_objectPoints, wrapped_imagePoints, wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_rvec, wrapped_tvec, useExtrinsicGuess.Value, iterationsCount.Value, reprojectionError.Value, wrapped_confidence);
