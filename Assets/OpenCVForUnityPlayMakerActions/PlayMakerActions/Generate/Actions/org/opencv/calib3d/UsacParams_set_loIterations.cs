...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_loIterations(int loIterations)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.UsacParams), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "loIterations")]
    public class UsacParams_set_loIterations : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt loIterations;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_loIterations(loIterations.Value);
