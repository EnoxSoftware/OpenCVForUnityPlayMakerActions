...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_fisheye_stereoRectify_3_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3d.fisheye_stereoRectify (wrapped_K1, wrapped_D1, wrapped_K2, wrapped_D2, new OpenCVForUnity.Size ((double)imageSize_width.Value, (double)imageSize_height.Value), wrapped_R, wrapped_tvec, wrapped_R1, wrapped_R2, wrapped_P1, wrapped_P2, wrapped_Q, flags.Value);
