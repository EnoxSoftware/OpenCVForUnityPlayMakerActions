...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_undistortImage : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3d.undistortImage (wrapped_distorted, wrapped_undistorted, wrapped_K, wrapped_D, wrapped_Knew, wrapped_new_size);
