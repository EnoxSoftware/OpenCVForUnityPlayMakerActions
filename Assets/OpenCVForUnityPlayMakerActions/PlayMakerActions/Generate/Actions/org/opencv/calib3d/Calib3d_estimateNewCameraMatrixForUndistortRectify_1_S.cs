...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void estimateNewCameraMatrixForUndistortRectify (Mat K, Mat D, Size image_size, Mat R, Mat P)")]
    ...
    public class Calib3d_estimateNewCameraMatrixForUndistortRectify_1_S : HutongGames.PlayMaker.FsmStateAction
    {
