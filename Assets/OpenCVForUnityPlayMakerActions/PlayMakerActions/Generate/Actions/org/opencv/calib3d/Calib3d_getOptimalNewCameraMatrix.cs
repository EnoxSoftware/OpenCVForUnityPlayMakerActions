...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_getOptimalNewCameraMatrix : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3d.getOptimalNewCameraMatrix (wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_imageSize, wrapped_alpha, wrapped_newImgSize, wrapped_validPixROI, centerPrincipalPoint.Value);
