...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_fisheye_calibrate_1_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.Calib3d.fisheye_calibrate (wrapped_objectPoints, wrapped_imagePoints, new OpenCVForUnity.Size ((double)image_size_width.Value, (double)image_size_height.Value), wrapped_K, wrapped_D, wrapped_rvecs, wrapped_tvecs, flags.Value);
