...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_estimateAffine2D_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3d.estimateAffine2D (wrapped_from, wrapped_to, wrapped_inliers, method.Value, (float)ransacReprojThreshold.Value, (int)maxIters.Value);
