...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_estimateChessboardSharpness : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Scalar)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.estimateChessboardSharpness(wrapped_image, wrapped_patternSize, wrapped_corners, rise_distance.Value, vertical.Value, wrapped_sharpness);
