...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_stereoRectify_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3d.stereoRectify (wrapped_K1, wrapped_D1, wrapped_K2, wrapped_D2, wrapped_imageSize, wrapped_R, wrapped_tvec, wrapped_R1, wrapped_R2, wrapped_P1, wrapped_P2, wrapped_Q, flags.Value, wrapped_newImageSize, (float)balance.Value, (float)fov_scale.Value);
