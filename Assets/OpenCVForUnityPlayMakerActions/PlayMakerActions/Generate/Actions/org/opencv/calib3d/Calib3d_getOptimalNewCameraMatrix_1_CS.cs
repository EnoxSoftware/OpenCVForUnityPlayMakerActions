...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_getOptimalNewCameraMatrix_1_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3d.getOptimalNewCameraMatrix (wrapped_cameraMatrix, wrapped_distCoeffs, new OpenCVForUnity.Size ((double)imageSize_width.Value, (double)imageSize_height.Value), (float)alpha.Value, new OpenCVForUnity.Size ((double)newImgSize_width.Value, (double)newImgSize_height.Value), new OpenCVForUnity.Rect ((int)validPixROI_x.Value, (int)validPixROI_y.Value, (int)validPixROI_width.Value, (int)validPixROI_height.Value));
