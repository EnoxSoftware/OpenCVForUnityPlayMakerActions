...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_estimateNewCameraMatrixForUndistortRectify_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3d.estimateNewCameraMatrixForUndistortRectify (wrapped_K, wrapped_D, wrapped_image_size, wrapped_R, wrapped_P);
