...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_projectPoints : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3d.projectPoints (wrapped_objectPoints, wrapped_rvec, wrapped_tvec, wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_imagePoints, wrapped_jacobian, wrapped_aspectRatio);
