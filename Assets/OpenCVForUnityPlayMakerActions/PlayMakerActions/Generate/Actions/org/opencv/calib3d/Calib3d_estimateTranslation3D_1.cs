...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_estimateTranslation3D_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3dModule.Calib3d.estimateTranslation3D(wrapped_src, wrapped_dst, wrapped__out, wrapped_inliers, wrapped_ransacThreshold);
