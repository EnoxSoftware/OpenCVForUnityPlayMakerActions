...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_fisheye_calibrate_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3d.fisheye_calibrate (wrapped_objectPoints, wrapped_imagePoints, wrapped_image_size, wrapped_K, wrapped_D, wrapped_rvecs, wrapped_tvecs, flags.Value);
