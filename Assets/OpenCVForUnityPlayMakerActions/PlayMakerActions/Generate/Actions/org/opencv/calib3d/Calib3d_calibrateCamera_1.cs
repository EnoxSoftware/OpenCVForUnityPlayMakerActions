...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_calibrateCamera_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.calibrateCamera(wrapped_objectPoints, wrapped_imagePoints, wrapped_imageSize, wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_rvecs, wrapped_tvecs, flags.Value);
