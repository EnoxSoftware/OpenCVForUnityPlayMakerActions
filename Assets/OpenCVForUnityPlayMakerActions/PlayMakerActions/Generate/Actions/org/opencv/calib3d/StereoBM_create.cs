...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static StereoBM create(int numDisparities, int blockSize)")]
    ...
    public class StereoBM_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.StereoBM)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.StereoBM.create(numDisparities.Value, blockSize.Value);
