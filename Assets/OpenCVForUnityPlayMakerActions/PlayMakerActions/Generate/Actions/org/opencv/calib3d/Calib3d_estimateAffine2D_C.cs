...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static Mat estimateAffine2D (Mat from, Mat to, Mat inliers, int method, double ransacReprojThreshold, long maxIters, double confidence, long refineIters)")]
    ...
    public class Calib3d_estimateAffine2D_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.estimateAffine2D (wrapped_from, wrapped_to, wrapped_inliers, method.Value, (float)ransacReprojThreshold.Value, (int)maxIters.Value, (float)confidence.Value, (int)refineIters.Value);
