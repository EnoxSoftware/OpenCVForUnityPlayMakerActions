...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_calibrateCameraExtended_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.Calib3d.calibrateCameraExtended (wrapped_objectPoints, wrapped_imagePoints, wrapped_imageSize, wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_rvecs, wrapped_tvecs, wrapped_stdDeviationsIntrinsics, wrapped_stdDeviationsExtrinsics, wrapped_perViewErrors, flags.Value);
