...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_calibrateCameraRO_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.Calib3dModule.Calib3d.calibrateCameraRO(wrapped_objectPoints, wrapped_imagePoints, wrapped_imageSize, iFixedPoint.Value, wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_rvecs, wrapped_tvecs, wrapped_newObjPoints, flags.Value);
