...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_stereoCalibrateExtended_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.Calib3d.stereoCalibrateExtended (wrapped_objectPoints, wrapped_imagePoints1, wrapped_imagePoints2, wrapped_cameraMatrix1, wrapped_distCoeffs1, wrapped_cameraMatrix2, wrapped_distCoeffs2, wrapped_imageSize, wrapped_R, wrapped_T, wrapped_E, wrapped_F, wrapped_perViewErrors);
