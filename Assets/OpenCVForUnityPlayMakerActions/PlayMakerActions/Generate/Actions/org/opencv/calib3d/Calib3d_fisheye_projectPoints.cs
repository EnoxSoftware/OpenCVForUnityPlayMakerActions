...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_fisheye_projectPoints : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3d.fisheye_projectPoints (wrapped_objectPoints, wrapped_imagePoints, wrapped_rvec, wrapped_tvec, wrapped_K, wrapped_D, wrapped_alpha, wrapped_jacobian);
