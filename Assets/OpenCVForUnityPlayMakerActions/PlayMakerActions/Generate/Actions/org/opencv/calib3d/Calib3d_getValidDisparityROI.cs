...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_getValidDisparityROI : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Rect)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.getValidDisparityROI(wrapped_roi1, wrapped_roi2, minDisparity.Value, numberOfDisparities.Value, blockSize.Value);
