...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_distortPoints : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3d.distortPoints (wrapped_undistorted, wrapped_distorted, wrapped_K, wrapped_D, wrapped_alpha);
