...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void fisheye_undistortImage(Mat distorted, Mat undistorted, Mat K, Mat D)")]
    ...
    public class Calib3d_fisheye_undistortImage_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.fisheye_undistortImage(wrapped_distorted, wrapped_undistorted, wrapped_K, wrapped_D);
