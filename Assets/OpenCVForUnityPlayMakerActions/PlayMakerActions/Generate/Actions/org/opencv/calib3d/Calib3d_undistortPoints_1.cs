...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void undistortPoints (Mat distorted, Mat undistorted, Mat K, Mat D)")]
    ...
    public class Calib3d_undistortPoints_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3d.undistortPoints (wrapped_distorted, wrapped_undistorted, wrapped_K, wrapped_D);
