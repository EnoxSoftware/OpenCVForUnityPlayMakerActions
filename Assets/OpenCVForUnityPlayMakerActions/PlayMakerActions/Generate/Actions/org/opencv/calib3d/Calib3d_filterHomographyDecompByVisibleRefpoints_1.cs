...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_filterHomographyDecompByVisibleRefpoints_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.filterHomographyDecompByVisibleRefpoints(wrapped_rotations, wrapped_normals, wrapped_beforePoints, wrapped_afterPoints, wrapped_possibleSolutions);
