...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void calibrateRobotWorldHandEye(List<Mat> R_world2cam, List<Mat> t_world2cam, List<Mat> R_base2gripper, List<Mat> t_base2gripper, Mat R_base2world, Mat t_base2world, Mat R_gripper2cam, Mat t_gripper2cam)")]
    ...
    public class Calib3d_calibrateRobotWorldHandEye_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.calibrateRobotWorldHandEye(wrapped_R_world2cam, wrapped_t_world2cam, wrapped_R_base2gripper, wrapped_t_base2gripper, wrapped_R_base2world, wrapped_t_base2world, wrapped_R_gripper2cam, wrapped_t_gripper2cam);
