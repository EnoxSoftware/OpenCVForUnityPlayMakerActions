...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_getDefaultNewCameraMatrix_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.getDefaultNewCameraMatrix(wrapped_cameraMatrix, wrapped_imgsize);
