...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_findEssentialMat_8_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3d.findEssentialMat (wrapped_points1, wrapped_points2, (float)focal.Value, new OpenCVForUnity.Point ((double)pp_x.Value, (double)pp_y.Value), method.Value);
