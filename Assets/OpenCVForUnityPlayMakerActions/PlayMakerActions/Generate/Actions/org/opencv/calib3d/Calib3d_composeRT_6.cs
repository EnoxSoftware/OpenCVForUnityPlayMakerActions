...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void composeRT(Mat rvec1, Mat tvec1, Mat rvec2, Mat tvec2, Mat rvec3, Mat tvec3, Mat dr3dr1, Mat dr3dt1)")]
    ...
    public class Calib3d_composeRT_6 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.composeRT(wrapped_rvec1, wrapped_tvec1, wrapped_rvec2, wrapped_tvec2, wrapped_rvec3, wrapped_tvec3, wrapped_dr3dr1, wrapped_dr3dt1);
