...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_calibrate_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3d.calibrate (wrapped_objectPoints, wrapped_imagePoints, new OpenCVForUnity.Size ((double)image_size_width.Value, (double)image_size_height.Value), wrapped_K, wrapped_D, wrapped_rvecs, wrapped_tvecs, flags.Value);
