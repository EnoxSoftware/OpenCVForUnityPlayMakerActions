...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_estimateAffine2D_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3dModule.Calib3d.estimateAffine2D(wrapped_from, wrapped_to, wrapped_inliers, method.Value, wrapped_ransacReprojThreshold, wrapped_maxIters, wrapped_confidence);
