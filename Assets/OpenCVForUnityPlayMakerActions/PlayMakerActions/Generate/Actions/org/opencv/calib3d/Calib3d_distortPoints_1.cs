...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void distortPoints (Mat undistorted, Mat distorted, Mat K, Mat D)")]
    ...
    public class Calib3d_distortPoints_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Calib3d.distortPoints (wrapped_undistorted, wrapped_distorted, wrapped_K, wrapped_D);
