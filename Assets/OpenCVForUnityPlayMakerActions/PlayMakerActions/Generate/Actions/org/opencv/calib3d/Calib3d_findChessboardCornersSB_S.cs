...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static bool findChessboardCornersSB(Mat image, Size patternSize, Mat corners, int flags)")]
    ...
    public class Calib3d_findChessboardCornersSB_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3dModule.Calib3d.findChessboardCornersSB(wrapped_image, new OpenCVForUnity.CoreModule.Size((double)patternSize_width.Value, (double)patternSize_height.Value), wrapped_corners, flags.Value);
