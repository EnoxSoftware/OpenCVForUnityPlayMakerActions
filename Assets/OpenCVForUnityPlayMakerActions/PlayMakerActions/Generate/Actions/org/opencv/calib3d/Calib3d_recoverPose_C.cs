...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_recoverPose_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Calib3d.recoverPose (wrapped_E, wrapped_points1, wrapped_points2, wrapped_R, wrapped_t, (float)focal.Value, wrapped_pp, wrapped_mask);
