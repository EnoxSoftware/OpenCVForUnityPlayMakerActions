...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_solvePnPRefineLM : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.solvePnPRefineLM(wrapped_objectPoints, wrapped_imagePoints, wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_rvec, wrapped_tvec, wrapped_criteria);
