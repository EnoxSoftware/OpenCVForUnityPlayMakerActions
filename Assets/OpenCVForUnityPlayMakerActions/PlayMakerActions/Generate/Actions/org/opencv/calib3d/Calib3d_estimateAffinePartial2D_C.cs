...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_estimateAffinePartial2D_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Calib3d.estimateAffinePartial2D (wrapped_from, wrapped_to, wrapped_inliers, method.Value, (float)ransacReprojThreshold.Value, (int)maxIters.Value, (float)confidence.Value, (int)refineIters.Value);
