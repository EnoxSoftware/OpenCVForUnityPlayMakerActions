...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Calib3d_fisheye_estimateNewCameraMatrixForUndistortRectify_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Calib3dModule.Calib3d.fisheye_estimateNewCameraMatrixForUndistortRectify(wrapped_K, wrapped_D, wrapped_image_size, wrapped_R, wrapped_P, (float)balance.Value);
