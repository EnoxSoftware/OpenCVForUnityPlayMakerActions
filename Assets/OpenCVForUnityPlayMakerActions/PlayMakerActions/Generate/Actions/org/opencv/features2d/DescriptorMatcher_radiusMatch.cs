...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void radiusMatch(Mat queryDescriptors, Mat trainDescriptors, List<MatOfDMatch> matches, float maxDistance, Mat mask, bool compactResult)")]
    ...
    public class DescriptorMatcher_radiusMatch : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.radiusMatch(wrapped_queryDescriptors, wrapped_trainDescriptors, wrapped_matches, maxDistance.Value, wrapped_mask, compactResult.Value);
