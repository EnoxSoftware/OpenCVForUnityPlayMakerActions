...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class FastFeatureDetector_create_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.FastFeatureDetector)storeResult.Value).wrappedObject = OpenCVForUnity.Features2dModule.FastFeatureDetector.create(threshold.Value, nonmaxSuppression.Value);
