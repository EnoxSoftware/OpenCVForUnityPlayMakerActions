...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class GFTTDetector_create_6 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.GFTTDetector)storeResult.Value).wrappedObject = OpenCVForUnity.GFTTDetector.create (maxCorners.Value, wrapped_qualityLevel, wrapped_minDistance);
