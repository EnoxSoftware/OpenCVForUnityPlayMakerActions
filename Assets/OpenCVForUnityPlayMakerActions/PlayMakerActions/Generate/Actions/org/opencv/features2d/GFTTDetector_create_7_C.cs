...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class GFTTDetector_create_7_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.GFTTDetector)storeResult.Value).wrappedObject = OpenCVForUnity.Features2dModule.GFTTDetector.create(maxCorners.Value, (float)qualityLevel.Value);
