...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static AffineFeature create(Feature2D backend)")]
    ...
    public class AffineFeature_create_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.AffineFeature)storeResult.Value).wrappedObject = OpenCVForUnity.Features2dModule.AffineFeature.create(wrapped_backend);
