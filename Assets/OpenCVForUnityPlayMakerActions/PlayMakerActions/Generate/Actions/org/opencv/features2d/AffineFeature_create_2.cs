...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static AffineFeature create(Feature2D backend, int maxTilt, int minTilt)")]
    ...
    public class AffineFeature_create_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.AffineFeature)storeResult.Value).wrappedObject = OpenCVForUnity.Features2dModule.AffineFeature.create(wrapped_backend, maxTilt.Value, minTilt.Value);
