...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class BRISK_create_7 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.BRISK)storeResult.Value).wrappedObject = OpenCVForUnity.Features2dModule.BRISK.create(wrapped_radiusList, wrapped_numberList);
