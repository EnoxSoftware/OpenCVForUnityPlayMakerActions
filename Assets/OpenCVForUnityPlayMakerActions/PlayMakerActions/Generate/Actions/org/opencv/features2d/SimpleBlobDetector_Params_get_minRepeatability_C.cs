...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class SimpleBlobDetector_Params_get_minRepeatability_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (int)wrapped_owner.get_minRepeatability();
