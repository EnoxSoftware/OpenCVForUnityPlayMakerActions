...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class ORB_create_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ORB)storeResult.Value).wrappedObject = OpenCVForUnity.ORB.create (nfeatures.Value, scaleFactor.Value, nlevels.Value, edgeThreshold.Value, firstLevel.Value, WTA_K.Value);
