...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static MSER create (int _delta, int _min_area, int _max_area, double _max_variation, double _min_diversity, int _max_evolution, double _area_threshold, double _min_margin, int _edge_blur_size)")]
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (OpenCVForUnityPlayMakerActions.Double), "_min_margin")]
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmInt), "_edge_blur_size")]
    ...
    public class MSER_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.UIHint (HutongGames.PlayMaker.UIHint.Variable)]
        [HutongGames.PlayMaker.ObjectType (typeof (OpenCVForUnityPlayMakerActions.Double))]
        public HutongGames.PlayMaker.FsmObject _min_margin;

        [HutongGames.PlayMaker.ActionSection ("[arg9] int")]
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.ObjectType (typeof (HutongGames.PlayMaker.FsmInt))]
        public HutongGames.PlayMaker.FsmInt _edge_blur_size;
        ...
        void DoProcess ()
        {
            ...
            if (!(_min_margin.Value is OpenCVForUnityPlayMakerActions.Double))
            {
                LogError ("_min_margin is not initialized. Add Action \"newDouble\".");
                return;
            }
            System.Double wrapped__min_margin = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Double, System.Double> (_min_margin);

            if (!(storeResult.Value is OpenCVForUnityPlayMakerActions.MSER)) storeResult.Value = new OpenCVForUnityPlayMakerActions.MSER ();
            ((OpenCVForUnityPlayMakerActions.MSER)storeResult.Value).wrappedObject = OpenCVForUnity.Features2dModule.MSER.create (_delta.Value, _min_area.Value, _max_area.Value, wrapped__max_variation, wrapped__min_diversity, _max_evolution.Value, wrapped__area_threshold, wrapped__min_margin, _edge_blur_size.Value);
