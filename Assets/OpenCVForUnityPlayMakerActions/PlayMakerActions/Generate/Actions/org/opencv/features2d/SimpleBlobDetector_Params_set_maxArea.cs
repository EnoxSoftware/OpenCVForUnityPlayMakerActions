...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_maxArea(float maxArea)")]
    ...
    public class SimpleBlobDetector_Params_set_maxArea : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_maxArea(maxArea.Value);
