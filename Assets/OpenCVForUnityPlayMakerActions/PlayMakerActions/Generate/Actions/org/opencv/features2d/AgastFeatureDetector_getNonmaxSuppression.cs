...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public  bool getNonmaxSuppression ()")]
    ...
    public class AgastFeatureDetector_getNonmaxSuppression : HutongGames.PlayMaker.FsmStateAction
    {
