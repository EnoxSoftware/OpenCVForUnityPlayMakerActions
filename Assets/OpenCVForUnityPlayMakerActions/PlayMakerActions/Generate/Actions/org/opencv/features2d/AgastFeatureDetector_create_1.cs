...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class AgastFeatureDetector_create_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.AgastFeatureDetector)storeResult.Value).wrappedObject = OpenCVForUnity.Features2dModule.AgastFeatureDetector.create(threshold.Value, nonmaxSuppression.Value);
