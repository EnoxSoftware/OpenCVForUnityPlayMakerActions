...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class MSER_create_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MSER)storeResult.Value).wrappedObject = OpenCVForUnity.Features2dModule.MSER.create(delta.Value, min_area.Value, max_area.Value, (float)max_variation.Value, (float)min_diversity.Value, max_evolution.Value, (float)area_threshold.Value, (float)min_margin.Value);
