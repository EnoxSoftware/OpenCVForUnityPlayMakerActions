...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class SimpleBlobDetector_Params_set_filterByInertia : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool filterByInertia;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_filterByInertia(filterByInertia.Value);
