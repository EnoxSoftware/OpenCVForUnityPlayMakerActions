...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setMaxEvolution(int maxEvolution)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.MSER), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "maxEvolution")]
    public class MSER_setMaxEvolution : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt maxEvolution;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setMaxEvolution(maxEvolution.Value);
