...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public SimpleBlobDetector_Params getParams()")]
    ...
    public class SimpleBlobDetector_getParams : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SimpleBlobDetector_Params)storeResult.Value).wrappedObject = wrapped_owner.getParams();
