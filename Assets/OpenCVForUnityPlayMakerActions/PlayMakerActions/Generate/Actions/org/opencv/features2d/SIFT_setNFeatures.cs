...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setNFeatures(int maxFeatures)")]
    ...
    public class SIFT_setNFeatures : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setNFeatures(maxFeatures.Value);
