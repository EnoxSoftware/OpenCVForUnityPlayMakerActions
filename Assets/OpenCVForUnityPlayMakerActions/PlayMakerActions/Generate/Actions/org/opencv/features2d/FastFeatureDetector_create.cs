...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class FastFeatureDetector_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.FastFeatureDetector)storeResult.Value).wrappedObject = OpenCVForUnity.FastFeatureDetector.create (threshold.Value, nonmaxSuppression.Value, type.Value);
