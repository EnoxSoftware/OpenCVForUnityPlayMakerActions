...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_minArea(float minArea)")]
    ...
    public class SimpleBlobDetector_Params_set_minArea : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_minArea(minArea.Value);
