...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class BRISK_create_9 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.BRISK)storeResult.Value).wrappedObject = OpenCVForUnity.Features2dModule.BRISK.create(thresh.Value, octaves.Value, wrapped_radiusList, wrapped_numberList, dMax.Value, dMin.Value);
