...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class SIFT_create_6_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SIFT)storeResult.Value).wrappedObject = OpenCVForUnity.Features2dModule.SIFT.create(nfeatures.Value, nOctaveLayers.Value, (float)contrastThreshold.Value, (float)edgeThreshold.Value, (float)sigma.Value, descriptorType.Value);
