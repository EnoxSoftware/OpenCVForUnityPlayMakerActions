...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void detect (Mat image, MatOfKeyPoint keypoints)")]
    ...
    public class FeatureDetector_detect_1 : HutongGames.PlayMaker.FsmStateAction
    {
