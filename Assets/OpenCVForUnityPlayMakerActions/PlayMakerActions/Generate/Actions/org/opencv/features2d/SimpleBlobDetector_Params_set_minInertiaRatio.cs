...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class SimpleBlobDetector_Params_set_minInertiaRatio : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat minInertiaRatio;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_minInertiaRatio(minInertiaRatio.Value);
