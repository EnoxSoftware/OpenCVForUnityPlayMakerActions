...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class SimpleBlobDetector_Params_set_filterByConvexity : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool filterByConvexity;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_filterByConvexity(filterByConvexity.Value);
