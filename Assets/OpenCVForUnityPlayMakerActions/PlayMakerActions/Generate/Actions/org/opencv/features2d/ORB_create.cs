...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class ORB_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ORB)storeResult.Value).wrappedObject = OpenCVForUnity.ORB.create (nfeatures.Value, scaleFactor.Value, nlevels.Value, edgeThreshold.Value, firstLevel.Value, WTA_K.Value, scoreType.Value, patchSize.Value, fastThreshold.Value);
