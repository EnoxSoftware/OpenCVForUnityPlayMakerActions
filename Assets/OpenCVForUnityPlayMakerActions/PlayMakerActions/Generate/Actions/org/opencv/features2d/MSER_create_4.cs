...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class MSER_create_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MSER)storeResult.Value).wrappedObject = OpenCVForUnity.Features2dModule.MSER.create(delta.Value, min_area.Value, max_area.Value, wrapped_max_variation, wrapped_min_diversity);
