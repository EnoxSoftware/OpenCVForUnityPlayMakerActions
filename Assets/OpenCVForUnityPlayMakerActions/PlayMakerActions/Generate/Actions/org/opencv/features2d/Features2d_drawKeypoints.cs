...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Features2d_drawKeypoints : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Features2dModule.Features2d.drawKeypoints(wrapped_image, wrapped_keypoints, wrapped_outImage, wrapped_color, flags.Value);
