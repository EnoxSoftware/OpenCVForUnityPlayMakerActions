...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_maxConvexity(float maxConvexity)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.SimpleBlobDetector_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "maxConvexity")]
    public class SimpleBlobDetector_Params_set_maxConvexity : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat maxConvexity;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_maxConvexity(maxConvexity.Value);
