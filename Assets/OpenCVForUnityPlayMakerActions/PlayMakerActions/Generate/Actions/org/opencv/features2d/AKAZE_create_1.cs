...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class AKAZE_create_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.AKAZE)storeResult.Value).wrappedObject = OpenCVForUnity.Features2dModule.AKAZE.create (descriptor_type.Value, descriptor_size.Value, descriptor_channels.Value, threshold.Value, nOctaves.Value, nOctaveLayers.Value);
