...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (OpenCVForUnityPlayMakerActions.Double), "nu11")]
    public class Moments_set_nu11 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmObject nu11;
        ...
        void DoProcess ()
        {
            ...
            if (!(nu11.Value is OpenCVForUnityPlayMakerActions.Double))
            {
                LogError ("nu11 is not initialized. Add Action \"newDouble\".");
                return;
            }
            System.Double wrapped_nu11 = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Double, System.Double> (nu11);

            wrapped_owner.set_nu11 (wrapped_nu11);
