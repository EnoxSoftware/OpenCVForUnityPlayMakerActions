...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void Sobel(Mat src, Mat dst, int ddepth, int dx, int dy)")]
    ...
    public class Imgproc_Sobel_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.Sobel(wrapped_src, wrapped_dst, ddepth.Value, dx.Value, dy.Value);
