...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_HoughLines_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.HoughLines (wrapped_image, wrapped_lines, (float)rho.Value, (float)theta.Value, threshold.Value, (float)srn.Value, (float)stn.Value, (float)min_theta.Value);
