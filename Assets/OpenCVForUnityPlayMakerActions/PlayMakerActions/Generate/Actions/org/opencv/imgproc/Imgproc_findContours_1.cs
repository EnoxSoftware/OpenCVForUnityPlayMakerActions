...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void findContours(Mat image, List<MatOfPoint> contours, Mat hierarchy, int mode, int method)")]
    ...
    public class Imgproc_findContours_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.findContours(wrapped_image, wrapped_contours, wrapped_hierarchy, mode.Value, method.Value);
