...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_initUndistortRectifyMap : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.initUndistortRectifyMap (wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_R, wrapped_newCameraMatrix, wrapped_size, m1type.Value, wrapped_map1, wrapped_map2);
