...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_linearPolar_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.linearPolar (wrapped_src, wrapped_dst, new OpenCVForUnity.Point ((double)center_x.Value, (double)center_y.Value), wrapped_maxRadius, flags.Value);
