...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void Laplacian (Mat src, Mat dst, int ddepth, int ksize, double scale, double delta)")]
    ...
    public class Imgproc_Laplacian_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.Laplacian (wrapped_src, wrapped_dst, ddepth.Value, ksize.Value, (float)scale.Value, (float)delta.Value);
