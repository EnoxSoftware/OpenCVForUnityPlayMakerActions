...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_grabCut_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.grabCut (wrapped_img, wrapped_mask, new OpenCVForUnity.CoreModule.Rect ((int)rect_x.Value, (int)rect_y.Value, (int)rect_width.Value, (int)rect_height.Value), wrapped_bgdModel, wrapped_fgdModel, iterCount.Value, mode.Value);
