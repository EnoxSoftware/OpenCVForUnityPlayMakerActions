...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class LineSegmentDetector_compareSegments_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.compareSegments(wrapped_size, wrapped_lines1, wrapped_lines2);
