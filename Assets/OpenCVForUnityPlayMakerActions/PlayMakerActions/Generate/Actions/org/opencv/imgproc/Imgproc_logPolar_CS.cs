...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_logPolar_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.logPolar (wrapped_src, wrapped_dst, new OpenCVForUnity.Point ((double)center_x.Value, (double)center_y.Value), (float)M.Value, flags.Value);
