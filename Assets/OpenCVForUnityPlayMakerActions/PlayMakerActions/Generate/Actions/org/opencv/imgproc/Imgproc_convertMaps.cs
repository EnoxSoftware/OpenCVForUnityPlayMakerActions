...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void convertMaps (Mat map1, Mat map2, Mat dstmap1, Mat dstmap2, int dstmap1type, bool nninterpolation)")]
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmBool), "nninterpolation")]
    public class Imgproc_convertMaps : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool nninterpolation;
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.convertMaps (wrapped_map1, wrapped_map2, wrapped_dstmap1, wrapped_dstmap2, dstmap1type.Value, nninterpolation.Value);
