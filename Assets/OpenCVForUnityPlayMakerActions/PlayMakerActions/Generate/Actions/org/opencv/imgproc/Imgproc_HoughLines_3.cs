...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_HoughLines_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.HoughLines (wrapped_image, wrapped_lines, wrapped_rho, wrapped_theta, threshold.Value, wrapped_srn);
