...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_phaseCorrelate : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Point)storeResult.Value).wrappedObject = OpenCVForUnity.Imgproc.phaseCorrelate (wrapped_src1, wrapped_src2, wrapped_window, wrapped_response);
