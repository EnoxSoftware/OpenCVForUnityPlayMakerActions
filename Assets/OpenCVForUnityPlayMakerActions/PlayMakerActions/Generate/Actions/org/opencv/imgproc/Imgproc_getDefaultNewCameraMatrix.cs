...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_getDefaultNewCameraMatrix : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Imgproc.getDefaultNewCameraMatrix (wrapped_cameraMatrix, wrapped_imgsize, centerPrincipalPoint.Value);
