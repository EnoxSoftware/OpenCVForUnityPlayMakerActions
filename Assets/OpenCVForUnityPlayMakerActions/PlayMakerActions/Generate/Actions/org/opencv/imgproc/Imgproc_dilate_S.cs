...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_dilate_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.dilate (wrapped_src, wrapped_dst, wrapped_kernel, new OpenCVForUnity.Point ((double)anchor_x.Value, (double)anchor_y.Value), iterations.Value, borderType.Value, new OpenCVForUnity.Scalar ((double)borderValue_v0.Value, (double)borderValue_v1.Value, (double)borderValue_v2.Value, (double)borderValue_v3.Value));
