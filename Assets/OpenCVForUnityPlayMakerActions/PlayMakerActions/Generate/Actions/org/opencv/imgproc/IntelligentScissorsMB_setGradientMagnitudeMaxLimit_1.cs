...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public IntelligentScissorsMB setGradientMagnitudeMaxLimit()")]
    ...
    public class IntelligentScissorsMB_setGradientMagnitudeMaxLimit_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.IntelligentScissorsMB)storeResult.Value).wrappedObject = wrapped_owner.setGradientMagnitudeMaxLimit();
