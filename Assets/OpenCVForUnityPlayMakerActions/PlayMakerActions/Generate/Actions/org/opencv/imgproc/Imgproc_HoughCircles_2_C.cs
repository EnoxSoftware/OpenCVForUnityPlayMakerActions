...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_HoughCircles_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.HoughCircles (wrapped_image, wrapped_circles, method.Value, (float)dp.Value, (float)minDist.Value, (float)param1.Value, (float)param2.Value);
