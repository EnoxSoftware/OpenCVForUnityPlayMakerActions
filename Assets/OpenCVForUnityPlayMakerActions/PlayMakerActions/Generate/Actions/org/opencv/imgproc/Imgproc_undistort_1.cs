...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_undistort_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.undistort (wrapped_src, wrapped_dst, wrapped_cameraMatrix, wrapped_distCoeffs);
