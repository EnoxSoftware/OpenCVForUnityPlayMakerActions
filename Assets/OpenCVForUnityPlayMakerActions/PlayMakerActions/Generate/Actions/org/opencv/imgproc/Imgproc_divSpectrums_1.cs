...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void divSpectrums(Mat a, Mat b, Mat c, int flags)")]
    ...
    public class Imgproc_divSpectrums_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.divSpectrums(wrapped_a, wrapped_b, wrapped_c, flags.Value);
