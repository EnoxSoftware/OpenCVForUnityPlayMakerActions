...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void cvtColorTwoPlane (Mat src1, Mat src2, Mat dst, int code)")]
    ...
    public class Imgproc_cvtColorTwoPlane : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.cvtColorTwoPlane (wrapped_src1, wrapped_src2, wrapped_dst, code.Value);
