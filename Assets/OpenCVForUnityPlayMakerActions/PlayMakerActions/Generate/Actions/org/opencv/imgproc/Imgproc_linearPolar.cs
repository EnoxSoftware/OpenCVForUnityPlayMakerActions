...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_linearPolar : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.linearPolar (wrapped_src, wrapped_dst, wrapped_center, wrapped_maxRadius, flags.Value);
