...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public IntelligentScissorsMB setEdgeFeatureCannyParameters(double threshold1, double threshold2)")]
    ...
    public class IntelligentScissorsMB_setEdgeFeatureCannyParameters_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.IntelligentScissorsMB)storeResult.Value).wrappedObject = wrapped_owner.setEdgeFeatureCannyParameters(wrapped_threshold1, wrapped_threshold2);
