...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class GeneralizedHoughGuil_getAngleEpsilon : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = wrapped_owner.getAngleEpsilon();
