...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static LineSegmentDetector createLineSegmentDetector(int refine, double scale, double sigma_scale, double quant, double ang_th, double log_eps, double density_th, int n_bins)")]
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.Double), "density_th")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "n_bins")]
    ...
    public class Imgproc_createLineSegmentDetector : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.UIHint(HutongGames.PlayMaker.UIHint.Variable)]
        [HutongGames.PlayMaker.ObjectType(typeof(OpenCVForUnityPlayMakerActions.Double))]
        public HutongGames.PlayMaker.FsmObject density_th;

        [HutongGames.PlayMaker.ActionSection("[arg8] int")]
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.ObjectType(typeof(HutongGames.PlayMaker.FsmInt))]
        public HutongGames.PlayMaker.FsmInt n_bins;
        ...
        void DoProcess()
        {
            ...
            if (!(density_th.Value is OpenCVForUnityPlayMakerActions.Double))
            {
                LogError("density_th is not initialized. Add Action \"newDouble\".");
                return;
            }
            System.Double wrapped_density_th = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Double, System.Double>(density_th);
            ...
            ((OpenCVForUnityPlayMakerActions.LineSegmentDetector)storeResult.Value).wrappedObject = OpenCVForUnity.ImgprocModule.Imgproc.createLineSegmentDetector(refine.Value, wrapped_scale, wrapped_sigma_scale, wrapped_quant, wrapped_ang_th, wrapped_log_eps, wrapped_density_th, n_bins.Value);
