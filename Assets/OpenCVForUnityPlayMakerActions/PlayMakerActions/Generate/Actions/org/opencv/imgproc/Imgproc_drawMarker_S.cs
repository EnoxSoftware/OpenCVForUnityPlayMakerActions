...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_drawMarker_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.drawMarker (wrapped_img, new OpenCVForUnity.Point ((double)position_x.Value, (double)position_y.Value), new OpenCVForUnity.Scalar ((double)color_v0.Value, (double)color_v1.Value, (double)color_v2.Value, (double)color_v3.Value), markerType.Value, markerSize.Value, thickness.Value, line_type.Value);
