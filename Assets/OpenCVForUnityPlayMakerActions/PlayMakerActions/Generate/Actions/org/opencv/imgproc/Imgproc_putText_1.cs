...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_putText_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.putText(wrapped_img, text.Value, wrapped_org, fontFace.Value, wrapped_fontScale, wrapped_color, thickness.Value, lineType.Value);
