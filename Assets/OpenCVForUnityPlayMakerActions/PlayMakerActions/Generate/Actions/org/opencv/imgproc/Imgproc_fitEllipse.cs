...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static RotatedRect fitEllipse (MatOfPoint2f points)")]
    ...
    public class Imgproc_fitEllipse : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.RotatedRect)storeResult.Value).wrappedObject = OpenCVForUnity.ImgprocModule.Imgproc.fitEllipse (wrapped_points);
