...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_HoughLinesWithAccumulator_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.HoughLinesWithAccumulator(wrapped_image, wrapped_lines, wrapped_rho, wrapped_theta, threshold.Value, wrapped_srn, wrapped_stn);
