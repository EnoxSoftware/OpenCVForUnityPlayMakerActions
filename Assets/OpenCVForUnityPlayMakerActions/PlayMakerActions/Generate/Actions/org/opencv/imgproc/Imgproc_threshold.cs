...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_threshold : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = OpenCVForUnity.Imgproc.threshold (wrapped_src, wrapped_dst, wrapped_thresh, wrapped_maxval, type.Value);
