...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_getRectSubPix_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.getRectSubPix(wrapped_image, new OpenCVForUnity.CoreModule.Size((double)patchSize_width.Value, (double)patchSize_height.Value), new OpenCVForUnity.CoreModule.Point((double)center_x.Value, (double)center_y.Value), wrapped_patch);
