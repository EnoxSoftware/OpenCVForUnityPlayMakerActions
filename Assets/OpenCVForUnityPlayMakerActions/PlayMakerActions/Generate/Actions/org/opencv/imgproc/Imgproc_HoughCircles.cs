...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_HoughCircles : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.HoughCircles (wrapped_image, wrapped_circles, method.Value, wrapped_dp, wrapped_minDist, wrapped_param1, wrapped_param2, minRadius.Value, maxRadius.Value);
