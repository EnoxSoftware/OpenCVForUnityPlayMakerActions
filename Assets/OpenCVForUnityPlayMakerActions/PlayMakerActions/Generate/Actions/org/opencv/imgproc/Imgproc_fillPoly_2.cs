...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_fillPoly_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.fillPoly (wrapped_img, wrapped_pts, wrapped_color, lineType.Value);
