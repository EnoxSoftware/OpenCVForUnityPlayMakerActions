...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void bilateralFilter(Mat src, Mat dst, int d, double sigmaColor, double sigmaSpace)")]
    ...
    public class Imgproc_bilateralFilter_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.bilateralFilter(wrapped_src, wrapped_dst, d.Value, (float)sigmaColor.Value, (float)sigmaSpace.Value);
