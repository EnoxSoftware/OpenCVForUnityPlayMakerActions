...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.Double), "maxAngle")]
    public class GeneralizedHoughGuil_setMaxAngle : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmObject maxAngle;
        ...
        void DoProcess()
        {
            ...
            if (!(maxAngle.Value is OpenCVForUnityPlayMakerActions.Double))
            {
                LogError("maxAngle is not initialized. Add Action \"newDouble\".");
                return;
            }
            System.Double wrapped_maxAngle = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Double, System.Double>(maxAngle);

            wrapped_owner.setMaxAngle(wrapped_maxAngle);
