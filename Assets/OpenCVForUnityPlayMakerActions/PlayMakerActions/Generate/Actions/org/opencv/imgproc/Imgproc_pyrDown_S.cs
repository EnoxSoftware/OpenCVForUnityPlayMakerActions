...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_pyrDown_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.pyrDown (wrapped_src, wrapped_dst, new OpenCVForUnity.Size ((double)dstsize_width.Value, (double)dstsize_height.Value), borderType.Value);
