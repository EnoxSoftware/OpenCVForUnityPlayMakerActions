...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_GaussianBlur_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.GaussianBlur(wrapped_src, wrapped_dst, wrapped_ksize, (float)sigmaX.Value, (float)sigmaY.Value, borderType.Value);
