...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_arrowedLine_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.arrowedLine(wrapped_img, wrapped_pt1, wrapped_pt2, wrapped_color, thickness.Value, line_type.Value, shift.Value, (float)tipLength.Value);
