...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_polylines_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.polylines(wrapped_img, wrapped_pts, isClosed.Value, wrapped_color, thickness.Value, lineType.Value);
