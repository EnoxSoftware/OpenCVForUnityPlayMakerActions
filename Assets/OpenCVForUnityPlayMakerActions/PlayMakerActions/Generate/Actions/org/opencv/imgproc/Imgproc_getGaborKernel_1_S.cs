...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_getGaborKernel_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.ImgprocModule.Imgproc.getGaborKernel(new OpenCVForUnity.CoreModule.Size((double)ksize_width.Value, (double)ksize_height.Value), wrapped_sigma, wrapped_theta, wrapped_lambd, wrapped_gamma, wrapped_psi);
