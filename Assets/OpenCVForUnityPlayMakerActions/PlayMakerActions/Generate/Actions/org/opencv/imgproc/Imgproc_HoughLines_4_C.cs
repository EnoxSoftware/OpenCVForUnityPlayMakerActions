...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_HoughLines_4_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.HoughLines (wrapped_image, wrapped_lines, (float)rho.Value, (float)theta.Value, threshold.Value);
