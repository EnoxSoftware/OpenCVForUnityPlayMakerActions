...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_warpPerspective_2_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.warpPerspective (wrapped_src, wrapped_dst, wrapped_M, new OpenCVForUnity.CoreModule.Size ((double)dsize_width.Value, (double)dsize_height.Value), flags.Value);
