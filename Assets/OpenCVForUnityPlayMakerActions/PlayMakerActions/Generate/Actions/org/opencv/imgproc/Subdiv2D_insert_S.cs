...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public int insert(Point pt)")]
    ...
    public class Subdiv2D_insert_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.insert(new OpenCVForUnity.CoreModule.Point((double)pt_x.Value, (double)pt_y.Value));
