...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_sepFilter2D : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.sepFilter2D(wrapped_src, wrapped_dst, ddepth.Value, wrapped_kernelX, wrapped_kernelY, wrapped_anchor, wrapped_delta, borderType.Value);
