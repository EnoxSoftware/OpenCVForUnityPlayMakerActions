...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (OpenCVForUnityPlayMakerActions.Double), "nu03")]
    public class Moments_set_nu03 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmObject nu03;
        ...
        void DoProcess ()
        {
            ...
            if (!(nu03.Value is OpenCVForUnityPlayMakerActions.Double))
            {
                LogError ("nu03 is not initialized. Add Action \"newDouble\".");
                return;
            }
            System.Double wrapped_nu03 = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Double, System.Double> (nu03);

            wrapped_owner.set_nu03 (wrapped_nu03);
