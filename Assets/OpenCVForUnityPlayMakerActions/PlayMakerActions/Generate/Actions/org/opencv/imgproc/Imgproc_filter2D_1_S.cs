...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_filter2D_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.filter2D(wrapped_src, wrapped_dst, ddepth.Value, wrapped_kernel, new OpenCVForUnity.CoreModule.Point((double)anchor_x.Value, (double)anchor_y.Value), wrapped_delta);
