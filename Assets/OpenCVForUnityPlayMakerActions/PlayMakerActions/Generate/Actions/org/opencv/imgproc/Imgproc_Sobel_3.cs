...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void Sobel (Mat src, Mat dst, int ddepth, int dx, int dy, int ksize)")]
    ...
    public class Imgproc_Sobel_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.Sobel (wrapped_src, wrapped_dst, ddepth.Value, dx.Value, dy.Value, ksize.Value);
