...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_warpPerspective_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.warpPerspective(wrapped_src, wrapped_dst, wrapped_M, wrapped_dsize);
