...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_pyrMeanShiftFiltering_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.pyrMeanShiftFiltering(wrapped_src, wrapped_dst, (float)sp.Value, (float)sr.Value);
