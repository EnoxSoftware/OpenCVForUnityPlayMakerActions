...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_warpAffine : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.warpAffine(wrapped_src, wrapped_dst, wrapped_M, wrapped_dsize, flags.Value, borderMode.Value, wrapped_borderValue);
