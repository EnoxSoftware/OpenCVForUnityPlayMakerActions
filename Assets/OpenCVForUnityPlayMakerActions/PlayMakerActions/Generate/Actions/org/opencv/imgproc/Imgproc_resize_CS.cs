...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_resize_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.resize (wrapped_src, wrapped_dst, new OpenCVForUnity.Size ((double)dsize_width.Value, (double)dsize_height.Value), (float)fx.Value, (float)fy.Value, interpolation.Value);
