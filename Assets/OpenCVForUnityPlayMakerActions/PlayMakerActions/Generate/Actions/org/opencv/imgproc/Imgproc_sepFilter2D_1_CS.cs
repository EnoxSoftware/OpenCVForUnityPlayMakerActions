...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_sepFilter2D_1_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.sepFilter2D(wrapped_src, wrapped_dst, ddepth.Value, wrapped_kernelX, wrapped_kernelY, new OpenCVForUnity.CoreModule.Point((double)anchor_x.Value, (double)anchor_y.Value), (float)delta.Value);
