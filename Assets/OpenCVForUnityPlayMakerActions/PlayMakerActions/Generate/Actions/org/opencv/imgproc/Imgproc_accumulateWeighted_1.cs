...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_accumulateWeighted_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.accumulateWeighted(wrapped_src, wrapped_dst, wrapped_alpha);
