...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_sepFilter2D_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.sepFilter2D (wrapped_src, wrapped_dst, ddepth.Value, wrapped_kernelX, wrapped_kernelY, wrapped_anchor, (float)delta.Value, borderType.Value);
