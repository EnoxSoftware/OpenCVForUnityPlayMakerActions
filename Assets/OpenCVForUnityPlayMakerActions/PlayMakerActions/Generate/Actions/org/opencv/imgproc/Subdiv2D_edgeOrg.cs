...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Subdiv2D_edgeOrg : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Point wrapped_orgpt = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Point, OpenCVForUnity.CoreModule.Point>(orgpt);
