...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void Scharr(Mat src, Mat dst, int ddepth, int dx, int dy, double scale, double delta, int borderType)")]
    ...
    public class Imgproc_Scharr_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.Scharr(wrapped_src, wrapped_dst, ddepth.Value, dx.Value, dy.Value, (float)scale.Value, (float)delta.Value, borderType.Value);
