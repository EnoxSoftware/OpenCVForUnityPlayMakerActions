...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_logPolar_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.logPolar (wrapped_src, wrapped_dst, wrapped_center, (float)M.Value, flags.Value);
