...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static float intersectConvexConvex(Mat p1, Mat p2, Mat p12)")]
    ...
    public class Imgproc_intersectConvexConvex_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.ImgprocModule.Imgproc.intersectConvexConvex(wrapped_p1, wrapped_p2, wrapped_p12);
