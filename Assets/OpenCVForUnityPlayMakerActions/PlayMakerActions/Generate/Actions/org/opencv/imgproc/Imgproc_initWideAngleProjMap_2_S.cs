...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_initWideAngleProjMap_2_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Imgproc.initWideAngleProjMap (wrapped_cameraMatrix, wrapped_distCoeffs, new OpenCVForUnity.Size ((double)imageSize_width.Value, (double)imageSize_height.Value), destImageWidth.Value, m1type.Value, wrapped_map1, wrapped_map2);
