...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_erode_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.erode (wrapped_src, wrapped_dst, wrapped_kernel, new OpenCVForUnity.Point ((double)anchor_x.Value, (double)anchor_y.Value), iterations.Value, borderType.Value);
