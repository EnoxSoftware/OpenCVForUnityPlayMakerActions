...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static int floodFill (Mat image, Mat mask, Point seedPoint, Scalar newVal, Rect rect, Scalar loDiff)")]
    ...
    public class Imgproc_floodFill_2_S : HutongGames.PlayMaker.FsmStateAction
    {
