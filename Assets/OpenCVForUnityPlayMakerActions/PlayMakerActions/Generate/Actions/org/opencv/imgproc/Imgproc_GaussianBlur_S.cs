...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_GaussianBlur_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.GaussianBlur (wrapped_src, wrapped_dst, new OpenCVForUnity.Size ((double)ksize_width.Value, (double)ksize_height.Value), wrapped_sigmaX, wrapped_sigmaY, borderType.Value);
