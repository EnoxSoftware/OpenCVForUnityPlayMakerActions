...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void HoughLinesWithAccumulator(Mat image, Mat lines, double rho, double theta, int threshold, double srn, double stn)")]
    ...
    public class Imgproc_HoughLinesWithAccumulator_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.HoughLinesWithAccumulator(wrapped_image, wrapped_lines, (float)rho.Value, (float)theta.Value, threshold.Value, (float)srn.Value, (float)stn.Value);
