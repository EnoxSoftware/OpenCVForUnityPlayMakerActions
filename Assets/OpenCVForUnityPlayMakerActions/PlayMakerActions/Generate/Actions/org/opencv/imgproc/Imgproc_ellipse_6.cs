...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void ellipse (Mat img, RotatedRect box, Scalar color)")]
    ...
    public class Imgproc_ellipse_6 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.ellipse (wrapped_img, wrapped_box, wrapped_color);
