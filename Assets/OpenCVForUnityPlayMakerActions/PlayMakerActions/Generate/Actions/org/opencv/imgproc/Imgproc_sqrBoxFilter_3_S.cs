...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void sqrBoxFilter(Mat src, Mat dst, int ddepth, Size ksize)")]
    ...
    public class Imgproc_sqrBoxFilter_3_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.sqrBoxFilter(wrapped_src, wrapped_dst, ddepth.Value, new OpenCVForUnity.CoreModule.Size((double)ksize_width.Value, (double)ksize_height.Value));
