...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void getContour(Point targetPt, Mat contour)")]
    ...
    public class IntelligentScissorsMB_getContour_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.getContour(new OpenCVForUnity.CoreModule.Point((double)targetPt_x.Value, (double)targetPt_y.Value), wrapped_contour);
