...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_resize_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.resize (wrapped_src, wrapped_dst, wrapped_dsize, (float)fx.Value, (float)fy.Value, interpolation.Value);
