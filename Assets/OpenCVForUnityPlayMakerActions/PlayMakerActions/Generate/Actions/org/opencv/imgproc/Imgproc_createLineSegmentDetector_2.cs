...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_createLineSegmentDetector_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.LineSegmentDetector)storeResult.Value).wrappedObject = OpenCVForUnity.ImgprocModule.Imgproc.createLineSegmentDetector(_refine.Value, wrapped__scale, wrapped__sigma_scale, wrapped__quant, wrapped__ang_th, wrapped__log_eps);
