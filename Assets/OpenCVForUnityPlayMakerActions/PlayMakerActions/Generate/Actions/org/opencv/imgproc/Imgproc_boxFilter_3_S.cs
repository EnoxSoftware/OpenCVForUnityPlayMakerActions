...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_boxFilter_3_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.boxFilter (wrapped_src, wrapped_dst, ddepth.Value, new OpenCVForUnity.CoreModule.Size ((double)ksize_width.Value, (double)ksize_height.Value));
