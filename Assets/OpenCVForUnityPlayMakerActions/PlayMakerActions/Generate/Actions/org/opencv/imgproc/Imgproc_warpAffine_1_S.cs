...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_warpAffine_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.warpAffine(wrapped_src, wrapped_dst, wrapped_M, new OpenCVForUnity.CoreModule.Size((double)dsize_width.Value, (double)dsize_height.Value), flags.Value, borderMode.Value);
