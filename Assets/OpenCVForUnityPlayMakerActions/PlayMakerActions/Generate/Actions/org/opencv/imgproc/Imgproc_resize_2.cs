...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_resize_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.resize(wrapped_src, wrapped_dst, wrapped_dsize, wrapped_fx);
