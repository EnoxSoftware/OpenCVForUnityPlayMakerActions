...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_morphologyEx_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.morphologyEx(wrapped_src, wrapped_dst, op.Value, wrapped_kernel);
