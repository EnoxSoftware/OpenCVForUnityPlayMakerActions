...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_arrowedLine_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.arrowedLine (wrapped_img, wrapped_pt1, wrapped_pt2, wrapped_color);
