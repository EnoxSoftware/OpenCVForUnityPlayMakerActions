...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class GeneralizedHough_setTemplate : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setTemplate (wrapped_edges, wrapped_dx, wrapped_dy, wrapped_templCenter);
