...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Subdiv2D_findNearest_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.findNearest(new OpenCVForUnity.CoreModule.Point((double)pt_x.Value, (double)pt_y.Value));
