...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_grabCut : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.grabCut(wrapped_img, wrapped_mask, wrapped_rect, wrapped_bgdModel, wrapped_fgdModel, iterCount.Value, mode.Value);
