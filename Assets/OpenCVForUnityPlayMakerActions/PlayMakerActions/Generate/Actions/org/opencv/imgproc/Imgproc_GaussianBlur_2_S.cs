...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_GaussianBlur_2_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.GaussianBlur(wrapped_src, wrapped_dst, new OpenCVForUnity.CoreModule.Size((double)ksize_width.Value, (double)ksize_height.Value), wrapped_sigmaX);
