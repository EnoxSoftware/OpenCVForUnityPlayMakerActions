...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_integral2_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.integral2(wrapped_src, wrapped_sum, wrapped_sqsum);
