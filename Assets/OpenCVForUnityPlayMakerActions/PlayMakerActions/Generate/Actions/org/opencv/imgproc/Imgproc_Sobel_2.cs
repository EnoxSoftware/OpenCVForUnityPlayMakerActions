...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_Sobel_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.Sobel (wrapped_src, wrapped_dst, ddepth.Value, dx.Value, dy.Value, ksize.Value, wrapped_scale);
