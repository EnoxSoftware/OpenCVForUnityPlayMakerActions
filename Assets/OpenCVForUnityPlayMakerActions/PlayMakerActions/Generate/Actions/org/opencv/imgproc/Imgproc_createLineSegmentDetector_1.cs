...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_createLineSegmentDetector_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.LineSegmentDetector)storeResult.Value).wrappedObject = OpenCVForUnity.Imgproc.createLineSegmentDetector (_refine.Value, wrapped__scale, wrapped__sigma_scale, wrapped__quant, wrapped__ang_th, wrapped__log_eps, wrapped__density_th);
