...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void calcBackProject (List<Mat> images, MatOfInt channels, Mat hist, Mat dst, MatOfFloat ranges, double scale)")]
    ...
    public class Imgproc_calcBackProject_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.calcBackProject (wrapped_images, wrapped_channels, wrapped_hist, wrapped_dst, wrapped_ranges, (float)scale.Value);
