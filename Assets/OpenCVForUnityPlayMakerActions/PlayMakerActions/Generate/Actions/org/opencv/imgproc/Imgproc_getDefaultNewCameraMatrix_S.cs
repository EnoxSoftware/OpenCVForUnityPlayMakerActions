...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_getDefaultNewCameraMatrix_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Imgproc.getDefaultNewCameraMatrix (wrapped_cameraMatrix, new OpenCVForUnity.Size ((double)imgsize_width.Value, (double)imgsize_height.Value), centerPrincipalPoint.Value);
