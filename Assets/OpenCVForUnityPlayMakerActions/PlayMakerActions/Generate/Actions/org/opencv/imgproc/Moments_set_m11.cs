...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (OpenCVForUnityPlayMakerActions.Double), "m11")]
    public class Moments_set_m11 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmObject m11;
        ...
        void DoProcess ()
        {
            ...
            if (!(m11.Value is OpenCVForUnityPlayMakerActions.Double))
            {
                LogError ("m11 is not initialized. Add Action \"newDouble\".");
                return;
            }
            System.Double wrapped_m11 = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Double, System.Double> (m11);

            wrapped_owner.set_m11 (wrapped_m11);
