...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_accumulateWeighted : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.accumulateWeighted(wrapped_src, wrapped_dst, wrapped_alpha, wrapped_mask);
