...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Moments_get_m11 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = wrapped_owner.get_m11 ();
