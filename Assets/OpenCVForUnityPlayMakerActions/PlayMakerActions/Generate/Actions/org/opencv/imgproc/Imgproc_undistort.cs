...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void undistort (Mat src, Mat dst, Mat cameraMatrix, Mat distCoeffs, Mat newCameraMatrix)")]
    ...
    public class Imgproc_undistort : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.undistort (wrapped_src, wrapped_dst, wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_newCameraMatrix);
