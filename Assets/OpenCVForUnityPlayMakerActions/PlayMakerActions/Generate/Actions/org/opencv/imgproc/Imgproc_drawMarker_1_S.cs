...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void drawMarker(Mat img, Point position, Scalar color, int markerType, int markerSize, int thickness)")]
    ...
    public class Imgproc_drawMarker_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.drawMarker(wrapped_img, new OpenCVForUnity.CoreModule.Point((double)position_x.Value, (double)position_y.Value), new OpenCVForUnity.CoreModule.Scalar((double)color_v0.Value, (double)color_v1.Value, (double)color_v2.Value, (double)color_v3.Value), markerType.Value, markerSize.Value, thickness.Value);
