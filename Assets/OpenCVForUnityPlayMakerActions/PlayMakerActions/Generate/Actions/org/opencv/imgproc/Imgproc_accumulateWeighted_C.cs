...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void accumulateWeighted(Mat src, Mat dst, double alpha, Mat mask)")]
    ...
    public class Imgproc_accumulateWeighted_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.accumulateWeighted(wrapped_src, wrapped_dst, (float)alpha.Value, wrapped_mask);
