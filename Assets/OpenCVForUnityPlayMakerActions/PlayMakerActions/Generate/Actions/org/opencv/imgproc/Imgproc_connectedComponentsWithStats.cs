...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static int connectedComponentsWithStats(Mat image, Mat labels, Mat stats, Mat centroids, int connectivity, int ltype)")]
    ...
    public class Imgproc_connectedComponentsWithStats : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.ImgprocModule.Imgproc.connectedComponentsWithStats(wrapped_image, wrapped_labels, wrapped_stats, wrapped_centroids, connectivity.Value, ltype.Value);
