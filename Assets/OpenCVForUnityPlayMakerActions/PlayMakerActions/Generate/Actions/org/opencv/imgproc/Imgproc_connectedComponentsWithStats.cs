...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_connectedComponentsWithStats : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Imgproc.connectedComponentsWithStats (wrapped_image, wrapped_labels, wrapped_stats, wrapped_centroids, connectivity.Value, ltype.Value);
