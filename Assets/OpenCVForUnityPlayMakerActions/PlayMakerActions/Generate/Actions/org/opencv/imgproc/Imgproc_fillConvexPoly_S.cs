...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void fillConvexPoly (Mat img, MatOfPoint points, Scalar color, int lineType, int shift)")]
    ...
    public class Imgproc_fillConvexPoly_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.fillConvexPoly (wrapped_img, wrapped_points, new OpenCVForUnity.CoreModule.Scalar ((double)color_v0.Value, (double)color_v1.Value, (double)color_v2.Value, (double)color_v3.Value), lineType.Value, shift.Value);
