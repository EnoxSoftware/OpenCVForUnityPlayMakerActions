...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_HoughCircles_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.HoughCircles (wrapped_image, wrapped_circles, method.Value, wrapped_dp, wrapped_minDist);
