...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_pyrUp_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.pyrUp(wrapped_src, wrapped_dst, new OpenCVForUnity.CoreModule.Size((double)dstsize_width.Value, (double)dstsize_height.Value), borderType.Value);
