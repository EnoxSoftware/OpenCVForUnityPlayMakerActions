...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_goodFeaturesToTrackWithQuality_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.goodFeaturesToTrackWithQuality(wrapped_image, wrapped_corners, maxCorners.Value, wrapped_qualityLevel, wrapped_minDistance, wrapped_mask, wrapped_cornersQuality);
