...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_rectangle_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.rectangle (wrapped_img, wrapped_pt1, wrapped_pt2, wrapped_color);
