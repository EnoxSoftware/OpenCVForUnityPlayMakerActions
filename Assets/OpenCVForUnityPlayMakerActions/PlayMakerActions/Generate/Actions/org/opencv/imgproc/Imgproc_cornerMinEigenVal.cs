...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void cornerMinEigenVal(Mat src, Mat dst, int blockSize, int ksize, int borderType)")]
    ...
    public class Imgproc_cornerMinEigenVal : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.cornerMinEigenVal(wrapped_src, wrapped_dst, blockSize.Value, ksize.Value, borderType.Value);
