...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_floodFill : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Imgproc.floodFill (wrapped_image, wrapped_mask, wrapped_seedPoint, wrapped_newVal, wrapped_rect, wrapped_loDiff, wrapped_upDiff, flags.Value);
