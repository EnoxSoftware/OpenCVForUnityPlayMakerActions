...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void linearPolar (Mat src, Mat dst, Point center, double maxRadius, int flags)")]
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmFloat), "maxRadius")]
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmInt), "flags")]
    public class Imgproc_linearPolar_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.ObjectType (typeof (HutongGames.PlayMaker.FsmFloat))]
        public HutongGames.PlayMaker.FsmFloat maxRadius;
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.linearPolar (wrapped_src, wrapped_dst, new OpenCVForUnity.Point ((double)center_x.Value, (double)center_y.Value), (float)maxRadius.Value, flags.Value);
