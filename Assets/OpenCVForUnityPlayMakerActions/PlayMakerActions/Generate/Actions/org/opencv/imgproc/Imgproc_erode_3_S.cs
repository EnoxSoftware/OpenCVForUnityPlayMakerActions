...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void erode (Mat src, Mat dst, Mat kernel, Point anchor)")]
    ...
    public class Imgproc_erode_3_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.erode (wrapped_src, wrapped_dst, wrapped_kernel, new OpenCVForUnity.CoreModule.Point ((double)anchor_x.Value, (double)anchor_y.Value));
