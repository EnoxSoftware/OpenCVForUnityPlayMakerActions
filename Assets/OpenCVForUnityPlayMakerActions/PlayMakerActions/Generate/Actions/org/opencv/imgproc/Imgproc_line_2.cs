...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_line_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.line (wrapped_img, wrapped_pt1, wrapped_pt2, wrapped_color, thickness.Value);
