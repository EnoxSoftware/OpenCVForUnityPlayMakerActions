...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_pyrMeanShiftFiltering_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.pyrMeanShiftFiltering (wrapped_src, wrapped_dst, (float)sp.Value, (float)sr.Value, maxLevel.Value, new OpenCVForUnity.TermCriteria ((int)termcrit_type.Value, (int)termcrit_maxCount.Value, (double)termcrit_epsilon.Value));
