...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_pyrMeanShiftFiltering_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat sp;
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.pyrMeanShiftFiltering(wrapped_src, wrapped_dst, (float)sp.Value, (float)sr.Value, maxLevel.Value, new OpenCVForUnity.CoreModule.TermCriteria((int)termcrit_type.Value, (int)termcrit_maxCount.Value, (double)termcrit_epsilon.Value));
