...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static Moments moments(Mat array)")]
    ...
    public class Imgproc_moments_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Moments)storeResult.Value).wrappedObject = OpenCVForUnity.ImgprocModule.Imgproc.moments(wrapped_array);
