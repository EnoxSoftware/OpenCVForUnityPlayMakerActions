...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_cornerHarris : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.cornerHarris (wrapped_src, wrapped_dst, blockSize.Value, ksize.Value, wrapped_k, borderType.Value);
