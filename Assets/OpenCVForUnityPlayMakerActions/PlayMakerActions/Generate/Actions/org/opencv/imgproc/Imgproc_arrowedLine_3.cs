...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void arrowedLine (Mat img, Point pt1, Point pt2, Scalar color, int thickness)")]
    ...
    public class Imgproc_arrowedLine_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.arrowedLine (wrapped_img, wrapped_pt1, wrapped_pt2, wrapped_color, thickness.Value);
