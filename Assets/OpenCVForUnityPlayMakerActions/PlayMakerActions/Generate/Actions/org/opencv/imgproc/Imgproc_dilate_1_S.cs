...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_dilate_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.dilate (wrapped_src, wrapped_dst, wrapped_kernel, new OpenCVForUnity.CoreModule.Point ((double)anchor_x.Value, (double)anchor_y.Value), iterations.Value, borderType.Value);
