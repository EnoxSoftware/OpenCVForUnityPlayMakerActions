...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_ellipse : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.ellipse (wrapped_img, wrapped_center, wrapped_axes, wrapped_angle, wrapped_startAngle, wrapped_endAngle, wrapped_color, thickness.Value, lineType.Value, shift.Value);
