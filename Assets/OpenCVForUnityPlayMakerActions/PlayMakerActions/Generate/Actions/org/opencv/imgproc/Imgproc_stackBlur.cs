...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_stackBlur : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.stackBlur(wrapped_src, wrapped_dst, wrapped_ksize);
