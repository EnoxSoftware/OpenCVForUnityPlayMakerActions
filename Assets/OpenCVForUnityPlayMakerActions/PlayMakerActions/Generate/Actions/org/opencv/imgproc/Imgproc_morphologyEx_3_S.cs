...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void morphologyEx (Mat src, Mat dst, int op, Mat kernel, Point anchor)")]
    ...
    public class Imgproc_morphologyEx_3_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.morphologyEx (wrapped_src, wrapped_dst, op.Value, wrapped_kernel, new OpenCVForUnity.CoreModule.Point ((double)anchor_x.Value, (double)anchor_y.Value));
