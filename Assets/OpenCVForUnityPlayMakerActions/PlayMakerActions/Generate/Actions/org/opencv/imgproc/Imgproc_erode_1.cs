...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_erode_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.erode(wrapped_src, wrapped_dst, wrapped_kernel, wrapped_anchor, iterations.Value, borderType.Value);
