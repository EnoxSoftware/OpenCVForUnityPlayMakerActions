...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void sepFilter2D(Mat src, Mat dst, int ddepth, Mat kernelX, Mat kernelY)")]
    ...
    public class Imgproc_sepFilter2D_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.sepFilter2D(wrapped_src, wrapped_dst, ddepth.Value, wrapped_kernelX, wrapped_kernelY);
