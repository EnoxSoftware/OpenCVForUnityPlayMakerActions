...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void detect(Mat image, Mat lines, Mat width, Mat prec, Mat nfa)")]
    ...
    public class LineSegmentDetector_detect : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.detect(wrapped_image, wrapped_lines, wrapped_width, wrapped_prec, wrapped_nfa);
