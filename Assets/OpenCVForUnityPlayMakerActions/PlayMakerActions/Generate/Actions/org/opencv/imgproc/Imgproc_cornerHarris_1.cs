...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_cornerHarris_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.cornerHarris(wrapped_src, wrapped_dst, blockSize.Value, ksize.Value, wrapped_k);
