...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_floodFill_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.ImgprocModule.Imgproc.floodFill (wrapped_image, wrapped_mask, wrapped_seedPoint, wrapped_newVal, wrapped_rect);
