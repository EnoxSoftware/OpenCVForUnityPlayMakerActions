...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_Scharr : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.Scharr(wrapped_src, wrapped_dst, ddepth.Value, dx.Value, dy.Value, wrapped_scale, wrapped_delta, borderType.Value);
