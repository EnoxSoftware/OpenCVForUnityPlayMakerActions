...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_polylines_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.polylines(wrapped_img, wrapped_pts, isClosed.Value, new OpenCVForUnity.CoreModule.Scalar((double)color_v0.Value, (double)color_v1.Value, (double)color_v2.Value, (double)color_v3.Value), thickness.Value, lineType.Value, shift.Value);
