...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_putText_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Point wrapped_org = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Point, OpenCVForUnity.CoreModule.Point>(org);
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.putText(wrapped_img, text.Value, wrapped_org, fontFace.Value, (float)fontScale.Value, wrapped_color, thickness.Value, lineType.Value, bottomLeftOrigin.Value);
