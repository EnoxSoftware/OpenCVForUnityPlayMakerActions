...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_circle_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.circle(wrapped_img, wrapped_center, radius.Value, wrapped_color);
