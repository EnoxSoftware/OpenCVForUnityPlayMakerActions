...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void HoughCircles(Mat image, Mat circles, int method, double dp, double minDist, double param1)")]
    ...
    public class Imgproc_HoughCircles_3_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.HoughCircles(wrapped_image, wrapped_circles, method.Value, (float)dp.Value, (float)minDist.Value, (float)param1.Value);
