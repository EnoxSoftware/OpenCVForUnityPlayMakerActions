...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_Laplacian_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.Laplacian(wrapped_src, wrapped_dst, ddepth.Value, ksize.Value, wrapped_scale);
