...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_GaussianBlur_2_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.GaussianBlur (wrapped_src, wrapped_dst, new OpenCVForUnity.Size ((double)ksize_width.Value, (double)ksize_height.Value), (float)sigmaX.Value);
