...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_initUndistortRectifyMap_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Mat wrapped_newCameraMatrix = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.Mat> (newCameraMatrix);
            ...
            OpenCVForUnity.Imgproc.initUndistortRectifyMap (wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_R, wrapped_newCameraMatrix, new OpenCVForUnity.Size ((double)size_width.Value, (double)size_height.Value), m1type.Value, wrapped_map1, wrapped_map2);
