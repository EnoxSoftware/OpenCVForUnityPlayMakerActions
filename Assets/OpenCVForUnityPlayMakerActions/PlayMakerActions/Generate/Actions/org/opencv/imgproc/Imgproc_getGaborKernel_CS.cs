...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_getGaborKernel_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.ImgprocModule.Imgproc.getGaborKernel(new OpenCVForUnity.CoreModule.Size((double)ksize_width.Value, (double)ksize_height.Value), (float)sigma.Value, (float)theta.Value, (float)lambd.Value, (float)gamma.Value, (float)psi.Value, ktype.Value);
