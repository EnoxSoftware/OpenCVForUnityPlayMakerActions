...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_blur_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.blur(wrapped_src, wrapped_dst, wrapped_ksize, wrapped_anchor);
