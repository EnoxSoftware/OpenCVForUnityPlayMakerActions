...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_pyrMeanShiftFiltering_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.pyrMeanShiftFiltering(wrapped_src, wrapped_dst, wrapped_sp, wrapped_sr, maxLevel.Value);
