...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_boxFilter_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.boxFilter (wrapped_src, wrapped_dst, ddepth.Value, new OpenCVForUnity.Size ((double)ksize_width.Value, (double)ksize_height.Value), new OpenCVForUnity.Point ((double)anchor_x.Value, (double)anchor_y.Value), normalize.Value);
