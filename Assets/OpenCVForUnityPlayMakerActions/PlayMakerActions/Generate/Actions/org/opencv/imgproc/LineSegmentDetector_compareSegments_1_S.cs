...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public int compareSegments(Size size, Mat lines1, Mat lines2)")]
    ...
    public class LineSegmentDetector_compareSegments_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.compareSegments(new OpenCVForUnity.CoreModule.Size((double)size_width.Value, (double)size_height.Value), wrapped_lines1, wrapped_lines2);
