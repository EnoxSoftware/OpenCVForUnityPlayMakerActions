...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_undistortPointsIter : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.undistortPointsIter (wrapped_src, wrapped_dst, wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_R, wrapped_P, wrapped_criteria);
