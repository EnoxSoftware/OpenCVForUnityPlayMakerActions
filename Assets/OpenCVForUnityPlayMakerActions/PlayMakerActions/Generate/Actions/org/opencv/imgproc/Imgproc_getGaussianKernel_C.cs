...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static Mat getGaussianKernel(int ksize, double sigma, int ktype)")]
    ...
    public class Imgproc_getGaussianKernel_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.ImgprocModule.Imgproc.getGaussianKernel(ksize.Value, (float)sigma.Value, ktype.Value);
