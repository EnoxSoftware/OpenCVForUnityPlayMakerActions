...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static int connectedComponentsWithAlgorithm(Mat image, Mat labels, int connectivity, int ltype, int ccltype)")]
    ...
    public class Imgproc_connectedComponentsWithAlgorithm : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.ImgprocModule.Imgproc.connectedComponentsWithAlgorithm(wrapped_image, wrapped_labels, connectivity.Value, ltype.Value, ccltype.Value);
