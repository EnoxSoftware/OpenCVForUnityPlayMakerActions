...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void cornerEigenValsAndVecs(Mat src, Mat dst, int blockSize, int ksize, int borderType)")]
    ...
    public class Imgproc_cornerEigenValsAndVecs : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.cornerEigenValsAndVecs(wrapped_src, wrapped_dst, blockSize.Value, ksize.Value, borderType.Value);
