...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_blur_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.blur (wrapped_src, wrapped_dst, new OpenCVForUnity.Size ((double)ksize_width.Value, (double)ksize_height.Value), new OpenCVForUnity.Point ((double)anchor_x.Value, (double)anchor_y.Value), borderType.Value);
