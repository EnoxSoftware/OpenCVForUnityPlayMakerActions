...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void blur (Mat src, Mat dst, Size ksize, Point anchor, int borderType)")]
    ...
    public class Imgproc_blur_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.blur (wrapped_src, wrapped_dst, new OpenCVForUnity.CoreModule.Size ((double)ksize_width.Value, (double)ksize_height.Value), new OpenCVForUnity.CoreModule.Point ((double)anchor_x.Value, (double)anchor_y.Value), borderType.Value);
