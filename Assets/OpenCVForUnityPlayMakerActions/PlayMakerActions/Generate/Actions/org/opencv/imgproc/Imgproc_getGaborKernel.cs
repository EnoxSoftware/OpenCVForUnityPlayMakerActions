...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_getGaborKernel : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.ImgprocModule.Imgproc.getGaborKernel(wrapped_ksize, wrapped_sigma, wrapped_theta, wrapped_lambd, wrapped_gamma, wrapped_psi, ktype.Value);
