...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_Scharr_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.Scharr (wrapped_src, wrapped_dst, ddepth.Value, dx.Value, dy.Value, (float)scale.Value);
