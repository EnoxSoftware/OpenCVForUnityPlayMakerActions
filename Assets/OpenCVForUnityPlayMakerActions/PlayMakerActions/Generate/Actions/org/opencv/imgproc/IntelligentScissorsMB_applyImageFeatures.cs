...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public IntelligentScissorsMB applyImageFeatures(Mat non_edge, Mat gradient_direction, Mat gradient_magnitude, Mat image)")]
    ...
    public class IntelligentScissorsMB_applyImageFeatures : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.IntelligentScissorsMB)storeResult.Value).wrappedObject = wrapped_owner.applyImageFeatures(wrapped_non_edge, wrapped_gradient_direction, wrapped_gradient_magnitude, wrapped_image);
