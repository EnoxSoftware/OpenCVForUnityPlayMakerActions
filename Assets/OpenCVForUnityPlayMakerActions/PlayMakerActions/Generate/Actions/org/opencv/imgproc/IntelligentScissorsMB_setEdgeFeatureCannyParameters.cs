...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class IntelligentScissorsMB_setEdgeFeatureCannyParameters : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.IntelligentScissorsMB)storeResult.Value).wrappedObject = wrapped_owner.setEdgeFeatureCannyParameters(wrapped_threshold1, wrapped_threshold2, apertureSize.Value, L2gradient.Value);
