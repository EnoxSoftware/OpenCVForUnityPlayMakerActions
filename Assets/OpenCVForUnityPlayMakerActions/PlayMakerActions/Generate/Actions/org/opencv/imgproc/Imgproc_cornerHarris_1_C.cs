...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void cornerHarris(Mat src, Mat dst, int blockSize, int ksize, double k)")]
    ...
    public class Imgproc_cornerHarris_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.cornerHarris(wrapped_src, wrapped_dst, blockSize.Value, ksize.Value, (float)k.Value);
