...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_sepFilter2D_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.sepFilter2D (wrapped_src, wrapped_dst, ddepth.Value, wrapped_kernelX, wrapped_kernelY, new OpenCVForUnity.Point ((double)anchor_x.Value, (double)anchor_y.Value), wrapped_delta);
