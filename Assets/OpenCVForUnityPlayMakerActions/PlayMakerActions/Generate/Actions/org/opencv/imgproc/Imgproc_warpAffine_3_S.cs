...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void warpAffine (Mat src, Mat dst, Mat M, Size dsize)")]
    ...
    public class Imgproc_warpAffine_3_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.warpAffine (wrapped_src, wrapped_dst, wrapped_M, new OpenCVForUnity.CoreModule.Size ((double)dsize_width.Value, (double)dsize_height.Value));
