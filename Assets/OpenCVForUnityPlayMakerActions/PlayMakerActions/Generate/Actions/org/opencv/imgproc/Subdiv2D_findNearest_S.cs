...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Subdiv2D_findNearest_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = wrapped_owner.findNearest (new OpenCVForUnity.Point ((double)pt_x.Value, (double)pt_y.Value), new OpenCVForUnity.Point ((double)nearestPt_x.Value, (double)nearestPt_y.Value));
