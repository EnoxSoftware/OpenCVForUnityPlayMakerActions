...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_drawContours_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.drawContours (wrapped_image, wrapped_contours, contourIdx.Value, wrapped_color);
