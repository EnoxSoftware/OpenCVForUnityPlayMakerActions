...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void demosaicing(Mat src, Mat dst, int code)")]
    ...
    public class Imgproc_demosaicing_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.demosaicing(wrapped_src, wrapped_dst, code.Value);
