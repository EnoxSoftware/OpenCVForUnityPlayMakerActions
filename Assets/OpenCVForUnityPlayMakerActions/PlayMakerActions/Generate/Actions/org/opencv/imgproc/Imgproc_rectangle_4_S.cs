...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_rectangle_4_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.rectangle (wrapped_img, new OpenCVForUnity.Rect ((int)rec_x.Value, (int)rec_y.Value, (int)rec_width.Value, (int)rec_height.Value), new OpenCVForUnity.Scalar ((double)color_v0.Value, (double)color_v1.Value, (double)color_v2.Value, (double)color_v3.Value), thickness.Value, lineType.Value, shift.Value);
