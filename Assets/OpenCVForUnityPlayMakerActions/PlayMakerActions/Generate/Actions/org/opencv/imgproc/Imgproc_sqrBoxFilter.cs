...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_sqrBoxFilter : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.sqrBoxFilter(wrapped_src, wrapped_dst, ddepth.Value, wrapped_ksize, wrapped_anchor, normalize.Value, borderType.Value);
