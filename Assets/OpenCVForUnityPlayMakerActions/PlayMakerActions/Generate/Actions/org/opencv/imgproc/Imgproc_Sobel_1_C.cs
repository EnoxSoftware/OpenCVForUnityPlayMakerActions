...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void Sobel(Mat src, Mat dst, int ddepth, int dx, int dy, int ksize, double scale, double delta)")]
    ...
    public class Imgproc_Sobel_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.Sobel(wrapped_src, wrapped_dst, ddepth.Value, dx.Value, dy.Value, ksize.Value, (float)scale.Value, (float)delta.Value);
