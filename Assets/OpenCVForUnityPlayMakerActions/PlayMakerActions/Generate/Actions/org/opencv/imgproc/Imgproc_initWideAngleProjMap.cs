...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_initWideAngleProjMap : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Imgproc.initWideAngleProjMap (wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_imageSize, destImageWidth.Value, m1type.Value, wrapped_map1, wrapped_map2, projType.Value, wrapped_alpha);
