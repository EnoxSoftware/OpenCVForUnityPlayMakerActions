...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static float intersectConvexConvex(Mat _p1, Mat _p2, Mat _p12, bool handleNested)")]
    ...
    public class Imgproc_intersectConvexConvex : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.ImgprocModule.Imgproc.intersectConvexConvex(wrapped__p1, wrapped__p2, wrapped__p12, handleNested.Value);
