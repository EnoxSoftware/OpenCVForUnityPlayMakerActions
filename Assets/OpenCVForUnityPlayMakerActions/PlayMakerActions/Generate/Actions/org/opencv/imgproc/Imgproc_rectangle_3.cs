...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_rectangle_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.rectangle (wrapped_img, wrapped_pt1, wrapped_pt2, wrapped_color);
