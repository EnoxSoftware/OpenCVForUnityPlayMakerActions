...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_remap_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.remap (wrapped_src, wrapped_dst, wrapped_map1, wrapped_map2, interpolation.Value);
