...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_drawContours_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.drawContours(wrapped_image, wrapped_contours, contourIdx.Value, new OpenCVForUnity.CoreModule.Scalar((double)color_v0.Value, (double)color_v1.Value, (double)color_v2.Value, (double)color_v3.Value), thickness.Value, lineType.Value, wrapped_hierarchy, maxLevel.Value, new OpenCVForUnity.CoreModule.Point((double)offset_x.Value, (double)offset_y.Value));
