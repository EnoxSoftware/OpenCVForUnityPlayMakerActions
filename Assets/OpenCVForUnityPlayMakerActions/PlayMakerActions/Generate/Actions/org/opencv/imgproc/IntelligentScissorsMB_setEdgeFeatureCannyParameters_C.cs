...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public IntelligentScissorsMB setEdgeFeatureCannyParameters(double threshold1, double threshold2, int apertureSize, bool L2gradient)")]
    ...
    public class IntelligentScissorsMB_setEdgeFeatureCannyParameters_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.IntelligentScissorsMB)storeResult.Value).wrappedObject = wrapped_owner.setEdgeFeatureCannyParameters((float)threshold1.Value, (float)threshold2.Value, apertureSize.Value, L2gradient.Value);
