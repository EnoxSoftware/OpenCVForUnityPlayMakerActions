...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_phaseCorrelate_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Point)storeResult.Value).wrappedObject = OpenCVForUnity.ImgprocModule.Imgproc.phaseCorrelate (wrapped_src1, wrapped_src2);
