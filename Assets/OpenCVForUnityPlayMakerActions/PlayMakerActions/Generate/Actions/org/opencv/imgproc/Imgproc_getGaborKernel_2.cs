...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_getGaborKernel_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Imgproc.getGaborKernel (wrapped_ksize, wrapped_sigma, wrapped_theta, wrapped_lambd, wrapped_gamma);
