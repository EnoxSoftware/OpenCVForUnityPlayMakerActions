...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_warpAffine_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.warpAffine (wrapped_src, wrapped_dst, wrapped_M, new OpenCVForUnity.Size ((double)dsize_width.Value, (double)dsize_height.Value), flags.Value, borderMode.Value, new OpenCVForUnity.Scalar ((double)borderValue_v0.Value, (double)borderValue_v1.Value, (double)borderValue_v2.Value, (double)borderValue_v3.Value));
