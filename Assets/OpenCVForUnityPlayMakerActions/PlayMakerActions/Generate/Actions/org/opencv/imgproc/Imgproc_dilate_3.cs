...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_dilate_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.dilate(wrapped_src, wrapped_dst, wrapped_kernel, wrapped_anchor);
