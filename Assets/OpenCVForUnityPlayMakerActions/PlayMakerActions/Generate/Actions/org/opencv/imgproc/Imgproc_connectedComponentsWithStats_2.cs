...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_connectedComponentsWithStats_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.ImgprocModule.Imgproc.connectedComponentsWithStats(wrapped_image, wrapped_labels, wrapped_stats, wrapped_centroids);
