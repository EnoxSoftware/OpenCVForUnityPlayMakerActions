...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_warpPolar_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.warpPolar(wrapped_src, wrapped_dst, new OpenCVForUnity.CoreModule.Size((double)dsize_width.Value, (double)dsize_height.Value), new OpenCVForUnity.CoreModule.Point((double)center_x.Value, (double)center_y.Value), wrapped_maxRadius, flags.Value);
