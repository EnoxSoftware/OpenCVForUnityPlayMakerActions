...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void dilate(Mat src, Mat dst, Mat kernel, Point anchor)")]
    ...
    public class Imgproc_dilate_3_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.dilate(wrapped_src, wrapped_dst, wrapped_kernel, new OpenCVForUnity.CoreModule.Point((double)anchor_x.Value, (double)anchor_y.Value));
