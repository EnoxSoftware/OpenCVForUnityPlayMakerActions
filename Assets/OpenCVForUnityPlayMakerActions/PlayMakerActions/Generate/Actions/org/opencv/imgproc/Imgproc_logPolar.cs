...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_logPolar : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.logPolar (wrapped_src, wrapped_dst, wrapped_center, wrapped_M, flags.Value);
