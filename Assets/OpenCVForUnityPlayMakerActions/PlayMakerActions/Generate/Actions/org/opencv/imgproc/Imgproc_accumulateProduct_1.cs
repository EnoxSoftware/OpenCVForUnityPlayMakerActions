...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void accumulateProduct(Mat src1, Mat src2, Mat dst)")]
    ...
    public class Imgproc_accumulateProduct_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.accumulateProduct(wrapped_src1, wrapped_src2, wrapped_dst);
