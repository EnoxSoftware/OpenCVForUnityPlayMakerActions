...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_ellipse_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Imgproc.ellipse (wrapped_img, wrapped_box, wrapped_color, thickness.Value, lineType.Value);
