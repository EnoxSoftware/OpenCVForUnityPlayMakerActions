...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgproc_fillConvexPoly_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ImgprocModule.Imgproc.fillConvexPoly(wrapped_img, wrapped_points, wrapped_color, lineType.Value);
