...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setMinSampleCount (int val)")]
    ...
    public class DTrees_setMinSampleCount : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setMinSampleCount (val.Value);
