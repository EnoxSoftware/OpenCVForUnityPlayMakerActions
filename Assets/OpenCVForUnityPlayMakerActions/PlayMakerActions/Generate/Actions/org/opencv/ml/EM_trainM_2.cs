...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool trainM(Mat samples, Mat probs0, Mat logLikelihoods)")]
    ...
    public class EM_trainM_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.trainM(wrapped_samples, wrapped_probs0, wrapped_logLikelihoods);
