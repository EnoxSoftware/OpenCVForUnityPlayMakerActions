...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setRpropDW0(double val)")]
    ...
    public class ANN_MLP_setRpropDW0_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setRpropDW0((float)val.Value);
