...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setRegressionAccuracy(float val)")]
    ...
    public class DTrees_setRegressionAccuracy : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setRegressionAccuracy(val.Value);
