...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class ANN_MLP_getRpropDWMax : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = wrapped_owner.getRpropDWMax ();
