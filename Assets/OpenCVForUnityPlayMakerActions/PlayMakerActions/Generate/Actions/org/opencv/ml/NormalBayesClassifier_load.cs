...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static NormalBayesClassifier load(string filepath, string nodeName)")]
    ...
    public class NormalBayesClassifier_load : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.NormalBayesClassifier)storeResult.Value).wrappedObject = OpenCVForUnity.MlModule.NormalBayesClassifier.load(filepath.Value, nodeName.Value);
