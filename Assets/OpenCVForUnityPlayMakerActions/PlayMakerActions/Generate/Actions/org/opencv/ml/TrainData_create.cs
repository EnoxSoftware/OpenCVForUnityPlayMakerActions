...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class TrainData_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Mat wrapped_varType = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.CoreModule.Mat>(varType);
            ...
            ((OpenCVForUnityPlayMakerActions.TrainData)storeResult.Value).wrappedObject = OpenCVForUnity.MlModule.TrainData.create(wrapped_samples, layout.Value, wrapped_responses, wrapped_varIdx, wrapped_sampleIdx, wrapped_sampleWeights, wrapped_varType);
