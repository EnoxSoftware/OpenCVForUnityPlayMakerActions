...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public override void setAnnealInitialT (double val)")]
    ...
    public class ANN_MLP_ANNEAL_setAnnealInitialT_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setAnnealInitialT ((float)val.Value);
