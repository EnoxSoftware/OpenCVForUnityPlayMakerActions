...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public override void setAnnealCoolingRatio (double val)")]
    ...
    public class ANN_MLP_ANNEAL_setAnnealCoolingRatio_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setAnnealCoolingRatio ((float)val.Value);
