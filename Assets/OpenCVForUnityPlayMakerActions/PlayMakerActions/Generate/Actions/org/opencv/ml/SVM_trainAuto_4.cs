...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public bool trainAuto (Mat samples, int layout, Mat responses, int kFold, ParamGrid Cgrid, ParamGrid gammaGrid, ParamGrid pGrid)")]
    ...
    public class SVM_trainAuto_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = wrapped_owner.trainAuto (wrapped_samples, layout.Value, wrapped_responses, kFold.Value, wrapped_Cgrid, wrapped_gammaGrid, wrapped_pGrid);
