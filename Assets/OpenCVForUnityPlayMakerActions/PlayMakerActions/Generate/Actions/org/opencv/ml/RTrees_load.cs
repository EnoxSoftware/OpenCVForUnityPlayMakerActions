...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class RTrees_load : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.RTrees)storeResult.Value).wrappedObject = OpenCVForUnity.MlModule.RTrees.load(filepath.Value, nodeName.Value);
