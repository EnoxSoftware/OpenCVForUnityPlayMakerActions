...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setMiniBatchSize(int val)")]
    ...
    public class LogisticRegression_setMiniBatchSize : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setMiniBatchSize(val.Value);
