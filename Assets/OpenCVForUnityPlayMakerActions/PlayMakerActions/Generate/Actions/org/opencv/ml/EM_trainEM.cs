...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public  bool trainEM (Mat samples, Mat logLikelihoods, Mat labels, Mat probs)")]
    ...
    public class EM_trainEM : HutongGames.PlayMaker.FsmStateAction
    {
