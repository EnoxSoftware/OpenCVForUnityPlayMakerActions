...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setTrainMethod (int method, double param1, double param2)")]
    ...
    public class ANN_MLP_setTrainMethod_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setTrainMethod (method.Value, (float)param1.Value, (float)param2.Value);
