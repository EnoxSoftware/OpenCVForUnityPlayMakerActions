...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static TrainData create(Mat samples, int layout, Mat responses, Mat varIdx, Mat sampleIdx)")]
    ...
    public class TrainData_create_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TrainData)storeResult.Value).wrappedObject = OpenCVForUnity.MlModule.TrainData.create(wrapped_samples, layout.Value, wrapped_responses, wrapped_varIdx, wrapped_sampleIdx);
