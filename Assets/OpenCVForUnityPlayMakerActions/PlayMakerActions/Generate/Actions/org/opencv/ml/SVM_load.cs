...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static SVM load(string filepath)")]
    ...
    public class SVM_load : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SVM)storeResult.Value).wrappedObject = OpenCVForUnity.MlModule.SVM.load(filepath.Value);
