...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setBackpropWeightScale (double val)")]
    ...
    public class ANN_MLP_setBackpropWeightScale_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setBackpropWeightScale ((float)val.Value);
