...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class ParamGrid_create_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ParamGrid)storeResult.Value).wrappedObject = OpenCVForUnity.MlModule.ParamGrid.create((float)minVal.Value, (float)maxVal.Value);
