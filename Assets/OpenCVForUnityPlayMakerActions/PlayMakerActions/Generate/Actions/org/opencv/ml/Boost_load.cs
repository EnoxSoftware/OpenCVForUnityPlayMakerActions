...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static new Boost load (string filepath, string nodeName)")]
    ...
    public class Boost_load : HutongGames.PlayMaker.FsmStateAction
    {
