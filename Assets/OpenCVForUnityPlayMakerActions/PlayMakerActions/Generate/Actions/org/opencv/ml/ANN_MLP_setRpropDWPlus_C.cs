...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setRpropDWPlus (double val)")]
    ...
    public class ANN_MLP_setRpropDWPlus_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setRpropDWPlus ((float)val.Value);
