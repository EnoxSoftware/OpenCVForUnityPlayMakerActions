...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class LogisticRegression_getLearningRate : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = wrapped_owner.getLearningRate ();
