...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class LogisticRegression_load : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.LogisticRegression)storeResult.Value).wrappedObject = OpenCVForUnity.MlModule.LogisticRegression.load(filepath.Value, nodeName.Value);
