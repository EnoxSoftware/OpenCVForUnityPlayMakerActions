...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setRpropDWMinus (double val)")]
    ...
    public class ANN_MLP_setRpropDWMinus_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setRpropDWMinus ((float)val.Value);
