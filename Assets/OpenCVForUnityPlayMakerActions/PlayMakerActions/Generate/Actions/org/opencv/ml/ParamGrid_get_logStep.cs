...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class ParamGrid_get_logStep : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = wrapped_owner.get_logStep ();
