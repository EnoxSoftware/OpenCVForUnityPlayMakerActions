...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public bool trainE (Mat samples, Mat means0, Mat covs0, Mat weights0)")]
    ...
    public class EM_trainE_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = wrapped_owner.trainE (wrapped_samples, wrapped_means0, wrapped_covs0, wrapped_weights0);
