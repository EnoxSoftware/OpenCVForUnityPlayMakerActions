...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static SVMSGD load(string filepath, string nodeName)")]
    ...
    public class SVMSGD_load : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SVMSGD)storeResult.Value).wrappedObject = OpenCVForUnity.MlModule.SVMSGD.load(filepath.Value, nodeName.Value);
