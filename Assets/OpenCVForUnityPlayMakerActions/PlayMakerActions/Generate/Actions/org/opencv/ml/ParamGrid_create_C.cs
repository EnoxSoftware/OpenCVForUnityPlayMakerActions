...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class ParamGrid_create_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ParamGrid)storeResult.Value).wrappedObject = OpenCVForUnity.ParamGrid.create ((float)minVal.Value, (float)maxVal.Value, (float)logstep.Value);
