...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public virtual float predict(Mat samples, Mat results)")]
    ...
    public class StatModel_predict_1 : HutongGames.PlayMaker.FsmStateAction
    {
