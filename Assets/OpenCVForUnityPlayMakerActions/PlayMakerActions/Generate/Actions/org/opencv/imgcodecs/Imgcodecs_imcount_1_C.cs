...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgcodecs_imcount_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (int)OpenCVForUnity.ImgcodecsModule.Imgcodecs.imcount(filename.Value);
