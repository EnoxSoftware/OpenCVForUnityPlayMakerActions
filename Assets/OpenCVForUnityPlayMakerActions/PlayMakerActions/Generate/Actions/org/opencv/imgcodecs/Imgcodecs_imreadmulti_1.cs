...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static bool imreadmulti(string filename, List<Mat> mats)")]
    ...
    public class Imgcodecs_imreadmulti_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.ImgcodecsModule.Imgcodecs.imreadmulti(filename.Value, wrapped_mats);
