...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Imgcodecs_imcount : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Long)storeResult.Value).wrappedObject = OpenCVForUnity.ImgcodecsModule.Imgcodecs.imcount(filename.Value, flags.Value);
