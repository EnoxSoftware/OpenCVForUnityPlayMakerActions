...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static bool imreadmulti(string filename, List<Mat> mats, int start, int count)")]
    ...
    public class Imgcodecs_imreadmulti_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.ImgcodecsModule.Imgcodecs.imreadmulti(filename.Value, wrapped_mats, start.Value, count.Value);
