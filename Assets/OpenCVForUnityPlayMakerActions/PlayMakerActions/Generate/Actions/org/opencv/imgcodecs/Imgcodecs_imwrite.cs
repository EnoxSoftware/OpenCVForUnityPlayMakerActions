...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static bool imwrite(string filename, Mat img, MatOfInt _params)")]
    ...
    public class Imgcodecs_imwrite : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.ImgcodecsModule.Imgcodecs.imwrite(filename.Value, wrapped_img, wrapped__params);
