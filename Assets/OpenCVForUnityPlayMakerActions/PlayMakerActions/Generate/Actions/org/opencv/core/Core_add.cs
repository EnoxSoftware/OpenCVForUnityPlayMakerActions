...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void add(Mat src1, Mat src2, Mat dst, Mat mask, int dtype)")]
    ...
    public class Core_add : HutongGames.PlayMaker.FsmStateAction
    {
