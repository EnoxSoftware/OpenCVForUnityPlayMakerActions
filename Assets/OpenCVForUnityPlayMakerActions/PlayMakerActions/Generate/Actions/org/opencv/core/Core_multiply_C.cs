...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void multiply(Mat src1, Mat src2, Mat dst, double scale, int dtype)")]
    ...
    public class Core_multiply_C : HutongGames.PlayMaker.FsmStateAction
    {
