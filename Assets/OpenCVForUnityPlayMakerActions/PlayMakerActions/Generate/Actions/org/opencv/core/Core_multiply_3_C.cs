...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_multiply_3_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.multiply(wrapped_src1, wrapped_src2, wrapped_dst, (float)scale.Value, dtype.Value);
