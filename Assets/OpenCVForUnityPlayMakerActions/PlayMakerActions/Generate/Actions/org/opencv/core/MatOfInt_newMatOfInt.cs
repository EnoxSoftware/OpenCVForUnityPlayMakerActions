...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public MatOfInt ()")]
    ...
    public class MatOfInt_newMatOfInt : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MatOfInt)storeResult.Value).wrappedObject = new OpenCVForUnity.CoreModule.MatOfInt ();
