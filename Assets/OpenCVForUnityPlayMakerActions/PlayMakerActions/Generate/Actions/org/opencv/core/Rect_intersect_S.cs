...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Rect_intersect_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Rect)storeResult.Value).wrappedObject = OpenCVForUnity.Rect.intersect (new OpenCVForUnity.Rect ((int)a_x.Value, (int)a_y.Value, (int)a_width.Value, (int)a_height.Value), new OpenCVForUnity.Rect ((int)b_x.Value, (int)b_y.Value, (int)b_width.Value, (int)b_height.Value));
