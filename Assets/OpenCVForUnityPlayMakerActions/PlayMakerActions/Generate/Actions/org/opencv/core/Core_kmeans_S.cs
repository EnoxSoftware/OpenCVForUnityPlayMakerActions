...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_kmeans_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = OpenCVForUnity.CoreModule.Core.kmeans(wrapped_data, K.Value, wrapped_bestLabels, new OpenCVForUnity.CoreModule.TermCriteria((int)criteria_type.Value, (int)criteria_maxCount.Value, (double)criteria_epsilon.Value), attempts.Value, flags.Value, wrapped_centers);
