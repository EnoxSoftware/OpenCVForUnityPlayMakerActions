...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Mat_elemSize : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Long)storeResult.Value).wrappedObject = wrapped_owner.elemSize ();
