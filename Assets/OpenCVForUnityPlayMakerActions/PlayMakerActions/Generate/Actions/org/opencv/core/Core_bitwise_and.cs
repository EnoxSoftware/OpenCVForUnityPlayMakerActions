...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void bitwise_and(Mat src1, Mat src2, Mat dst, Mat mask)")]
    ...
    public class Core_bitwise_and : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.bitwise_and(wrapped_src1, wrapped_src2, wrapped_dst, wrapped_mask);
