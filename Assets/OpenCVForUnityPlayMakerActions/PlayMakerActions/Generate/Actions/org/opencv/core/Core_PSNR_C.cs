...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_PSNR_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.CoreModule.Core.PSNR(wrapped_src1, wrapped_src2, (float)R.Value);
