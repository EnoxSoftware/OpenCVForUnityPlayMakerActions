...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class TermCriteria_newTermCriteria_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TermCriteria)storeResult.Value).wrappedObject = new OpenCVForUnity.TermCriteria (type.Value, maxCount.Value, (float)epsilon.Value);
