...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Point3_cross_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Point3)storeResult.Value).wrappedObject = wrapped_owner.cross(new OpenCVForUnity.CoreModule.Point3((double)p_x.Value, (double)p_y.Value, (double)p_z.Value));
