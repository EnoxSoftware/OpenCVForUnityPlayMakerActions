...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.Double), "v3")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.Scalar), "storeResult")]
    public class Scalar_newScalar : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.UIHint(HutongGames.PlayMaker.UIHint.Variable)]
        [HutongGames.PlayMaker.ObjectType(typeof(OpenCVForUnityPlayMakerActions.Double))]
        public HutongGames.PlayMaker.FsmObject v3;
        ...
        void DoProcess()
        {
            ...
            if (!(v3.Value is OpenCVForUnityPlayMakerActions.Double))
            {
                LogError("v3 is not initialized. Add Action \"newDouble\".");
                return;
            }
            System.Double wrapped_v3 = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Double, System.Double>(v3);
            ...
            ((OpenCVForUnityPlayMakerActions.Scalar)storeResult.Value).wrappedObject = new OpenCVForUnity.CoreModule.Scalar(wrapped_v0, wrapped_v1, wrapped_v2, wrapped_v3);
