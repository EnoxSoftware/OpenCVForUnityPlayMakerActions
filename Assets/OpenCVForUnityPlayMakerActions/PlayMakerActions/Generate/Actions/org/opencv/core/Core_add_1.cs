...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void add(Mat src1, Mat src2, Mat dst, Mat mask)")]
    ...
    public class Core_add_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.add(wrapped_src1, wrapped_src2, wrapped_dst, wrapped_mask);
