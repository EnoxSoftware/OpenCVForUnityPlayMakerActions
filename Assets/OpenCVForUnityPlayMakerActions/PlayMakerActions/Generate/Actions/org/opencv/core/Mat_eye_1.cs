...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Mat_eye_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.CoreModule.Mat.eye (wrapped_size, type.Value);
