...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_multiply_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Core.multiply (wrapped_src1, wrapped_src2, wrapped_dst, (float)scale.Value);
