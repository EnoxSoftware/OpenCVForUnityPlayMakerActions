...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_PCACompute_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Core.PCACompute (wrapped_data, wrapped_mean, wrapped_eigenvectors, (float)retainedVariance.Value);
