...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_gemm_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Core.gemm (wrapped_src1, wrapped_src2, wrapped_alpha, wrapped_src3, wrapped_beta, wrapped_dst);
