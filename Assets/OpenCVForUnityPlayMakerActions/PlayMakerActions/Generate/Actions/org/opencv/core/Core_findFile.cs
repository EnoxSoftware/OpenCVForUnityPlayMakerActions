...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static string findFile(string relative_path, bool required, bool silentMode)")]
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "silentMode")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmString), "storeResult")]
    public class Core_findFile : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.ObjectType(typeof(HutongGames.PlayMaker.FsmBool))]
        public HutongGames.PlayMaker.FsmBool silentMode;
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.CoreModule.Core.findFile(relative_path.Value, required.Value, silentMode.Value);
