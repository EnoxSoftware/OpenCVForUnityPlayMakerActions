...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_scaleAdd : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.CoreModule.Core.scaleAdd (wrapped_src1, wrapped_alpha, wrapped_src2, wrapped_dst);
