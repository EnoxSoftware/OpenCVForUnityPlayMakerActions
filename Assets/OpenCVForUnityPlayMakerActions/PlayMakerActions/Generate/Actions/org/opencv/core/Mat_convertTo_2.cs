...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void convertTo(Mat m, int rtype)")]
    ...
    public class Mat_convertTo_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.convertTo(wrapped_m, rtype.Value);
