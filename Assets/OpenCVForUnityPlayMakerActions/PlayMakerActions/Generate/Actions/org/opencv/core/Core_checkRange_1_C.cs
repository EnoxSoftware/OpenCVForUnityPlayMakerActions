...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static bool checkRange(Mat a, bool quiet, double minVal)")]
    ...
    public class Core_checkRange_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.CoreModule.Core.checkRange(wrapped_a, quiet.Value, (float)minVal.Value);
