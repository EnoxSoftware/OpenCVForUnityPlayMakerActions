...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Rect2d_inflate_2_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Rect2d)storeResult.Value).wrappedObject = OpenCVForUnity.Rect2d.inflate (new OpenCVForUnity.Rect2d ((double)rect_x.Value, (double)rect_y.Value, (double)rect_width.Value, (double)rect_height.Value), wrapped_x, wrapped_y);
