...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public Rect2d clone()")]
    ...
    public class Rect2d_clone : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Rect2d)storeResult.Value).wrappedObject = wrapped_owner.clone();
