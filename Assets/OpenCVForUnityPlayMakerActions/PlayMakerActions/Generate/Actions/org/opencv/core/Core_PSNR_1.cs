...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_PSNR_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = OpenCVForUnity.CoreModule.Core.PSNR (wrapped_src1, wrapped_src2);
