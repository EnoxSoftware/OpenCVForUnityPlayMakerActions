...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static MatOfByte fromNativeAddr(IntPtr addr)")]
    ...
    public class MatOfByte_fromNativeAddr : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MatOfByte)storeResult.Value).wrappedObject = OpenCVForUnity.CoreModule.MatOfByte.fromNativeAddr(wrapped_addr);
