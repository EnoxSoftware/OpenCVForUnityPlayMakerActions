...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Mat_mul_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = wrapped_owner.mul(wrapped_m, (float)scale.Value);
