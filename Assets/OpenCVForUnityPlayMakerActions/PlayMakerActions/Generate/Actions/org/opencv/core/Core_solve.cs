...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static bool solve(Mat src1, Mat src2, Mat dst, int flags)")]
    ...
    public class Core_solve : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = OpenCVForUnity.CoreModule.Core.solve(wrapped_src1, wrapped_src2, wrapped_dst, flags.Value);
