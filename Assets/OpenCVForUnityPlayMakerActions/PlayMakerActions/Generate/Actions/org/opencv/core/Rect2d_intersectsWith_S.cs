...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public bool intersectsWith (Rect2d rect)")]
    ...
    public class Rect2d_intersectsWith_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = wrapped_owner.intersectsWith (new OpenCVForUnity.CoreModule.Rect2d ((double)rect_x.Value, (double)rect_y.Value, (double)rect_width.Value, (double)rect_height.Value));
