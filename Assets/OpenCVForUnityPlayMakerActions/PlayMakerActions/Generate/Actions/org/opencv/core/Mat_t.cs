...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Mat_t : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = wrapped_owner.t();
