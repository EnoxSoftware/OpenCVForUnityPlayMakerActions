...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_convertScaleAbs_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.convertScaleAbs(wrapped_src, wrapped_dst, wrapped_alpha);
