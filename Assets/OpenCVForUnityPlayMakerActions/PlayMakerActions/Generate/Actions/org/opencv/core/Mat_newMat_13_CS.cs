...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Mat_newMat_13_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = new OpenCVForUnity.CoreModule.Mat(new OpenCVForUnity.CoreModule.Size((double)size_width.Value, (double)size_height.Value), type.Value, wrapped_data, (int)step.Value);
