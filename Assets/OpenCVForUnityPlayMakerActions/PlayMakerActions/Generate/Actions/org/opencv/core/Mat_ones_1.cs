...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Mat_ones_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.CoreModule.Mat.ones (wrapped_size, type.Value);
