...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Rect2d_newRect2d_3_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Rect2d)storeResult.Value).wrappedObject = new OpenCVForUnity.Rect2d (new OpenCVForUnity.Point ((double)p_x.Value, (double)p_y.Value), new OpenCVForUnity.Size ((double)s_width.Value, (double)s_height.Value));
