...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public MatOfKeyPoint(Mat m)")]
    ...
    public class MatOfKeyPoint_newMatOfKeyPoint_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MatOfKeyPoint)storeResult.Value).wrappedObject = new OpenCVForUnity.CoreModule.MatOfKeyPoint(wrapped_m);
