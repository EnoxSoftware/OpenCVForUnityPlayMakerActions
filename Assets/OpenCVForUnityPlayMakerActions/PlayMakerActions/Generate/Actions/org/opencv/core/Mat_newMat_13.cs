...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Mat_newMat_13 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = new OpenCVForUnity.CoreModule.Mat(wrapped_size, type.Value, wrapped_data, wrapped_step);
