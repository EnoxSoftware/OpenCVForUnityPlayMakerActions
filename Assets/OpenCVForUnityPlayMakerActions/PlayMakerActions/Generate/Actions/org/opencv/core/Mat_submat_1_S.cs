...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Mat_submat_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = wrapped_owner.submat(new OpenCVForUnity.CoreModule.Range((int)rowRange_start.Value, (int)rowRange_end.Value), new OpenCVForUnity.CoreModule.Range((int)colRange_start.Value, (int)colRange_end.Value));
