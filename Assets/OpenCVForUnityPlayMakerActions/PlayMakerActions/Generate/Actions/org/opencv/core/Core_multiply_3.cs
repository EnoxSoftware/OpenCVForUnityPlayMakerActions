...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_multiply_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.multiply(wrapped_src1, wrapped_src2, wrapped_dst, wrapped_scale, dtype.Value);
