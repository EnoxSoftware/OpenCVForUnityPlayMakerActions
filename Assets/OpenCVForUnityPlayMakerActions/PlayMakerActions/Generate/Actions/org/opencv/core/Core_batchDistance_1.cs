...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void batchDistance (Mat src1, Mat src2, Mat dist, int dtype, Mat nidx, int normType, int K, Mat mask, int update)")]
    ...
    public class Core_batchDistance_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Core.batchDistance (wrapped_src1, wrapped_src2, wrapped_dist, dtype.Value, wrapped_nidx, normType.Value, K.Value, wrapped_mask, update.Value);
