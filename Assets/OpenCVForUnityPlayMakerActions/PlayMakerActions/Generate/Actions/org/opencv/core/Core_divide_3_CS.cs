...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_divide_3_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Core.divide (wrapped_src1, new OpenCVForUnity.Scalar ((double)src2_v0.Value, (double)src2_v1.Value, (double)src2_v2.Value, (double)src2_v3.Value), wrapped_dst, (float)scale.Value, dtype.Value);
