...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void divide (Mat src1, Mat src2, Mat dst, double scale)")]
    ...
    public class Core_divide_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.CoreModule.Core.divide (wrapped_src1, wrapped_src2, wrapped_dst, (float)scale.Value);
