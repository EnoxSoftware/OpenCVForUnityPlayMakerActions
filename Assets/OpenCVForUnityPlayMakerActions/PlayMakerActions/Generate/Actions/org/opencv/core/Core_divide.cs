...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_divide : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Core.divide (wrapped_src1, wrapped_src2, wrapped_dst, wrapped_scale, dtype.Value);
