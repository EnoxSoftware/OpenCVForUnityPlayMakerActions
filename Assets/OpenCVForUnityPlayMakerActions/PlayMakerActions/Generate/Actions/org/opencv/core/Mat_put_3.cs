...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public int put(int[] idx, float[] data)")]
    ...
    public class Mat_put_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.ActionSection("[arg2] float[](Array(float))")]
        [HutongGames.PlayMaker.RequiredField]
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.put(idx.intValues, data.floatValues);
