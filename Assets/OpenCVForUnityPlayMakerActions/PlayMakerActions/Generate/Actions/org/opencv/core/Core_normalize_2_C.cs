...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void normalize(Mat src, Mat dst, double alpha, double beta, int norm_type)")]
    ...
    public class Core_normalize_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.normalize(wrapped_src, wrapped_dst, (float)alpha.Value, (float)beta.Value, norm_type.Value);
