...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void compare(Mat src1, Scalar src2, Mat dst, int cmpop)")]
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "cmpop")]
    public class Core_compare_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt cmpop;
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.compare(wrapped_src1, new OpenCVForUnity.CoreModule.Scalar((double)src2_v0.Value, (double)src2_v1.Value, (double)src2_v2.Value, (double)src2_v3.Value), wrapped_dst, cmpop.Value);
