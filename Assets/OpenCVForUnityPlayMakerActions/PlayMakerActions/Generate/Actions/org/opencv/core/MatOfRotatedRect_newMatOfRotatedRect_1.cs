...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public MatOfRotatedRect (Mat m)")]
    ...
    public class MatOfRotatedRect_newMatOfRotatedRect_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MatOfRotatedRect)storeResult.Value).wrappedObject = new OpenCVForUnity.CoreModule.MatOfRotatedRect (wrapped_m);
