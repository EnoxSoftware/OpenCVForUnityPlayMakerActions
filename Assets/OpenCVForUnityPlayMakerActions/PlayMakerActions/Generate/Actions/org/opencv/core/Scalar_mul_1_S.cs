...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Scalar_mul_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Scalar)storeResult.Value).wrappedObject = wrapped_owner.mul (new OpenCVForUnity.Scalar ((double)it_v0.Value, (double)it_v1.Value, (double)it_v2.Value, (double)it_v3.Value));
