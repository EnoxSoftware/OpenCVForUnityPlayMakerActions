...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_normalize_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.normalize(wrapped_src, wrapped_dst, (float)alpha.Value, (float)beta.Value, norm_type.Value, dtype.Value, wrapped_mask);
