...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_add_5_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Core.add (wrapped_src1, new OpenCVForUnity.Scalar ((double)src2_v0.Value, (double)src2_v1.Value, (double)src2_v2.Value, (double)src2_v3.Value), wrapped_dst);
