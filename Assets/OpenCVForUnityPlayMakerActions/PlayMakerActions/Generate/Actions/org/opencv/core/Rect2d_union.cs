...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Rect2d_union : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Rect2d)storeResult.Value).wrappedObject = wrapped_owner.union(wrapped_rect);
