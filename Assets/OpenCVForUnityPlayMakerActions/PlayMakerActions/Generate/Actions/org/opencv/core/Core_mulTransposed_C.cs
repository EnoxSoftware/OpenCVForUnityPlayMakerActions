...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void mulTransposed(Mat src, Mat dst, bool aTa, Mat delta, double scale, int dtype)")]
    ...
    public class Core_mulTransposed_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.mulTransposed(wrapped_src, wrapped_dst, aTa.Value, wrapped_delta, (float)scale.Value, dtype.Value);
