...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static Mat zeros(Size size, int type)")]
    ...
    public class Mat_zeros_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.CoreModule.Mat.zeros(new OpenCVForUnity.CoreModule.Size((double)size_width.Value, (double)size_height.Value), type.Value);
