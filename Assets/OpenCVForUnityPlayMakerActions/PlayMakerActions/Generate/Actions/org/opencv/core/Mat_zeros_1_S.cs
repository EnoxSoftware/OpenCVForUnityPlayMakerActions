...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Mat_zeros_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Mat.zeros (new OpenCVForUnity.Size ((double)size_width.Value, (double)size_height.Value), type.Value);
