...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public KeyPoint (float x, float y, float _size, float _angle, float _response, int _octave) : this(x, y, _size, _angle, _response, _octave, -1)")]
