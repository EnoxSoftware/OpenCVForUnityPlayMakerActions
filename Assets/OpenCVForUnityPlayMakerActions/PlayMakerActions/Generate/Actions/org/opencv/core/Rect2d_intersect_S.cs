...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Rect2d_intersect_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Rect2d)storeResult.Value).wrappedObject = OpenCVForUnity.CoreModule.Rect2d.intersect (new OpenCVForUnity.CoreModule.Rect2d ((double)a_x.Value, (double)a_y.Value, (double)a_width.Value, (double)a_height.Value), new OpenCVForUnity.CoreModule.Rect2d ((double)b_x.Value, (double)b_y.Value, (double)b_width.Value, (double)b_height.Value));
