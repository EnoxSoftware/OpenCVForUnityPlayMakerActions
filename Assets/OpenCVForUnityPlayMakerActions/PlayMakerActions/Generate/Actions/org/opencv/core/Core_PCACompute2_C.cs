...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_PCACompute2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Core.PCACompute2 (wrapped_data, wrapped_mean, wrapped_eigenvectors, wrapped_eigenvalues, (float)retainedVariance.Value);
