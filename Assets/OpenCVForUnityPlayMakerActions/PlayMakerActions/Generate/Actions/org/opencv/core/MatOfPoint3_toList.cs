...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class MatOfPoint3_toList : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            List<OpenCVForUnity.Point3> wrapped_storeResult = wrapped_owner.toList ();

            if (!storeResult.IsNone)
            {
                OpenCVForUnityPlayMakerActionsUtils.ConvertListToFsmArray<OpenCVForUnity.Point3, OpenCVForUnityPlayMakerActions.Point3> (wrapped_storeResult, storeResult);
            }
