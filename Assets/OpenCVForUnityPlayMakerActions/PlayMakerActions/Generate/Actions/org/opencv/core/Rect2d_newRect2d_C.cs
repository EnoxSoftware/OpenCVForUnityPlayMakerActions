...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Rect2d_newRect2d_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Rect2d)storeResult.Value).wrappedObject = new OpenCVForUnity.Rect2d ((float)x.Value, (float)y.Value, (float)width.Value, (float)height.Value);
