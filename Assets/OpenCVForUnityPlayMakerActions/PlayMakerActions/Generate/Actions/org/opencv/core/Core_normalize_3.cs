...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_normalize_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.normalize(wrapped_src, wrapped_dst, wrapped_alpha, wrapped_beta);
