...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_multiply_4_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.multiply(wrapped_src1, new OpenCVForUnity.CoreModule.Scalar((double)src2_v0.Value, (double)src2_v1.Value, (double)src2_v2.Value, (double)src2_v3.Value), wrapped_dst, (float)scale.Value);
