...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Point3_dot_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = wrapped_owner.dot (new OpenCVForUnity.Point3 ((double)p_x.Value, (double)p_y.Value, (double)p_z.Value));
