...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_divide_4_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.CoreModule.Core.divide (wrapped_src1, new OpenCVForUnity.CoreModule.Scalar ((double)src2_v0.Value, (double)src2_v1.Value, (double)src2_v2.Value, (double)src2_v3.Value), wrapped_dst, wrapped_scale);
