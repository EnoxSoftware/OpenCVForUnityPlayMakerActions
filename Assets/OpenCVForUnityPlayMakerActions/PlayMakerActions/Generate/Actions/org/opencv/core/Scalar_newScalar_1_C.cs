...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Scalar_newScalar_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Scalar)storeResult.Value).wrappedObject = new OpenCVForUnity.CoreModule.Scalar ((float)v0.Value, (float)v1.Value, (float)v2.Value);
