...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Mat_eye_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Mat.eye (new OpenCVForUnity.Size ((double)size_width.Value, (double)size_height.Value), type.Value);
