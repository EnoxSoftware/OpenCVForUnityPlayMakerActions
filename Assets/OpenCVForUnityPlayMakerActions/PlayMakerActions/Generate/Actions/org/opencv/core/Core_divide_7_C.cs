...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void divide(double scale, Mat src2, Mat dst)")]
    ...
    public class Core_divide_7_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.divide((float)scale.Value, wrapped_src2, wrapped_dst);
