...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void multiply(Mat src1, Mat src2, Mat dst, double scale)")]
    ...
    public class Core_multiply_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.multiply(wrapped_src1, wrapped_src2, wrapped_dst, wrapped_scale);
