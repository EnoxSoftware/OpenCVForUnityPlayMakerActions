...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public MatOfPoint3f () : base()")]
    ...
    public class MatOfPoint3f_newMatOfPoint3f : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MatOfPoint3f)storeResult.Value).wrappedObject = new OpenCVForUnity.MatOfPoint3f ();
