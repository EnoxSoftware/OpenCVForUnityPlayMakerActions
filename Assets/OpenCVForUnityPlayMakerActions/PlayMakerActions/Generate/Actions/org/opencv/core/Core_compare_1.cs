...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_compare_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.compare(wrapped_src1, wrapped_src2, wrapped_dst, cmpop.Value);
