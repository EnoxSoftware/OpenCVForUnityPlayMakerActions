...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void calcCovarMatrix (Mat samples, Mat covar, Mat mean, int flags)")]
    ...
    public class Core_calcCovarMatrix_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Mat wrapped_covar = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.Mat> (covar);
            ...
            OpenCVForUnity.Core.calcCovarMatrix (wrapped_samples, wrapped_covar, wrapped_mean, flags.Value);
