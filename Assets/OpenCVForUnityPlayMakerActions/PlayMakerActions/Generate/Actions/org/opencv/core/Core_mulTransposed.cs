...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_mulTransposed : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.mulTransposed(wrapped_src, wrapped_dst, aTa.Value, wrapped_delta, wrapped_scale, dtype.Value);
