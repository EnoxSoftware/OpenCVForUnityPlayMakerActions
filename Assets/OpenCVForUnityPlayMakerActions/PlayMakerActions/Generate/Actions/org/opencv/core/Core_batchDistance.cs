...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void batchDistance (Mat src1, Mat src2, Mat dist, int dtype, Mat nidx, int normType, int K, Mat mask, int update, bool crosscheck)")]
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmInt), "update")]
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmBool), "crosscheck")]
    public class Core_batchDistance : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.ObjectType (typeof (HutongGames.PlayMaker.FsmInt))]
        public HutongGames.PlayMaker.FsmInt update;
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Mat wrapped_dist = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.Mat> (dist);
            ...
            OpenCVForUnity.Mat wrapped_nidx = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.Mat> (nidx);
            ...
            OpenCVForUnity.Core.batchDistance (wrapped_src1, wrapped_src2, wrapped_dist, dtype.Value, wrapped_nidx, normType.Value, K.Value, wrapped_mask, update.Value, crosscheck.Value);
