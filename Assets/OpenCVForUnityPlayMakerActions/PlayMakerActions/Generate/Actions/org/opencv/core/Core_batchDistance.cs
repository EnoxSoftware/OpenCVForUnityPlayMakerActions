...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_batchDistance : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.CoreModule.Core.batchDistance (wrapped_src1, wrapped_src2, wrapped_dist, dtype.Value, wrapped_nidx, normType.Value, K.Value, wrapped_mask, update.Value, crosscheck.Value);
