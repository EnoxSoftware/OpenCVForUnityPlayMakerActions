...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public MatOfPoint (Mat m)")]
    ...
    public class MatOfPoint_newMatOfPoint_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MatOfPoint)storeResult.Value).wrappedObject = new OpenCVForUnity.CoreModule.MatOfPoint (wrapped_m);
