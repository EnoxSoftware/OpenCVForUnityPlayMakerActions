...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void bitwise_xor(Mat src1, Mat src2, Mat dst, Mat mask)")]
    ...
    public class Core_bitwise_xor : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.bitwise_xor(wrapped_src1, wrapped_src2, wrapped_dst, wrapped_mask);
