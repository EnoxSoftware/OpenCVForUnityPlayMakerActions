...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public KeyPoint (float x, float y, float _size, float _angle, float _response) : this(x, y, _size, _angle, _response, 0, -1)")]
    ...
    public class KeyPoint_newKeyPoint_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.KeyPoint)storeResult.Value).wrappedObject = new OpenCVForUnity.KeyPoint (x.Value, y.Value, _size.Value, _angle.Value, _response.Value);
