...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void compare (Mat src1, Mat src2, Mat dst, int cmpop)")]
    ...
    public class Core_compare : HutongGames.PlayMaker.FsmStateAction
    {
