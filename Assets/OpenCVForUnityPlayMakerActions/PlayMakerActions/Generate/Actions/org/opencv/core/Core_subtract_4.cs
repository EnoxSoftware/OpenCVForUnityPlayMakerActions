...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_subtract_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.subtract(wrapped_src1, wrapped_src2, wrapped_dst, wrapped_mask);
