...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void addWeighted (Mat src1, double alpha, Mat src2, double beta, double gamma, Mat dst)")]
    ...
    public class Core_addWeighted_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.CoreModule.Core.addWeighted (wrapped_src1, (float)alpha.Value, wrapped_src2, (float)beta.Value, (float)gamma.Value, wrapped_dst);
