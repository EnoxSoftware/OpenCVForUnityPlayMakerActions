...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public Mat submat (Rect roi)")]
    ...
    public class Mat_submat_2_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = wrapped_owner.submat (new OpenCVForUnity.CoreModule.Rect ((int)roi_x.Value, (int)roi_y.Value, (int)roi_width.Value, (int)roi_height.Value));
