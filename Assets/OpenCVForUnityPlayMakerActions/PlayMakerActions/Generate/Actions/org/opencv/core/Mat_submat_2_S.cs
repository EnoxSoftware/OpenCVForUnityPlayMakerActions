...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Mat_submat_2_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = wrapped_owner.submat (new OpenCVForUnity.Rect ((int)roi_x.Value, (int)roi_y.Value, (int)roi_width.Value, (int)roi_height.Value));
