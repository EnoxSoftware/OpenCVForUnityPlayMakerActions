...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public KeyPoint(float x, float y, float _size, float _angle)")]
    ...
    public class KeyPoint_newKeyPoint_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.KeyPoint)storeResult.Value).wrappedObject = new OpenCVForUnity.CoreModule.KeyPoint(x.Value, y.Value, _size.Value, _angle.Value);
