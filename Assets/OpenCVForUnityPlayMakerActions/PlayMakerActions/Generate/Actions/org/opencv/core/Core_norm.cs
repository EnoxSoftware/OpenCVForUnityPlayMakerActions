...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_norm : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = OpenCVForUnity.Core.norm (wrapped_src1, wrapped_src2, normType.Value, wrapped_mask);
