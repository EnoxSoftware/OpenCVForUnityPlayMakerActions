...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Mat_zeros_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.CoreModule.Mat.zeros(wrapped_size, type.Value);
