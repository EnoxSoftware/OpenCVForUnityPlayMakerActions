...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class KeyPoint_newKeyPoint : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.KeyPoint)storeResult.Value).wrappedObject = new OpenCVForUnity.KeyPoint (x.Value, y.Value, _size.Value, _angle.Value, _response.Value, _octave.Value, _class_id.Value);
