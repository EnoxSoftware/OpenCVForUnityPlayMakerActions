...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public KeyPoint(float x, float y, float _size, float _angle, float _response, int _octave, int _class_id)")]
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "_class_id")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.KeyPoint), "storeResult")]
    public class KeyPoint_newKeyPoint : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.ObjectType(typeof(HutongGames.PlayMaker.FsmInt))]
        public HutongGames.PlayMaker.FsmInt _class_id;
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.KeyPoint)storeResult.Value).wrappedObject = new OpenCVForUnity.CoreModule.KeyPoint(x.Value, y.Value, _size.Value, _angle.Value, _response.Value, _octave.Value, _class_id.Value);
