...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_add_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.add(wrapped_src1, wrapped_src2, wrapped_dst, wrapped_mask, dtype.Value);
