...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void convertTo (Mat m, int rtype, double alpha)")]
    ...
    public class Mat_convertTo_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.convertTo (wrapped_m, rtype.Value, (float)alpha.Value);
