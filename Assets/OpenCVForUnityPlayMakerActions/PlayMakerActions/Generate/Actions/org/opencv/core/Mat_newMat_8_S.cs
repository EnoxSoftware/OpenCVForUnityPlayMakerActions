...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Mat_newMat_8_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = new OpenCVForUnity.Mat (wrapped_m, new OpenCVForUnity.Rect ((int)roi_x.Value, (int)roi_y.Value, (int)roi_width.Value, (int)roi_height.Value));
