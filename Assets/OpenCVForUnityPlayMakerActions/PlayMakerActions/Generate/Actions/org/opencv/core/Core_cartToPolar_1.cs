...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void cartToPolar(Mat x, Mat y, Mat magnitude, Mat angle)")]
    ...
    public class Core_cartToPolar_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.cartToPolar(wrapped_x, wrapped_y, wrapped_magnitude, wrapped_angle);
