...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void subtract(Mat src1, Scalar src2, Mat dst, Mat mask, int dtype)")]
    ...
    public class Core_subtract_3_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.CoreModule.Core.subtract(wrapped_src1, new OpenCVForUnity.CoreModule.Scalar((double)src2_v0.Value, (double)src2_v1.Value, (double)src2_v2.Value, (double)src2_v3.Value), wrapped_dst, wrapped_mask, dtype.Value);
