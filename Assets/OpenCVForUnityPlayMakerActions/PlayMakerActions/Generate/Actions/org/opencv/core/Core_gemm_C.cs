...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Core_gemm_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Mat wrapped_src3 = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.Mat> (src3);
            ...
            OpenCVForUnity.Core.gemm (wrapped_src1, wrapped_src2, (float)alpha.Value, wrapped_src3, (float)beta.Value, wrapped_dst, flags.Value);
