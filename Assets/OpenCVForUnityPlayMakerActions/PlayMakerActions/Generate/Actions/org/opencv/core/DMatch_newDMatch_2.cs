...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class DMatch_newDMatch_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.DMatch)storeResult.Value).wrappedObject = new OpenCVForUnity.DMatch (_queryIdx.Value, _trainIdx.Value, _imgIdx.Value, _distance.Value);
