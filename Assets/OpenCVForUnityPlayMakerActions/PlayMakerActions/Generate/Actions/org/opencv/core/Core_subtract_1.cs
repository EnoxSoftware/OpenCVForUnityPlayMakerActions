...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void subtract(Mat src1, Mat src2, Mat dst, Mat mask)")]
    ...
    public class Core_subtract_1 : HutongGames.PlayMaker.FsmStateAction
    {
