...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Rect_intersect_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Rect)storeResult.Value).wrappedObject = wrapped_owner.intersect (wrapped_rect);
