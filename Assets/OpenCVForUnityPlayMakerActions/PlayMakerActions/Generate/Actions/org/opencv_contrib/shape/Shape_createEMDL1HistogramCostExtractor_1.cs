...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static HistogramCostExtractor createEMDL1HistogramCostExtractor (int nDummies)")]
    ...
    public class Shape_createEMDL1HistogramCostExtractor_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HistogramCostExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.ShapeModule.Shape.createEMDL1HistogramCostExtractor (nDummies.Value);
