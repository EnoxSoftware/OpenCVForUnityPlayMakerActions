...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static HistogramCostExtractor createEMDHistogramCostExtractor (int flag, int nDummies, float defaultCost)")]
    ...
    public class Shape_createEMDHistogramCostExtractor : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HistogramCostExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.ShapeModule.Shape.createEMDHistogramCostExtractor (flag.Value, nDummies.Value, defaultCost.Value);
