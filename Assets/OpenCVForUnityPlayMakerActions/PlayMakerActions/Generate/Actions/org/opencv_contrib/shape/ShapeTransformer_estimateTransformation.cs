...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class ShapeTransformer_estimateTransformation : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.CoreModule.Mat wrapped_transformingShape = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.CoreModule.Mat> (transformingShape);
            ...
            OpenCVForUnity.CoreModule.Mat wrapped_targetShape = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.CoreModule.Mat> (targetShape);
