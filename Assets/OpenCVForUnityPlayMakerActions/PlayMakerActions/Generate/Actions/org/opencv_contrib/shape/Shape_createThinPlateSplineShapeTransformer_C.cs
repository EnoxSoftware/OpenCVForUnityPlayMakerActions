...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createThinPlateSplineShapeTransformer_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ThinPlateSplineShapeTransformer)storeResult.Value).wrappedObject = OpenCVForUnity.ShapeModule.Shape.createThinPlateSplineShapeTransformer ((float)regularizationParameter.Value);
