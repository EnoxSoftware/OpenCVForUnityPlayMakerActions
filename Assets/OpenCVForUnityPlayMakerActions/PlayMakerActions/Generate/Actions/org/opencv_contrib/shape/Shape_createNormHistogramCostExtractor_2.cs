...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createNormHistogramCostExtractor_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HistogramCostExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.ShapeModule.Shape.createNormHistogramCostExtractor (flag.Value);
