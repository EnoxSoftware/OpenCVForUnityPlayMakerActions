...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static HistogramCostExtractor createEMDHistogramCostExtractor (int flag)")]
    ...
    public class Shape_createEMDHistogramCostExtractor_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HistogramCostExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.ShapeModule.Shape.createEMDHistogramCostExtractor (flag.Value);
