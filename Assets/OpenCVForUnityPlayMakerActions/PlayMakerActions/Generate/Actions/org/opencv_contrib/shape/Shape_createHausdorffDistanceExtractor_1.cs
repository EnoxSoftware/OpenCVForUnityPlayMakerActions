...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createHausdorffDistanceExtractor_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HausdorffDistanceExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.ShapeModule.Shape.createHausdorffDistanceExtractor (distanceFlag.Value);
