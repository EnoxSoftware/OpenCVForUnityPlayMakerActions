...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createEMDL1HistogramCostExtractor_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HistogramCostExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.ShapeModule.Shape.createEMDL1HistogramCostExtractor ();
