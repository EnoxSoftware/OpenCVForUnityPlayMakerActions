...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createNormHistogramCostExtractor_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HistogramCostExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.ShapeModule.Shape.createNormHistogramCostExtractor ();
