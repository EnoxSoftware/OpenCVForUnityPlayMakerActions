...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public float getBendingEnergyWeight ()")]
    ...
    public class ShapeContextDistanceExtractor_getBendingEnergyWeight : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = wrapped_owner.getBendingEnergyWeight ();
