...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class HausdorffDistanceExtractor_setDistanceFlag : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ShapeModule.HausdorffDistanceExtractor wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.HausdorffDistanceExtractor, OpenCVForUnity.ShapeModule.HausdorffDistanceExtractor> (owner);
