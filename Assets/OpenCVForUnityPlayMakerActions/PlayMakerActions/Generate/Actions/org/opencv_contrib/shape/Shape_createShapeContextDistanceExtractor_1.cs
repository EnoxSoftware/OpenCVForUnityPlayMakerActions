...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createShapeContextDistanceExtractor_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ShapeContextDistanceExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.ShapeModule.Shape.createShapeContextDistanceExtractor (nAngularBins.Value, nRadialBins.Value, innerRadius.Value, outerRadius.Value, iterations.Value, wrapped_comparer);
