...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class ThinPlateSplineShapeTransformer_getRegularizationParameter_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ShapeModule.ThinPlateSplineShapeTransformer wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.ThinPlateSplineShapeTransformer, OpenCVForUnity.ShapeModule.ThinPlateSplineShapeTransformer> (owner);

            storeResult.Value = (float)wrapped_owner.getRegularizationParameter ();
