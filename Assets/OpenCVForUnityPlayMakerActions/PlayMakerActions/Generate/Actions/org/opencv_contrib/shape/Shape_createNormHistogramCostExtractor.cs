...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createNormHistogramCostExtractor : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HistogramCostExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.ShapeModule.Shape.createNormHistogramCostExtractor (flag.Value, nDummies.Value, defaultCost.Value);
