...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class ShapeDistanceExtractor_computeDistance : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.ShapeModule.ShapeDistanceExtractor wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.ShapeDistanceExtractor, OpenCVForUnity.ShapeModule.ShapeDistanceExtractor> (owner);
