...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Shape_createHausdorffDistanceExtractor : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HausdorffDistanceExtractor)storeResult.Value).wrappedObject = OpenCVForUnity.ShapeModule.Shape.createHausdorffDistanceExtractor (distanceFlag.Value, rankProp.Value);
