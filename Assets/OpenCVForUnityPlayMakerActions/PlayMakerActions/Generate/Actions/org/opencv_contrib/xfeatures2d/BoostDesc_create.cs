...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class BoostDesc_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.BoostDesc)storeResult.Value).wrappedObject = OpenCVForUnity.BoostDesc.create (desc.Value, use_scale_orientation.Value, scale_factor.Value);
