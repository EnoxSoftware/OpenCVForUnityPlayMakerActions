...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static TEBLID create(float scale_factor, int n_bits)")]
    ...
    public class TEBLID_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TEBLID)storeResult.Value).wrappedObject = OpenCVForUnity.Xfeatures2dModule.TEBLID.create(scale_factor.Value, n_bits.Value);
