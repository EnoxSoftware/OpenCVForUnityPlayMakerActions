...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static TBMR create(int min_area, float max_area_relative, float scale_factor, int n_scales)")]
    ...
    public class TBMR_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TBMR)storeResult.Value).wrappedObject = OpenCVForUnity.Xfeatures2dModule.TBMR.create(min_area.Value, max_area_relative.Value, scale_factor.Value, n_scales.Value);
