...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setPatchRadius(int patch_radius)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.MSDDetector), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "patch_radius")]
    public class MSDDetector_setPatchRadius : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt patch_radius;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setPatchRadius(patch_radius.Value);
