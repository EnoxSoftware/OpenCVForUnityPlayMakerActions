...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class VGG_create_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.VGG)storeResult.Value).wrappedObject = OpenCVForUnity.Xfeatures2dModule.VGG.create (desc.Value, isigma.Value, img_normalize.Value, use_scale_orientation.Value, scale_factor.Value);
