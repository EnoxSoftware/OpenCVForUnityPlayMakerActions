...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class SIFT_create_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SIFT)storeResult.Value).wrappedObject = OpenCVForUnity.Xfeatures2dModule.SIFT.create(nfeatures.Value, nOctaveLayers.Value, wrapped_contrastThreshold);
