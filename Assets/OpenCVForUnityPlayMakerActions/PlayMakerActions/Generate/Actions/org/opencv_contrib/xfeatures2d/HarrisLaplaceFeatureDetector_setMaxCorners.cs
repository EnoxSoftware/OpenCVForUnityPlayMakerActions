...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setMaxCorners(int maxCorners_)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.HarrisLaplaceFeatureDetector), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "maxCorners_")]
    public class HarrisLaplaceFeatureDetector_setMaxCorners : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt maxCorners_;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setMaxCorners(maxCorners_.Value);
