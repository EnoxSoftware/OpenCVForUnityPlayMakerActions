...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class PCTSignaturesSQFD_create_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.PCTSignaturesSQFD)storeResult.Value).wrappedObject = OpenCVForUnity.Xfeatures2dModule.PCTSignaturesSQFD.create(distanceFunction.Value);
