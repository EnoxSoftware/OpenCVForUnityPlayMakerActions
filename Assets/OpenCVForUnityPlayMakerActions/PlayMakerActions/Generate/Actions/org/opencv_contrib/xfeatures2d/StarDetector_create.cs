...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class StarDetector_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.StarDetector)storeResult.Value).wrappedObject = OpenCVForUnity.StarDetector.create (maxSize.Value, responseThreshold.Value, lineThresholdProjected.Value, lineThresholdBinarized.Value, suppressNonmaxSize.Value);
