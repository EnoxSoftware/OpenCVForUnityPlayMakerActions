...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (OpenCVForUnityPlayMakerActions.Double), "thresholdFactor")]
    public class Xfeatures2d_matchGMS_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmObject thresholdFactor;
        ...
        void DoProcess ()
        {
            ...
            if (!(thresholdFactor.Value is OpenCVForUnityPlayMakerActions.Double))
            {
                LogError ("thresholdFactor is not initialized. Add Action \"newDouble\".");
                return;
            }
            System.Double wrapped_thresholdFactor = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Double, System.Double> (thresholdFactor);

            OpenCVForUnity.Xfeatures2d.matchGMS (new OpenCVForUnity.Size ((double)size1_width.Value, (double)size1_height.Value), new OpenCVForUnity.Size ((double)size2_width.Value, (double)size2_height.Value), wrapped_keypoints1, wrapped_keypoints2, wrapped_matches1to2, wrapped_matchesGMS, withRotation.Value, withScale.Value, wrapped_thresholdFactor);
