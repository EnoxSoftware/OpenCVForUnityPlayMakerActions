...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class PCTSignaturesSQFD_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.PCTSignaturesSQFD)storeResult.Value).wrappedObject = OpenCVForUnity.Xfeatures2dModule.PCTSignaturesSQFD.create(distanceFunction.Value, similarityFunction.Value, similarityParameter.Value);
