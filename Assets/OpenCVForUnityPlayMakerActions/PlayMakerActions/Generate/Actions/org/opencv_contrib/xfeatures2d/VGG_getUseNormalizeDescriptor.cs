...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool getUseNormalizeDescriptor()")]
    ...
    public class VGG_getUseNormalizeDescriptor : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.getUseNormalizeDescriptor();
