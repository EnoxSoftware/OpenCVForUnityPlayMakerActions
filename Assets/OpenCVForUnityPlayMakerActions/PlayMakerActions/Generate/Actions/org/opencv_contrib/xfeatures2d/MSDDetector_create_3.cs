...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static MSDDetector create(int m_patch_radius, int m_search_area_radius, int m_nms_radius, int m_nms_scale_radius, float m_th_saliency, int m_kNN)")]
    ...
    public class MSDDetector_create_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MSDDetector)storeResult.Value).wrappedObject = OpenCVForUnity.Xfeatures2dModule.MSDDetector.create(m_patch_radius.Value, m_search_area_radius.Value, m_nms_radius.Value, m_nms_scale_radius.Value, m_th_saliency.Value, m_kNN.Value);
