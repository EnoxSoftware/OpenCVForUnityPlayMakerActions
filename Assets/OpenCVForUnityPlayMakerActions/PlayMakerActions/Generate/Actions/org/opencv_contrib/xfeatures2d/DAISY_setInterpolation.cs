...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setInterpolation(bool interpolation)")]
    ...
    public class DAISY_setInterpolation : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setInterpolation(interpolation.Value);
