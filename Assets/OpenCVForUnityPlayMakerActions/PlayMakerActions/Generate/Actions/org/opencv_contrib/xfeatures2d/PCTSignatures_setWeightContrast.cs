...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setWeightContrast (float weight)")]
    ...
    public class PCTSignatures_setWeightContrast : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setWeightContrast (weight.Value);
