...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setOrientationNormalized(bool orientationNormalized)")]
    ...
    public class FREAK_setOrientationNormalized : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setOrientationNormalized(orientationNormalized.Value);
