...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class HarrisLaplaceFeatureDetector_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HarrisLaplaceFeatureDetector)storeResult.Value).wrappedObject = OpenCVForUnity.HarrisLaplaceFeatureDetector.create (numOctaves.Value, corn_thresh.Value, DOG_thresh.Value, maxCorners.Value, num_layers.Value);
