...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static MSDDetector create(int m_patch_radius, int m_search_area_radius)")]
    ...
    public class MSDDetector_create_7 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MSDDetector)storeResult.Value).wrappedObject = OpenCVForUnity.Xfeatures2dModule.MSDDetector.create(m_patch_radius.Value, m_search_area_radius.Value);
