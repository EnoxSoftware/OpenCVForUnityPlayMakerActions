...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static TBMR create(int min_area, float max_area_relative, float scale_factor)")]
    ...
    public class TBMR_create_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TBMR)storeResult.Value).wrappedObject = OpenCVForUnity.Xfeatures2dModule.TBMR.create(min_area.Value, max_area_relative.Value, scale_factor.Value);
