...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class PCTSignatures_drawSignature : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Xfeatures2dModule.PCTSignatures.drawSignature (wrapped_source, wrapped_signature, wrapped_result, radiusToShorterSideRatio.Value, borderThickness.Value);
