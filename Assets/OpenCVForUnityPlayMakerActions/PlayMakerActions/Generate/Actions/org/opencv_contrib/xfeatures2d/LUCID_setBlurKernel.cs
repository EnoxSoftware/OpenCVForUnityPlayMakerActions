...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setBlurKernel(int blur_kernel)")]
    ...
    public class LUCID_setBlurKernel : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setBlurKernel(blur_kernel.Value);
