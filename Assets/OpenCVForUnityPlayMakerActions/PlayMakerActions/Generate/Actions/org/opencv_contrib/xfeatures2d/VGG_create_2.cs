...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class VGG_create_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.VGG)storeResult.Value).wrappedObject = OpenCVForUnity.VGG.create (desc.Value, isigma.Value, img_normalize.Value, use_scale_orientation.Value);
