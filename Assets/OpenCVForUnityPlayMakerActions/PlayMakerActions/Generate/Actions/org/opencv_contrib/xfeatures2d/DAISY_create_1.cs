...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static DAISY create (float radius, int q_radius, int q_theta, int q_hist, int norm, Mat H, bool interpolation)")]
    ...
    public class DAISY_create_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.DAISY)storeResult.Value).wrappedObject = OpenCVForUnity.DAISY.create (radius.Value, q_radius.Value, q_theta.Value, q_hist.Value, norm.Value, wrapped_H, interpolation.Value);
