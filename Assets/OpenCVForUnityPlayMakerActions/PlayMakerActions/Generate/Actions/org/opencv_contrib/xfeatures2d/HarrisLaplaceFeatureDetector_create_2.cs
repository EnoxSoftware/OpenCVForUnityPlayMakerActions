...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static HarrisLaplaceFeatureDetector create(int numOctaves, float corn_thresh, float DOG_thresh)")]
    ...
    public class HarrisLaplaceFeatureDetector_create_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HarrisLaplaceFeatureDetector)storeResult.Value).wrappedObject = OpenCVForUnity.Xfeatures2dModule.HarrisLaplaceFeatureDetector.create(numOctaves.Value, corn_thresh.Value, DOG_thresh.Value);
