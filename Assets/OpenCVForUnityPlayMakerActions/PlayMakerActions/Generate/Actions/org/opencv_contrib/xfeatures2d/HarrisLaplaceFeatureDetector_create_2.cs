...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class HarrisLaplaceFeatureDetector_create_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.HarrisLaplaceFeatureDetector)storeResult.Value).wrappedObject = OpenCVForUnity.HarrisLaplaceFeatureDetector.create (numOctaves.Value, corn_thresh.Value, DOG_thresh.Value);
