...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setSuppressNonmaxSize(int _suppressNonmaxSize)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.StarDetector), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "_suppressNonmaxSize")]
    public class StarDetector_setSuppressNonmaxSize : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt _suppressNonmaxSize;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setSuppressNonmaxSize(_suppressNonmaxSize.Value);
