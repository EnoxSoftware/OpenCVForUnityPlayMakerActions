...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class StarDetector_create_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.StarDetector)storeResult.Value).wrappedObject = OpenCVForUnity.Xfeatures2dModule.StarDetector.create(maxSize.Value, responseThreshold.Value, lineThresholdProjected.Value);
