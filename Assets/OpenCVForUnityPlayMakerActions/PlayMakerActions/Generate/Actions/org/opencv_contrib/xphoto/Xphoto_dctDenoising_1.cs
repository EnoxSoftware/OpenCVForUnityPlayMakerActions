...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Xphoto_dctDenoising_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XphotoModule.Xphoto.dctDenoising(wrapped_src, wrapped_dst, wrapped_sigma);
