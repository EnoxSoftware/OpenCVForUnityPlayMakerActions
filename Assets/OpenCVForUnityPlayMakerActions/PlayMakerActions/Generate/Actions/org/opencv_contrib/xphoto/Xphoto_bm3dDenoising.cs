...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void bm3dDenoising (Mat src, Mat dst, float h, int templateWindowSize, int searchWindowSize, int blockMatchingStep1, int blockMatchingStep2, int groupSize, int slidingStep, float beta, int normType, int step, int transformType)")]
    ...
    public class Xphoto_bm3dDenoising : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.XphotoModule.Xphoto.bm3dDenoising (wrapped_src, wrapped_dst, h.Value, templateWindowSize.Value, searchWindowSize.Value, blockMatchingStep1.Value, blockMatchingStep2.Value, groupSize.Value, slidingStep.Value, beta.Value, normType.Value, step.Value, transformType.Value);
