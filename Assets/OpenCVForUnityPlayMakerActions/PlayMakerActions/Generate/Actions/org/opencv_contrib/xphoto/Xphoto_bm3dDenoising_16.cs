...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Xphoto_bm3dDenoising_16 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Xphoto.bm3dDenoising (wrapped_src, wrapped_dstStep1, wrapped_dstStep2, h.Value, templateWindowSize.Value, searchWindowSize.Value, blockMatchingStep1.Value, blockMatchingStep2.Value, groupSize.Value, slidingStep.Value);
