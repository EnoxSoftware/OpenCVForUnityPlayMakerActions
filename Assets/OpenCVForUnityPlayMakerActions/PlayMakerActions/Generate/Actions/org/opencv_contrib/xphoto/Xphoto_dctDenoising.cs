...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Xphoto_dctDenoising : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.XphotoModule.Xphoto.dctDenoising (wrapped_src, wrapped_dst, wrapped_sigma, psize.Value);
