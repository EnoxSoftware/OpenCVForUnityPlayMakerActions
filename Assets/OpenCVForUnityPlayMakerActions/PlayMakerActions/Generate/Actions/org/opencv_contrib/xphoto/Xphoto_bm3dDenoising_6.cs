...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Xphoto_bm3dDenoising_6 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Xphoto.bm3dDenoising (wrapped_src, wrapped_dst, h.Value, templateWindowSize.Value, searchWindowSize.Value, blockMatchingStep1.Value, blockMatchingStep2.Value);
