...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void bm3dDenoising(Mat src, Mat dst, float h, int templateWindowSize)")]
    ...
    public class Xphoto_bm3dDenoising_21 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XphotoModule.Xphoto.bm3dDenoising(wrapped_src, wrapped_dst, h.Value, templateWindowSize.Value);
