...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public  void setHistBinNum (int val)")]
    ...
    public class LearningBasedWB_setHistBinNum : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setHistBinNum (val.Value);
