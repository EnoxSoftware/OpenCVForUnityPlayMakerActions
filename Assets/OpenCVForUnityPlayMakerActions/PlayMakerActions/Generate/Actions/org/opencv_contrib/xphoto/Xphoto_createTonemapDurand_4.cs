...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static TonemapDurand createTonemapDurand(float gamma)")]
    ...
    public class Xphoto_createTonemapDurand_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TonemapDurand)storeResult.Value).wrappedObject = OpenCVForUnity.XphotoModule.Xphoto.createTonemapDurand(gamma.Value);
