...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Dictionary_create_from : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Dictionary)storeResult.Value).wrappedObject = OpenCVForUnity.ArucoModule.Dictionary.create_from(nMarkers.Value, markerSize.Value, wrapped_baseDictionary, randomSeed.Value);
