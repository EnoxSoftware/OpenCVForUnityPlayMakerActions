...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static int interpolateCornersCharuco (List<Mat> markerCorners, Mat markerIds, Mat image, CharucoBoard board, Mat charucoCorners, Mat charucoIds, Mat cameraMatrix, Mat distCoeffs, int minMarkers)")]
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmInt), "minMarkers")]
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmInt), "storeResult")]
    public class Aruco_interpolateCornersCharuco : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt minMarkers;
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Aruco.interpolateCornersCharuco (wrapped_markerCorners, wrapped_markerIds, wrapped_image, wrapped_board, wrapped_charucoCorners, wrapped_charucoIds, wrapped_cameraMatrix, wrapped_distCoeffs, minMarkers.Value);
