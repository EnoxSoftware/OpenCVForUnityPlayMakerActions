...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmFloat), "polygonalApproxAccuracyRate")]
    public class DetectorParameters_set_polygonalApproxAccuracyRate_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat polygonalApproxAccuracyRate;
        ...
        {
            owner = null;
            polygonalApproxAccuracyRate = 0.0f;
            everyFrame = false;
        }
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.set_polygonalApproxAccuracyRate ((float)polygonalApproxAccuracyRate.Value);
