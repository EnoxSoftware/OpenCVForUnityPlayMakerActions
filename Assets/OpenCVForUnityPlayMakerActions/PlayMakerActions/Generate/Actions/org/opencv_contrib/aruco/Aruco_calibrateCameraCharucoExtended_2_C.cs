...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Aruco_calibrateCameraCharucoExtended_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.Aruco.calibrateCameraCharucoExtended (wrapped_charucoCorners, wrapped_charucoIds, wrapped_board, wrapped_imageSize, wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_rvecs, wrapped_tvecs, wrapped_stdDeviationsIntrinsics, wrapped_stdDeviationsExtrinsics, wrapped_perViewErrors);
