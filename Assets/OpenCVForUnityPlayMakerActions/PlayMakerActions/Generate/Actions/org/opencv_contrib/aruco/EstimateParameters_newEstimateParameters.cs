...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public EstimateParameters()")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.EstimateParameters), "storeResult")]
    public class EstimateParameters_newEstimateParameters : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.EstimateParameters)storeResult.Value).wrappedObject = new OpenCVForUnity.ArucoModule.EstimateParameters();
