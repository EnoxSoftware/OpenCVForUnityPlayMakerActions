...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Aruco_custom_dictionary_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Dictionary)storeResult.Value).wrappedObject = OpenCVForUnity.ArucoModule.Aruco.custom_dictionary(nMarkers.Value, markerSize.Value);
