...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Aruco_detectCharucoDiamond_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Aruco.detectCharucoDiamond (wrapped_image, wrapped_markerCorners, wrapped_markerIds, squareMarkerLengthRate.Value, wrapped_diamondCorners, wrapped_diamondIds, wrapped_cameraMatrix);
