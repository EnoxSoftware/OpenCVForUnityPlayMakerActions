...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class DetectorParameters_set_perspectiveRemovePixelPerCell : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt perspectiveRemovePixelPerCell;
        ...
        {
            owner = null;
            perspectiveRemovePixelPerCell = 0;
            everyFrame = false;
        }
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.set_perspectiveRemovePixelPerCell (perspectiveRemovePixelPerCell.Value);
