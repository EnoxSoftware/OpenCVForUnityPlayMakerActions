...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Aruco_drawDetectedMarkers_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.ArucoModule.Aruco.drawDetectedMarkers(wrapped_image, wrapped_corners);
