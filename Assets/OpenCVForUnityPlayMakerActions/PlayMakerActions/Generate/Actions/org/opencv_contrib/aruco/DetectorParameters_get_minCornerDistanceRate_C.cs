...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class DetectorParameters_get_minCornerDistanceRate_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (float)wrapped_owner.get_minCornerDistanceRate();
