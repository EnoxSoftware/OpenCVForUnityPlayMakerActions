...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_detectInvertedMarker(bool detectInvertedMarker)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.DetectorParameters), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "detectInvertedMarker")]
    public class DetectorParameters_set_detectInvertedMarker : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool detectInvertedMarker;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_detectInvertedMarker(detectInvertedMarker.Value);
