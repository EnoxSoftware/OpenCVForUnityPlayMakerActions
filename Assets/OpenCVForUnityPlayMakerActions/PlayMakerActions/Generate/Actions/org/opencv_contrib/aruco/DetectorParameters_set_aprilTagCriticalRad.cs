...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_aprilTagCriticalRad(float aprilTagCriticalRad)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.DetectorParameters), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "aprilTagCriticalRad")]
    public class DetectorParameters_set_aprilTagCriticalRad : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat aprilTagCriticalRad;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_aprilTagCriticalRad(aprilTagCriticalRad.Value);
