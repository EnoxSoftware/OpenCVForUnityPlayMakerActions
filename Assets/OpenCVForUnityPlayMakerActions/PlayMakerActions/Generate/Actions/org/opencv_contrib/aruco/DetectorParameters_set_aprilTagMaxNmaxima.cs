...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void set_aprilTagMaxNmaxima (int aprilTagMaxNmaxima)")]
    [HutongGames.PlayMaker.ActionTarget (typeof (OpenCVForUnityPlayMakerActions.DetectorParameters), "owner")]
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmInt), "aprilTagMaxNmaxima")]
    public class DetectorParameters_set_aprilTagMaxNmaxima : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt aprilTagMaxNmaxima;
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.set_aprilTagMaxNmaxima (aprilTagMaxNmaxima.Value);
