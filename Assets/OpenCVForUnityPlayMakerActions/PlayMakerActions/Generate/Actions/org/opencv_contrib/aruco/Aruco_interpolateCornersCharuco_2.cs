...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Aruco_interpolateCornersCharuco_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.ArucoModule.Aruco.interpolateCornersCharuco (wrapped_markerCorners, wrapped_markerIds, wrapped_image, wrapped_board, wrapped_charucoCorners, wrapped_charucoIds, wrapped_cameraMatrix);
