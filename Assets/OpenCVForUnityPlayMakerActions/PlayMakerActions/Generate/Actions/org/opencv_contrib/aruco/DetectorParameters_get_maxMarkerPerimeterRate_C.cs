...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class DetectorParameters_get_maxMarkerPerimeterRate_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = (float)wrapped_owner.get_maxMarkerPerimeterRate ();
