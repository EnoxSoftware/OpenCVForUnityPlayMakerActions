...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static int estimatePoseBoard (List<Mat> corners, Mat ids, Board board, Mat cameraMatrix, Mat distCoeffs, Mat rvec, Mat tvec)")]
    ...
    public class Aruco_estimatePoseBoard_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = OpenCVForUnity.Aruco.estimatePoseBoard (wrapped_corners, wrapped_ids, wrapped_board, wrapped_cameraMatrix, wrapped_distCoeffs, wrapped_rvec, wrapped_tvec);
