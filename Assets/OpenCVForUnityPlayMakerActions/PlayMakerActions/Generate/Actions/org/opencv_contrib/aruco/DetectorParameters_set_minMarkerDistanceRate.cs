...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (OpenCVForUnityPlayMakerActions.Double), "minMarkerDistanceRate")]
    public class DetectorParameters_set_minMarkerDistanceRate : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmObject minMarkerDistanceRate;
        ...
        void DoProcess ()
        {
            ...
            if (!(minMarkerDistanceRate.Value is OpenCVForUnityPlayMakerActions.Double))
            {
                LogError ("minMarkerDistanceRate is not initialized. Add Action \"newDouble\".");
                return;
            }
            System.Double wrapped_minMarkerDistanceRate = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Double, System.Double> (minMarkerDistanceRate);

            wrapped_owner.set_minMarkerDistanceRate (wrapped_minMarkerDistanceRate);
