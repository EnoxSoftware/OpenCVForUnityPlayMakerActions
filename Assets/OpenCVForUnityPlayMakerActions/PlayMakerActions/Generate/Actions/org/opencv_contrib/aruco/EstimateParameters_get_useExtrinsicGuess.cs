...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool get_useExtrinsicGuess()")]
    ...
    public class EstimateParameters_get_useExtrinsicGuess : HutongGames.PlayMaker.FsmStateAction
    {
