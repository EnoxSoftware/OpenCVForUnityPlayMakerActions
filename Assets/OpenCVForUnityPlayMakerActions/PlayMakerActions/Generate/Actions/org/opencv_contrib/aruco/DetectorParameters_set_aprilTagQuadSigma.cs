...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_aprilTagQuadSigma(float aprilTagQuadSigma)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.DetectorParameters), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "aprilTagQuadSigma")]
    public class DetectorParameters_set_aprilTagQuadSigma : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat aprilTagQuadSigma;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_aprilTagQuadSigma(aprilTagQuadSigma.Value);
