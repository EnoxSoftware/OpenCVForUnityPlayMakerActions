...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_aprilTagMinWhiteBlackDiff(int aprilTagMinWhiteBlackDiff)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.DetectorParameters), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "aprilTagMinWhiteBlackDiff")]
    public class DetectorParameters_set_aprilTagMinWhiteBlackDiff : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt aprilTagMinWhiteBlackDiff;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_aprilTagMinWhiteBlackDiff(aprilTagMinWhiteBlackDiff.Value);
