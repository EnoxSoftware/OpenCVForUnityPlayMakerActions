...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Aruco_refineDetectedMarkers_5 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Aruco.refineDetectedMarkers (wrapped_image, wrapped_board, wrapped_detectedCorners, wrapped_detectedIds, wrapped_rejectedCorners, wrapped_cameraMatrix, wrapped_distCoeffs);
