...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_aprilTagMaxLineFitMse(float aprilTagMaxLineFitMse)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.DetectorParameters), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "aprilTagMaxLineFitMse")]
    public class DetectorParameters_set_aprilTagMaxLineFitMse : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat aprilTagMaxLineFitMse;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_aprilTagMaxLineFitMse(aprilTagMaxLineFitMse.Value);
