...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class DetectorParameters_set_minOtsuStdDev : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmObject minOtsuStdDev;
        ...
        void DoProcess ()
        {
            ...
            if (!(minOtsuStdDev.Value is OpenCVForUnityPlayMakerActions.Double))
            {
                LogError ("minOtsuStdDev is not initialized. Add Action \"newDouble\".");
                return;
            }
            System.Double wrapped_minOtsuStdDev = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Double, System.Double> (minOtsuStdDev);

            wrapped_owner.set_minOtsuStdDev (wrapped_minOtsuStdDev);
