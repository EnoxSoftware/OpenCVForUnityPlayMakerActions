...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static GridBoard create(int markersX, int markersY, float markerLength, float markerSeparation, Dictionary dictionary, int firstMarker)")]
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "firstMarker")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.GridBoard), "storeResult")]
    public class GridBoard_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.ObjectType(typeof(HutongGames.PlayMaker.FsmInt))]
        public HutongGames.PlayMaker.FsmInt firstMarker;
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.GridBoard)storeResult.Value).wrappedObject = OpenCVForUnity.ArucoModule.GridBoard.create(markersX.Value, markersY.Value, markerLength.Value, markerSeparation.Value, wrapped_dictionary, firstMarker.Value);
