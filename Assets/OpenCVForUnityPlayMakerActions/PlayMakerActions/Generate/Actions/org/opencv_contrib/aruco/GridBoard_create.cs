...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class GridBoard_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.GridBoard)storeResult.Value).wrappedObject = OpenCVForUnity.GridBoard.create (markersX.Value, markersY.Value, markerLength.Value, markerSeparation.Value, wrapped_dictionary, firstMarker.Value);
