...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_minDistanceToBorder(int minDistanceToBorder)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.DetectorParameters), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "minDistanceToBorder")]
    public class DetectorParameters_set_minDistanceToBorder : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt minDistanceToBorder;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_minDistanceToBorder(minDistanceToBorder.Value);
