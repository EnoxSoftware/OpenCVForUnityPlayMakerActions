...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static Dictionary create(int nMarkers, int markerSize, int randomSeed)")]
    ...
    public class Dictionary_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Dictionary)storeResult.Value).wrappedObject = OpenCVForUnity.ArucoModule.Dictionary.create(nMarkers.Value, markerSize.Value, randomSeed.Value);
