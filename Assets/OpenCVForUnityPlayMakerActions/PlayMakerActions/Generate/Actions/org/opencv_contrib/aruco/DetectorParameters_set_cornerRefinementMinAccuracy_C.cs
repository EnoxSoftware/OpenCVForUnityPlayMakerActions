...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "cornerRefinementMinAccuracy")]
    public class DetectorParameters_set_cornerRefinementMinAccuracy_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat cornerRefinementMinAccuracy;
        ...
        {
            owner = null;
            cornerRefinementMinAccuracy = 0.0f;
            everyFrame = false;
        }
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_cornerRefinementMinAccuracy((float)cornerRefinementMinAccuracy.Value);
