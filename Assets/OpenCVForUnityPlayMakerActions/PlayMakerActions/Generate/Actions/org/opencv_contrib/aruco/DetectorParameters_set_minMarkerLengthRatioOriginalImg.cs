...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_minMarkerLengthRatioOriginalImg(float minMarkerLengthRatioOriginalImg)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.DetectorParameters), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "minMarkerLengthRatioOriginalImg")]
    public class DetectorParameters_set_minMarkerLengthRatioOriginalImg : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat minMarkerLengthRatioOriginalImg;
        ...
        {
            owner = null;
            minMarkerLengthRatioOriginalImg = 0.0f;
            everyFrame = false;
        }
