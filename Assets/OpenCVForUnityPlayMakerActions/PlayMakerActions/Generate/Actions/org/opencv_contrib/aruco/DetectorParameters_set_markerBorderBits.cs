...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_markerBorderBits(int markerBorderBits)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.DetectorParameters), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "markerBorderBits")]
    public class DetectorParameters_set_markerBorderBits : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt markerBorderBits;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_markerBorderBits(markerBorderBits.Value);
