...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setGridLinesNumber(int gridLinesNumber)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.Plot2d), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "gridLinesNumber")]
    public class Plot2d_setGridLinesNumber : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt gridLinesNumber;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setGridLinesNumber(gridLinesNumber.Value);
