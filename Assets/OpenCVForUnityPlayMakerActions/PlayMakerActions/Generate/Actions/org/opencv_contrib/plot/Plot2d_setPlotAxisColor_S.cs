...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Plot2d_setPlotAxisColor_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setPlotAxisColor (new OpenCVForUnity.Scalar ((double)_plotAxisColor_v0.Value, (double)_plotAxisColor_v1.Value, (double)_plotAxisColor_v2.Value, (double)_plotAxisColor_v3.Value));
