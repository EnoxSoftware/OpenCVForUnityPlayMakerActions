...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Plot2d_setPlotTextColor : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Scalar wrapped__plotTextColor = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Scalar, OpenCVForUnity.Scalar> (_plotTextColor);
