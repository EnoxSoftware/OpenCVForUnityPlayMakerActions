...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static Plot2d createPlot2d (Mat dataX, Mat dataY)")]
    ...
    public class Plot_createPlot2d_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Plot2d)storeResult.Value).wrappedObject = OpenCVForUnity.Plot.createPlot2d (wrapped_dataX, wrapped_dataY);
