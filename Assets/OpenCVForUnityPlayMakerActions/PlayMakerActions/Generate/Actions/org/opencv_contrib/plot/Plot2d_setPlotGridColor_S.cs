...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Plot2d_setPlotGridColor_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setPlotGridColor (new OpenCVForUnity.CoreModule.Scalar ((double)_plotGridColor_v0.Value, (double)_plotGridColor_v1.Value, (double)_plotGridColor_v2.Value, (double)_plotGridColor_v3.Value));
