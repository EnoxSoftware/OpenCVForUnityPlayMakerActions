...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Plot2d_setPlotBackgroundColor : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Scalar wrapped__plotBackgroundColor = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Scalar, OpenCVForUnity.Scalar> (_plotBackgroundColor);
