...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_fastGlobalSmootherFilter : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Ximgproc.fastGlobalSmootherFilter (wrapped_guide, wrapped_src, wrapped_dst, wrapped_lambda, wrapped_sigma_color, wrapped_lambda_attenuation, num_iter.Value);
