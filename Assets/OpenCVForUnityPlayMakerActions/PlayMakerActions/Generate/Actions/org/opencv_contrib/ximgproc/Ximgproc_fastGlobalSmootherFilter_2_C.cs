...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void fastGlobalSmootherFilter (Mat guide, Mat src, Mat dst, double lambda, double sigma_color)")]
    ...
    public class Ximgproc_fastGlobalSmootherFilter_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.fastGlobalSmootherFilter (wrapped_guide, wrapped_src, wrapped_dst, (float)lambda.Value, (float)sigma_color.Value);
