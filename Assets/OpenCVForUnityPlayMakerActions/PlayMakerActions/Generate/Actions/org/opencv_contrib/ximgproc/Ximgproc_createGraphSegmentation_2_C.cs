...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createGraphSegmentation_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.GraphSegmentation)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.Ximgproc.createGraphSegmentation((float)sigma.Value);
