...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class RidgeDetectionFilter_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.RidgeDetectionFilter)storeResult.Value).wrappedObject = OpenCVForUnity.RidgeDetectionFilter.create (ddepth.Value, dx.Value, dy.Value, ksize.Value, out_dtype.Value, wrapped_scale, wrapped_delta, borderType.Value);
