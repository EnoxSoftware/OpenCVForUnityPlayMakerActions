...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class ContourFitting_estimateTransformation_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.estimateTransformation (wrapped_src, wrapped_dst, wrapped_alphaPhiST, wrapped_dist);
