...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "MaxErrorThreshold")]
    public class EdgeDrawing_Params_set_MaxErrorThreshold_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat MaxErrorThreshold;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_MaxErrorThreshold((float)MaxErrorThreshold.Value);
