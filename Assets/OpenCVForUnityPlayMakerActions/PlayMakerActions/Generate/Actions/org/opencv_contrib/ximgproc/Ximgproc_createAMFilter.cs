...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createAMFilter : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.AdaptiveManifoldFilter)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.Ximgproc.createAMFilter (wrapped_sigma_s, wrapped_sigma_r, adjust_outliers.Value);
