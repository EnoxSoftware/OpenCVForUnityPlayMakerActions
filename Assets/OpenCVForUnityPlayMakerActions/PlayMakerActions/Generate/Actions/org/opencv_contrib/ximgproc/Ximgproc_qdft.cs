...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void qdft(Mat img, Mat qimg, int flags, bool sideLeft)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.Mat), "img")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.Mat), "qimg")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "flags")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "sideLeft")]
    public class Ximgproc_qdft : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool sideLeft;
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.qdft(wrapped_img, wrapped_qimg, flags.Value, sideLeft.Value);
