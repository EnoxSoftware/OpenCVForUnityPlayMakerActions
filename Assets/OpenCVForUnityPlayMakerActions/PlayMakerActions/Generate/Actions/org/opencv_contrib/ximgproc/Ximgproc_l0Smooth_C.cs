...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_l0Smooth_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.l0Smooth(wrapped_src, wrapped_dst, (float)lambda.Value, (float)kappa.Value);
