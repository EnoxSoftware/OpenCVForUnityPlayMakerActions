...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setFGSLambda(float lambda)")]
    ...
    public class RICInterpolator_setFGSLambda : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setFGSLambda(lambda.Value);
