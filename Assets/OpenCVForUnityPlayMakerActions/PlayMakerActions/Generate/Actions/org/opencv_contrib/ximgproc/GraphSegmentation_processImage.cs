...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void processImage (Mat src, Mat dst)")]
    ...
    public class GraphSegmentation_processImage : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.processImage (wrapped_src, wrapped_dst);
