...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createDTFilter_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.DTFilter)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.Ximgproc.createDTFilter (wrapped_guide, wrapped_sigmaSpatial, wrapped_sigmaColor);
