...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_fastBilateralSolverFilter_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.fastBilateralSolverFilter (wrapped_guide, wrapped_src, wrapped_confidence, wrapped_dst, (float)sigma_spatial.Value, (float)sigma_luma.Value, (float)sigma_chroma.Value, (float)lambda.Value);
