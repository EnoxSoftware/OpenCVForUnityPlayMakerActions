...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static RidgeDetectionFilter create(int ddepth, int dx, int dy, int ksize, int out_dtype)")]
    ...
    public class RidgeDetectionFilter_create_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.RidgeDetectionFilter)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.RidgeDetectionFilter.create(ddepth.Value, dx.Value, dy.Value, ksize.Value, out_dtype.Value);
