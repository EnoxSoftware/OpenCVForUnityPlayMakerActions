...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool getUseVariationalRefinement()")]
    ...
    public class RICInterpolator_getUseVariationalRefinement : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.getUseVariationalRefinement();
