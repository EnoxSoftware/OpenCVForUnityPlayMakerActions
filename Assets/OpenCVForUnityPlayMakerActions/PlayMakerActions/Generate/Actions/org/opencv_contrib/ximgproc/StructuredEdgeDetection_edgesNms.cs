...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void edgesNms (Mat edge_image, Mat orientation_image, Mat _dst, int r, int s, float m, bool isParallel)")]
    ...
    public class StructuredEdgeDetection_edgesNms : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.edgesNms (wrapped_edge_image, wrapped_orientation_image, wrapped__dst, r.Value, s.Value, m.Value, isParallel.Value);
