...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createSelectiveSearchSegmentationStrategyMultiple : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.SelectiveSearchSegmentationStrategy wrapped_s4 = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.SelectiveSearchSegmentationStrategy, OpenCVForUnity.SelectiveSearchSegmentationStrategy> (s4);
            ...
            ((OpenCVForUnityPlayMakerActions.SelectiveSearchSegmentationStrategyMultiple)storeResult.Value).wrappedObject = OpenCVForUnity.Ximgproc.createSelectiveSearchSegmentationStrategyMultiple (wrapped_s1, wrapped_s2, wrapped_s3, wrapped_s4);
