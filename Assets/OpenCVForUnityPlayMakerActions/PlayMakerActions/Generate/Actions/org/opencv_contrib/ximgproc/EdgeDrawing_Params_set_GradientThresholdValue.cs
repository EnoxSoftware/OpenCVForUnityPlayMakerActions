...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_GradientThresholdValue(int GradientThresholdValue)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.EdgeDrawing_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "GradientThresholdValue")]
    public class EdgeDrawing_Params_set_GradientThresholdValue : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt GradientThresholdValue;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_GradientThresholdValue(GradientThresholdValue.Value);
