...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_NFAValidation(bool NFAValidation)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.EdgeDrawing_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "NFAValidation")]
    public class EdgeDrawing_Params_set_NFAValidation : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool NFAValidation;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_NFAValidation(NFAValidation.Value);
