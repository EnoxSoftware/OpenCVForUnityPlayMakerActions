...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void findEllipses(Mat image, Mat ellipses, float scoreThreshold)")]
    ...
    public class Ximgproc_findEllipses_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.findEllipses(wrapped_image, wrapped_ellipses, scoreThreshold.Value);
