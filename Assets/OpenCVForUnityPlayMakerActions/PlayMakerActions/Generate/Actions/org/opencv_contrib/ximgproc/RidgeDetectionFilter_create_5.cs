...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class RidgeDetectionFilter_create_5 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.RidgeDetectionFilter)storeResult.Value).wrappedObject = OpenCVForUnity.RidgeDetectionFilter.create (ddepth.Value, dx.Value, dy.Value);
