...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static ScanSegment createScanSegment(int image_width, int image_height, int num_superpixels)")]
    ...
    public class Ximgproc_createScanSegment_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ScanSegment)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.Ximgproc.createScanSegment(image_width.Value, image_height.Value, num_superpixels.Value);
