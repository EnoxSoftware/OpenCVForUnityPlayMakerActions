...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createAMFilter_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.AdaptiveManifoldFilter)storeResult.Value).wrappedObject = OpenCVForUnity.Ximgproc.createAMFilter ((float)sigma_s.Value, (float)sigma_r.Value, adjust_outliers.Value);
