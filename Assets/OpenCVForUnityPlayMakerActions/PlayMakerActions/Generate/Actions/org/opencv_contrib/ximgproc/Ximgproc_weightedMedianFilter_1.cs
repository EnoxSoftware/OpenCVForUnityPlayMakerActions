...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_weightedMedianFilter_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.weightedMedianFilter (wrapped_joint, wrapped_src, wrapped_dst, r.Value, wrapped_sigma, weightType.Value);
