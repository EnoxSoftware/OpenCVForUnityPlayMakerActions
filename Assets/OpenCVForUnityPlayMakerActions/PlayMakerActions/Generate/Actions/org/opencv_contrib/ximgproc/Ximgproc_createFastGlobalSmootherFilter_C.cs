...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createFastGlobalSmootherFilter_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.FastGlobalSmootherFilter)storeResult.Value).wrappedObject = OpenCVForUnity.Ximgproc.createFastGlobalSmootherFilter (wrapped_guide, (float)lambda.Value, (float)sigma_color.Value, (float)lambda_attenuation.Value, num_iter.Value);
