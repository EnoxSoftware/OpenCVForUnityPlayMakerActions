...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void qmultiply (Mat src1, Mat src2, Mat dst)")]
    ...
    public class Ximgproc_qmultiply : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.qmultiply (wrapped_src1, wrapped_src2, wrapped_dst);
