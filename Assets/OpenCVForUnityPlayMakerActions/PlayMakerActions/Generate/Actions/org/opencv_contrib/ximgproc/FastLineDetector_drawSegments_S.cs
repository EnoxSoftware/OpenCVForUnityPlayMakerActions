...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class FastLineDetector_drawSegments_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.drawSegments(wrapped_image, wrapped_lines, draw_arrow.Value, new OpenCVForUnity.CoreModule.Scalar((double)linecolor_v0.Value, (double)linecolor_v1.Value, (double)linecolor_v2.Value, (double)linecolor_v3.Value), linethickness.Value);
