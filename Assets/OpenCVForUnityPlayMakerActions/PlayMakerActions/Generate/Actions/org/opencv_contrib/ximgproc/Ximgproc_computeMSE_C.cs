...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_computeMSE_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.XimgprocModule.Ximgproc.computeMSE(wrapped_GT, wrapped_src, wrapped_ROI);
