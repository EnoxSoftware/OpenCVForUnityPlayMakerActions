...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_computeMSE_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.XimgprocModule.Ximgproc.computeMSE(wrapped_GT, wrapped_src, new OpenCVForUnity.CoreModule.Rect((int)ROI_x.Value, (int)ROI_y.Value, (int)ROI_width.Value, (int)ROI_height.Value));
