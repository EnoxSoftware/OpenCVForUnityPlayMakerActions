...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createSuperpixelLSC_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SuperpixelLSC)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.Ximgproc.createSuperpixelLSC(wrapped_image, region_size.Value);
