...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void switchToSelectiveSearchQuality(int base_k)")]
    ...
    public class SelectiveSearchSegmentation_switchToSelectiveSearchQuality_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.switchToSelectiveSearchQuality(base_k.Value);
