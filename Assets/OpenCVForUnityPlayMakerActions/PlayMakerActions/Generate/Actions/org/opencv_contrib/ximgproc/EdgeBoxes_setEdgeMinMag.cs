...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setEdgeMinMag(float value)")]
    ...
    public class EdgeBoxes_setEdgeMinMag : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setEdgeMinMag(value.Value);
