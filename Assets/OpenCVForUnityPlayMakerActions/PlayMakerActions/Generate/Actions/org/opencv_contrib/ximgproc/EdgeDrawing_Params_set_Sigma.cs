...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_Sigma(float Sigma)")]
    ...
    public class EdgeDrawing_Params_set_Sigma : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_Sigma(Sigma.Value);
