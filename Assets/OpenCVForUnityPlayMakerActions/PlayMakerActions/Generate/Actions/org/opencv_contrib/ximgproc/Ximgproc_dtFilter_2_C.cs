...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_dtFilter_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.dtFilter(wrapped_guide, wrapped_src, wrapped_dst, (float)sigmaSpatial.Value, (float)sigmaColor.Value);
