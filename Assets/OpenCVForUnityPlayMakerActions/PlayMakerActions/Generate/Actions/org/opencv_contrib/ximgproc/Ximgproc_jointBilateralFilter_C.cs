...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_jointBilateralFilter_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Ximgproc.jointBilateralFilter (wrapped_joint, wrapped_src, wrapped_dst, d.Value, (float)sigmaColor.Value, (float)sigmaSpace.Value, borderType.Value);
