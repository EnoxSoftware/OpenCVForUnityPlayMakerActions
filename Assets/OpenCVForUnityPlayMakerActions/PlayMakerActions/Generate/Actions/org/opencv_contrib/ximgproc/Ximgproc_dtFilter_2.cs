...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_dtFilter_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.dtFilter(wrapped_guide, wrapped_src, wrapped_dst, wrapped_sigmaSpatial, wrapped_sigmaColor);
