...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void estimateTransformation (Mat src, Mat dst, Mat alphaPhiST, double[] dist)")]
    ...
    public class ContourFitting_estimateTransformation_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Mat wrapped_alphaPhiST = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.Mat> (alphaPhiST);

            float[] float_dist = dist.floatValues;
            double[] casted_dist = new double[float_dist.Length];
            float_dist.CopyTo (casted_dist, 0);

            wrapped_owner.estimateTransformation (wrapped_src, wrapped_dst, wrapped_alphaPhiST, casted_dist);
