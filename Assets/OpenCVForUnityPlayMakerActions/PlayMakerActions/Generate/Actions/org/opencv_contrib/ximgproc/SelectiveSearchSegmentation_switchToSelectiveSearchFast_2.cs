...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void switchToSelectiveSearchFast (int base_k)")]
    ...
    public class SelectiveSearchSegmentation_switchToSelectiveSearchFast_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.switchToSelectiveSearchFast (base_k.Value);
