...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void weightedMedianFilter(Mat joint, Mat src, Mat dst, int r, double sigma, int weightType)")]
    ...
    public class Ximgproc_weightedMedianFilter_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.weightedMedianFilter(wrapped_joint, wrapped_src, wrapped_dst, r.Value, (float)sigma.Value, weightType.Value);
