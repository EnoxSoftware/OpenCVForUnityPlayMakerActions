...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_getDisparityVis : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.getDisparityVis(wrapped_src, wrapped_dst, wrapped_scale);
