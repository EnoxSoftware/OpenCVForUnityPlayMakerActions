...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_weightedMedianFilter_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.weightedMedianFilter (wrapped_joint, wrapped_src, wrapped_dst, r.Value, (float)sigma.Value);
