...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static ScanSegment createScanSegment(int image_width, int image_height, int num_superpixels, int slices, bool merge_small)")]
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "merge_small")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.ScanSegment), "storeResult")]
    public class Ximgproc_createScanSegment : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool merge_small;
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ScanSegment)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.Ximgproc.createScanSegment(image_width.Value, image_height.Value, num_superpixels.Value, slices.Value, merge_small.Value);
