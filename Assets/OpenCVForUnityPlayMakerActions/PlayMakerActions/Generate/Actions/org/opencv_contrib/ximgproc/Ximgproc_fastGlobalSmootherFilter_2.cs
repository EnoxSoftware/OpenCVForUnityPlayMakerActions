...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_fastGlobalSmootherFilter_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.fastGlobalSmootherFilter(wrapped_guide, wrapped_src, wrapped_dst, wrapped_lambda, wrapped_sigma_color);
