...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createSelectiveSearchSegmentationStrategyFill : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SelectiveSearchSegmentationStrategyFill)storeResult.Value).wrappedObject = OpenCVForUnity.Ximgproc.createSelectiveSearchSegmentationStrategyFill ();
