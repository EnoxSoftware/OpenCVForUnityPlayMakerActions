...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "LineFitErrorThreshold")]
    public class EdgeDrawing_Params_set_LineFitErrorThreshold_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat LineFitErrorThreshold;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_LineFitErrorThreshold((float)LineFitErrorThreshold.Value);
