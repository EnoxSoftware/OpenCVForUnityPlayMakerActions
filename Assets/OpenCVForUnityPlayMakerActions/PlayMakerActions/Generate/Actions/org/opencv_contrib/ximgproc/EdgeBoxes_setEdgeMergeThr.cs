...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setEdgeMergeThr(float value)")]
    ...
    public class EdgeBoxes_setEdgeMergeThr : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setEdgeMergeThr(value.Value);
