...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createEdgeBoxes : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.EdgeBoxes)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.Ximgproc.createEdgeBoxes(alpha.Value, beta.Value, eta.Value, minScore.Value, maxBoxes.Value, edgeMinMag.Value, edgeMergeThr.Value, clusterMinMag.Value, maxAspectRatio.Value, minBoxArea.Value, gamma.Value, kappa.Value);
