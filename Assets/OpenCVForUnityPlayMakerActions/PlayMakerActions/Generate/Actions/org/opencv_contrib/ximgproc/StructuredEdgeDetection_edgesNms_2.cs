...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void edgesNms(Mat edge_image, Mat orientation_image, Mat dst, int r, int s)")]
    ...
    public class StructuredEdgeDetection_edgesNms_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.edgesNms(wrapped_edge_image, wrapped_orientation_image, wrapped_dst, r.Value, s.Value);
