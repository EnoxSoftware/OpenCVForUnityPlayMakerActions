...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void amFilter(Mat joint, Mat src, Mat dst, double sigma_s, double sigma_r)")]
    ...
    public class Ximgproc_amFilter_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.amFilter(wrapped_joint, wrapped_src, wrapped_dst, (float)sigma_s.Value, (float)sigma_r.Value);
