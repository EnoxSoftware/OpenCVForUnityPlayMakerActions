...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "MaxDistanceBetweenTwoLines")]
    public class EdgeDrawing_Params_set_MaxDistanceBetweenTwoLines_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat MaxDistanceBetweenTwoLines;
        ...
        {
            owner = null;
            MaxDistanceBetweenTwoLines = 0.0f;
            everyFrame = false;
        }
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_MaxDistanceBetweenTwoLines((float)MaxDistanceBetweenTwoLines.Value);
