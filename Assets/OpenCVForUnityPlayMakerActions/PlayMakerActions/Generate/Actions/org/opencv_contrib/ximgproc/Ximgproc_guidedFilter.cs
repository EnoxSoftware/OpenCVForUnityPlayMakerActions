...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_guidedFilter : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.guidedFilter(wrapped_guide, wrapped_src, wrapped_dst, radius.Value, wrapped_eps, dDepth.Value);
