...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void switchToSelectiveSearchQuality(int base_k, int inc_k)")]
    ...
    public class SelectiveSearchSegmentation_switchToSelectiveSearchQuality_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.switchToSelectiveSearchQuality(base_k.Value, inc_k.Value);
