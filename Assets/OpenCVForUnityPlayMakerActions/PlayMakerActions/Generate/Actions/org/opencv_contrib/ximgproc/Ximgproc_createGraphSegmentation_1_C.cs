...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createGraphSegmentation_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.GraphSegmentation)storeResult.Value).wrappedObject = OpenCVForUnity.Ximgproc.createGraphSegmentation ((float)sigma.Value, k.Value);
