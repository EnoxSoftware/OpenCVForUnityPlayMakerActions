...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_GradientDericheX : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.GradientDericheX(wrapped_op, wrapped_dst, wrapped_alpha, wrapped_omega);
