...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setLambda(float _lambda)")]
    ...
    public class EdgeAwareInterpolator_setLambda : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setLambda(_lambda.Value);
