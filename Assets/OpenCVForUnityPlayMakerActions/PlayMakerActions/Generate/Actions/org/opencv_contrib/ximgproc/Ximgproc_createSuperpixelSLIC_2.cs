...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createSuperpixelSLIC_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SuperpixelSLIC)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.Ximgproc.createSuperpixelSLIC (wrapped_image, algorithm.Value);
