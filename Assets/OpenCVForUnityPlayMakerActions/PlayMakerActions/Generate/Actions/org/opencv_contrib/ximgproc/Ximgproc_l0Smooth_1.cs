...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_l0Smooth_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.l0Smooth(wrapped_src, wrapped_dst, wrapped_lambda);
