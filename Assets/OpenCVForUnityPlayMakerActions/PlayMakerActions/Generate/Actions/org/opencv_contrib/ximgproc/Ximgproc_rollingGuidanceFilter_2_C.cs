...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_rollingGuidanceFilter_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.rollingGuidanceFilter(wrapped_src, wrapped_dst, d.Value, (float)sigmaColor.Value, (float)sigmaSpace.Value);
