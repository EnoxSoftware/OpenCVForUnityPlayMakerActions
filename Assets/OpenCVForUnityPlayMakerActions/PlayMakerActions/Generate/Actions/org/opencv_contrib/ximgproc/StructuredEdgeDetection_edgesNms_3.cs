...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void edgesNms (Mat edge_image, Mat orientation_image, Mat _dst, int r)")]
    ...
    public class StructuredEdgeDetection_edgesNms_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.edgesNms (wrapped_edge_image, wrapped_orientation_image, wrapped__dst, r.Value);
