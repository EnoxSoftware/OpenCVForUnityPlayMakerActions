...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createFastLineDetector_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.FastLineDetector)storeResult.Value).wrappedObject = OpenCVForUnity.Ximgproc.createFastLineDetector (_length_threshold.Value, _distance_threshold.Value, wrapped__canny_th1, wrapped__canny_th2, _canny_aperture_size.Value);
