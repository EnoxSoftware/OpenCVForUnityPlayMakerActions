...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void fastGlobalSmootherFilter(Mat guide, Mat src, Mat dst, double lambda, double sigma_color, double lambda_attenuation, int num_iter)")]
    ...
    public class Ximgproc_fastGlobalSmootherFilter_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.fastGlobalSmootherFilter(wrapped_guide, wrapped_src, wrapped_dst, (float)lambda.Value, (float)sigma_color.Value, (float)lambda_attenuation.Value, num_iter.Value);
