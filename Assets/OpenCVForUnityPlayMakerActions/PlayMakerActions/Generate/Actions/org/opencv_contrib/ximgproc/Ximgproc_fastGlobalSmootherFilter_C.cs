...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_fastGlobalSmootherFilter_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Ximgproc.fastGlobalSmootherFilter (wrapped_guide, wrapped_src, wrapped_dst, (float)lambda.Value, (float)sigma_color.Value, (float)lambda_attenuation.Value, num_iter.Value);
