...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static RidgeDetectionFilter create (int ddepth, int dx, int dy, int ksize)")]
    ...
    public class RidgeDetectionFilter_create_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.RidgeDetectionFilter)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.RidgeDetectionFilter.create (ddepth.Value, dx.Value, dy.Value, ksize.Value);
