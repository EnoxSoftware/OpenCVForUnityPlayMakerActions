...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createFastGlobalSmootherFilter_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.FastGlobalSmootherFilter)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.Ximgproc.createFastGlobalSmootherFilter(wrapped_guide, (float)lambda.Value, (float)sigma_color.Value, (float)lambda_attenuation.Value);
