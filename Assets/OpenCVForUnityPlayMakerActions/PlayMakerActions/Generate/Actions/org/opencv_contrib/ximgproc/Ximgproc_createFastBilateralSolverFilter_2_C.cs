...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createFastBilateralSolverFilter_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.FastBilateralSolverFilter)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.Ximgproc.createFastBilateralSolverFilter(wrapped_guide, (float)sigma_spatial.Value, (float)sigma_luma.Value, (float)sigma_chroma.Value, (float)lambda.Value);
