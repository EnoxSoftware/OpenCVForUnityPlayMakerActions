...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_amFilter_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.amFilter(wrapped_joint, wrapped_src, wrapped_dst, (float)sigma_s.Value, (float)sigma_r.Value, adjust_outliers.Value);
