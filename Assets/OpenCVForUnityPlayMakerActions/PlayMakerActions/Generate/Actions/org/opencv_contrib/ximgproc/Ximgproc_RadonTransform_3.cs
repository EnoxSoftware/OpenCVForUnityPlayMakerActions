...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_RadonTransform_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.RadonTransform(wrapped_src, wrapped_dst, wrapped_theta, wrapped_start_angle);
