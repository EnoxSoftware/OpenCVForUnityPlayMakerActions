...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void transformFD(Mat src, Mat t, Mat dst, bool fdContour)")]
    ...
    public class Ximgproc_transformFD : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.transformFD(wrapped_src, wrapped_t, wrapped_dst, fdContour.Value);
