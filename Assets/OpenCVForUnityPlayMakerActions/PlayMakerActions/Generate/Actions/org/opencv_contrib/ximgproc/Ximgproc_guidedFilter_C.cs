...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void guidedFilter(Mat guide, Mat src, Mat dst, int radius, double eps, int dDepth)")]
    ...
    public class Ximgproc_guidedFilter_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.guidedFilter(wrapped_guide, wrapped_src, wrapped_dst, radius.Value, (float)eps.Value, dDepth.Value);
