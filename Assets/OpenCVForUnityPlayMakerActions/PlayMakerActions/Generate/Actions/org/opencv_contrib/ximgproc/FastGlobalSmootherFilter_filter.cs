...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class FastGlobalSmootherFilter_filter : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.FastGlobalSmootherFilter wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.FastGlobalSmootherFilter, OpenCVForUnity.XimgprocModule.FastGlobalSmootherFilter>(owner);
