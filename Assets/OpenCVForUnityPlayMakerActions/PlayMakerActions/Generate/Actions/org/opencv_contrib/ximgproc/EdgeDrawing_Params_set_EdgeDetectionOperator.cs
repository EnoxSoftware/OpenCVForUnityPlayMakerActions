...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_EdgeDetectionOperator(int EdgeDetectionOperator)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.EdgeDrawing_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "EdgeDetectionOperator")]
    public class EdgeDrawing_Params_set_EdgeDetectionOperator : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt EdgeDetectionOperator;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_EdgeDetectionOperator(EdgeDetectionOperator.Value);
