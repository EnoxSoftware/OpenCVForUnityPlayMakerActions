...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setMinBoxArea (float value)")]
    ...
    public class EdgeBoxes_setMinBoxArea : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setMinBoxArea (value.Value);
