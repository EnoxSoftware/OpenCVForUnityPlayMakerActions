...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void switchToSelectiveSearchFast (int base_k, int inc_k, float sigma)")]
    ...
    public class SelectiveSearchSegmentation_switchToSelectiveSearchFast : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.switchToSelectiveSearchFast (base_k.Value, inc_k.Value, sigma.Value);
