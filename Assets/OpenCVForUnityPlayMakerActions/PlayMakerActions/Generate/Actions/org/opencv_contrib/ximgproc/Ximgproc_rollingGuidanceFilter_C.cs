...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_rollingGuidanceFilter_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Ximgproc.rollingGuidanceFilter (wrapped_src, wrapped_dst, d.Value, (float)sigmaColor.Value, (float)sigmaSpace.Value, numOfIter.Value, borderType.Value);
