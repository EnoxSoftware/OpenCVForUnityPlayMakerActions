...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class EdgeDrawing_Params_get_MaxErrorThreshold_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (float)wrapped_owner.get_MaxErrorThreshold();
