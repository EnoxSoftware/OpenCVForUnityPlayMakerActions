...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void iterate(Mat img, int num_iterations)")]
    ...
    public class SuperpixelSEEDS_iterate : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.iterate(wrapped_img, num_iterations.Value);
