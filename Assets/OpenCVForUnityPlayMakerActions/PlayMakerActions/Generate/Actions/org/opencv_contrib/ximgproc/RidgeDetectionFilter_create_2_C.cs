...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static RidgeDetectionFilter create (int ddepth, int dx, int dy, int ksize, int out_dtype, double scale)")]
    ...
    public class RidgeDetectionFilter_create_2_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.RidgeDetectionFilter)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.RidgeDetectionFilter.create (ddepth.Value, dx.Value, dy.Value, ksize.Value, out_dtype.Value, (float)scale.Value);
