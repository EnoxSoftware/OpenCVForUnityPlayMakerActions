...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setSuperpixelMode(int mode)")]
    ...
    public class RICInterpolator_setSuperpixelMode : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setSuperpixelMode(mode.Value);
