...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class EdgeDrawing_Params_get_MaxDistanceBetweenTwoLines_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (float)wrapped_owner.get_MaxDistanceBetweenTwoLines();
