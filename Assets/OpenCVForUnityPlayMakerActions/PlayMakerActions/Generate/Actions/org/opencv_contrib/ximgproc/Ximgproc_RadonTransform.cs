...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_RadonTransform : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.RadonTransform(wrapped_src, wrapped_dst, wrapped_theta, wrapped_start_angle, wrapped_end_angle, crop.Value, norm.Value);
