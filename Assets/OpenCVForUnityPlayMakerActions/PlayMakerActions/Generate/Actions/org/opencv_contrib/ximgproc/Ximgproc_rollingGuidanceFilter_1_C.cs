...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void rollingGuidanceFilter(Mat src, Mat dst, int d, double sigmaColor, double sigmaSpace, int numOfIter)")]
    ...
    public class Ximgproc_rollingGuidanceFilter_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.rollingGuidanceFilter(wrapped_src, wrapped_dst, d.Value, (float)sigmaColor.Value, (float)sigmaSpace.Value, numOfIter.Value);
