...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void GradientDericheX(Mat op, Mat dst, double alpha, double omega)")]
    ...
    public class Ximgproc_GradientDericheX_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.GradientDericheX(wrapped_op, wrapped_dst, (float)alpha.Value, (float)omega.Value);
