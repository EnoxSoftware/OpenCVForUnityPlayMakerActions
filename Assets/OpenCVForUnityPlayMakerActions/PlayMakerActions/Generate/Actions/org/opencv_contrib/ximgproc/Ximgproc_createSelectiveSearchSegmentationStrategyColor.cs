...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createSelectiveSearchSegmentationStrategyColor : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SelectiveSearchSegmentationStrategyColor)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.Ximgproc.createSelectiveSearchSegmentationStrategyColor ();
