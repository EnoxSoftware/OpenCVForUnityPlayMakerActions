...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_rollingGuidanceFilter_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.rollingGuidanceFilter(wrapped_src, wrapped_dst, d.Value, wrapped_sigmaColor, wrapped_sigmaSpace, numOfIter.Value);
