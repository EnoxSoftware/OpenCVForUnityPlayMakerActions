...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_amFilter_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.amFilter(wrapped_joint, wrapped_src, wrapped_dst, wrapped_sigma_s, wrapped_sigma_r);
