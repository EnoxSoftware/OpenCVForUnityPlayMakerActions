...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static double computeMSE(Mat GT, Mat src, Rect ROI)")]
    ...
    public class Ximgproc_computeMSE_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = OpenCVForUnity.XimgprocModule.Ximgproc.computeMSE(wrapped_GT, wrapped_src, new OpenCVForUnity.CoreModule.Rect((int)ROI_x.Value, (int)ROI_y.Value, (int)ROI_width.Value, (int)ROI_height.Value));
