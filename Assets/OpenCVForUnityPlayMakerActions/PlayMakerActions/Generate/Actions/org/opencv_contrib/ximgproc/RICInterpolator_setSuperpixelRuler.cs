...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setSuperpixelRuler(float ruler)")]
    ...
    public class RICInterpolator_setSuperpixelRuler : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setSuperpixelRuler(ruler.Value);
