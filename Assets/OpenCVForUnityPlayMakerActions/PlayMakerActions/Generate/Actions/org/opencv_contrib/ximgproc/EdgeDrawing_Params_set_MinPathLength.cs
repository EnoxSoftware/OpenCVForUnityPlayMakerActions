...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_MinPathLength(int MinPathLength)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.EdgeDrawing_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "MinPathLength")]
    public class EdgeDrawing_Params_set_MinPathLength : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt MinPathLength;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_MinPathLength(MinPathLength.Value);
