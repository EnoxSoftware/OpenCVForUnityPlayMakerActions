...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void drawSegments(Mat image, Mat lines, bool draw_arrow)")]
    ...
    public class FastLineDetector_drawSegments_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.drawSegments(wrapped_image, wrapped_lines, draw_arrow.Value);
