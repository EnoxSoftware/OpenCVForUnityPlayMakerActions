...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_bilateralTextureFilter_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.bilateralTextureFilter(wrapped_src, wrapped_dst, fr.Value, numIter.Value, (float)sigmaAlpha.Value);
