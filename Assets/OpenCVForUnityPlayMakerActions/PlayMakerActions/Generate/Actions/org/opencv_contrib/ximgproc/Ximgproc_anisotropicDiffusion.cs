...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void anisotropicDiffusion(Mat src, Mat dst, float alpha, float K, int niters)")]
    ...
    public class Ximgproc_anisotropicDiffusion : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.anisotropicDiffusion(wrapped_src, wrapped_dst, alpha.Value, K.Value, niters.Value);
