...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createEdgeBoxes_7 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.EdgeBoxes)storeResult.Value).wrappedObject = OpenCVForUnity.Ximgproc.createEdgeBoxes (alpha.Value, beta.Value, eta.Value, minScore.Value, maxBoxes.Value);
