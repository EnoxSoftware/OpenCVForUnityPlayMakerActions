...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class EdgeDrawing_Params_get_LineFitErrorThreshold_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (float)wrapped_owner.get_LineFitErrorThreshold();
