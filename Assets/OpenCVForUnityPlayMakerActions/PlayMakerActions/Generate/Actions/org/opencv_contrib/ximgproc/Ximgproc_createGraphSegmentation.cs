...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_createGraphSegmentation : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.GraphSegmentation)storeResult.Value).wrappedObject = OpenCVForUnity.Ximgproc.createGraphSegmentation (wrapped_sigma, k.Value, min_size.Value);
