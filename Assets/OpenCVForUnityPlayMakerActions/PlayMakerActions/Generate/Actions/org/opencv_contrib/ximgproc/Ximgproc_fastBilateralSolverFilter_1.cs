...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_fastBilateralSolverFilter_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.fastBilateralSolverFilter(wrapped_guide, wrapped_src, wrapped_confidence, wrapped_dst, wrapped_sigma_spatial, wrapped_sigma_luma, wrapped_sigma_chroma, wrapped_lambda, num_iter.Value);
