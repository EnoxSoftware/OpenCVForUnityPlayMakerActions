...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ximgproc_edgePreservingFilter : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.XimgprocModule.Ximgproc.edgePreservingFilter(wrapped_src, wrapped_dst, d.Value, wrapped_threshold);
