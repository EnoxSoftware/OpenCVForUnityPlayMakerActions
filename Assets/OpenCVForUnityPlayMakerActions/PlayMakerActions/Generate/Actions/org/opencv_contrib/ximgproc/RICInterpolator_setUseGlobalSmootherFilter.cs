...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setUseGlobalSmootherFilter(bool use_FGS)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.RICInterpolator), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "use_FGS")]
    public class RICInterpolator_setUseGlobalSmootherFilter : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool use_FGS;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setUseGlobalSmootherFilter(use_FGS.Value);
