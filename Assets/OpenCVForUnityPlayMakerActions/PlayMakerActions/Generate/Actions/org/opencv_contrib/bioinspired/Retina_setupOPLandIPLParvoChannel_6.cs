...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setupOPLandIPLParvoChannel(bool colorMode, bool normaliseOutput, float photoreceptorsLocalAdaptationSensitivity)")]
    ...
    public class Retina_setupOPLandIPLParvoChannel_6 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setupOPLandIPLParvoChannel(colorMode.Value, normaliseOutput.Value, photoreceptorsLocalAdaptationSensitivity.Value);
