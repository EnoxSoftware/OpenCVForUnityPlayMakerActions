...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Bioinspired_createRetina_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Retina)storeResult.Value).wrappedObject = OpenCVForUnity.Bioinspired.createRetina (wrapped_inputSize, colorMode.Value);
