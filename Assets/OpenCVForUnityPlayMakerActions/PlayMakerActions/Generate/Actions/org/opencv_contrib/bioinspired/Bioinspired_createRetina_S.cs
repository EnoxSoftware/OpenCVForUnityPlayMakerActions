...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static Retina createRetina (Size inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling, float reductionFactor, float samplingStrenght)")]
    ...
    public class Bioinspired_createRetina_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Retina)storeResult.Value).wrappedObject = OpenCVForUnity.Bioinspired.createRetina (new OpenCVForUnity.Size ((double)inputSize_width.Value, (double)inputSize_height.Value), colorMode.Value, colorSamplingMethod.Value, useRetinaLogSampling.Value, reductionFactor.Value, samplingStrenght.Value);
