...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setupIPLMagnoChannel(bool normaliseOutput, float parasolCells_beta, float parasolCells_tau, float parasolCells_k, float amacrinCellsTemporalCutFrequency)")]
    ...
    public class Retina_setupIPLMagnoChannel_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setupIPLMagnoChannel(normaliseOutput.Value, parasolCells_beta.Value, parasolCells_tau.Value, parasolCells_k.Value, amacrinCellsTemporalCutFrequency.Value);
