...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Bioinspired_createTransientAreasSegmentationModule_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.TransientAreasSegmentationModule)storeResult.Value).wrappedObject = OpenCVForUnity.Bioinspired.createTransientAreasSegmentationModule (new OpenCVForUnity.Size ((double)inputSize_width.Value, (double)inputSize_height.Value));
