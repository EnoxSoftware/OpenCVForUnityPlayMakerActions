...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Retina_create_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Retina)storeResult.Value).wrappedObject = OpenCVForUnity.Retina.create (wrapped_inputSize, colorMode.Value, colorSamplingMethod.Value, useRetinaLogSampling.Value);
