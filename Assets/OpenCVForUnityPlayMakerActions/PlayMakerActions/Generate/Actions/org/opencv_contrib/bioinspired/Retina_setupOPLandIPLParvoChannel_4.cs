...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setupOPLandIPLParvoChannel(bool colorMode, bool normaliseOutput, float photoreceptorsLocalAdaptationSensitivity, float photoreceptorsTemporalConstant, float photoreceptorsSpatialConstant)")]
    ...
    public class Retina_setupOPLandIPLParvoChannel_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setupOPLandIPLParvoChannel(colorMode.Value, normaliseOutput.Value, photoreceptorsLocalAdaptationSensitivity.Value, photoreceptorsTemporalConstant.Value, photoreceptorsSpatialConstant.Value);
