...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setupOPLandIPLParvoChannel(bool colorMode)")]
    ...
    public class Retina_setupOPLandIPLParvoChannel_8 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setupOPLandIPLParvoChannel(colorMode.Value);
