...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "ganglionCellsSensitivity")]
    public class Retina_setupOPLandIPLParvoChannel : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.ObjectType(typeof(HutongGames.PlayMaker.FsmFloat))]
        public HutongGames.PlayMaker.FsmFloat ganglionCellsSensitivity;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setupOPLandIPLParvoChannel(colorMode.Value, normaliseOutput.Value, photoreceptorsLocalAdaptationSensitivity.Value, photoreceptorsTemporalConstant.Value, photoreceptorsSpatialConstant.Value, horizontalCellsGain.Value, HcellsTemporalConstant.Value, HcellsSpatialConstant.Value, ganglionCellsSensitivity.Value);
