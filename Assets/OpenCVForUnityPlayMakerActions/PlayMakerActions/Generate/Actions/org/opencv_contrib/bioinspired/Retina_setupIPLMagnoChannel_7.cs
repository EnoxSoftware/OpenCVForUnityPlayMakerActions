...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setupIPLMagnoChannel(bool normaliseOutput)")]
    ...
    public class Retina_setupIPLMagnoChannel_7 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setupIPLMagnoChannel(normaliseOutput.Value);
