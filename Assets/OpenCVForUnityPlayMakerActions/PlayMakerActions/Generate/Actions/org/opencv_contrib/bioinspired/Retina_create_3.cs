...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Retina_create_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Retina)storeResult.Value).wrappedObject = OpenCVForUnity.Retina.create (wrapped_inputSize, colorMode.Value, colorSamplingMethod.Value);
