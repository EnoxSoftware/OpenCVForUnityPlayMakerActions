...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Retina_create_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Retina)storeResult.Value).wrappedObject = OpenCVForUnity.BioinspiredModule.Retina.create(wrapped_inputSize, colorMode.Value, colorSamplingMethod.Value);
