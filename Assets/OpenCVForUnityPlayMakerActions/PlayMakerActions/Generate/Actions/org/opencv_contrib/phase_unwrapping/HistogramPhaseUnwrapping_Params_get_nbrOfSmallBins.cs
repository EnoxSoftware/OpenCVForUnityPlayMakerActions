...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public int get_nbrOfSmallBins()")]
    ...
    public class HistogramPhaseUnwrapping_Params_get_nbrOfSmallBins : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.get_nbrOfSmallBins();
