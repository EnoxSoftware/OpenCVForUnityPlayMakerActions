...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Text_erGrouping : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.TextModule.Text.erGrouping(wrapped_image, wrapped_channel, wrapped_regions, wrapped_groups_rects, method.Value, filename.Value, minProbablity.Value);
