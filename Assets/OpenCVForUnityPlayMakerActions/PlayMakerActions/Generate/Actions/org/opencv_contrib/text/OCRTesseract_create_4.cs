...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static OCRTesseract create(string datapath)")]
    ...
    public class OCRTesseract_create_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.OCRTesseract)storeResult.Value).wrappedObject = OpenCVForUnity.TextModule.OCRTesseract.create(datapath.Value);
