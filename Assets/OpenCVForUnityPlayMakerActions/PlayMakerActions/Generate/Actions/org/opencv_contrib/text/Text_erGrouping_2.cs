...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void erGrouping(Mat image, Mat channel, List<MatOfPoint> regions, MatOfRect groups_rects, int method)")]
    ...
    public class Text_erGrouping_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.TextModule.Text.erGrouping(wrapped_image, wrapped_channel, wrapped_regions, wrapped_groups_rects, method.Value);
