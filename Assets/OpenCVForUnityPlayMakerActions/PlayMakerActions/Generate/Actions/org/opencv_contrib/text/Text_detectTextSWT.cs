...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void detectTextSWT(Mat input, MatOfRect result, bool dark_on_light, Mat draw, Mat chainBBs)")]
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.Mat), "chainBBs")]
    public class Text_detectTextSWT : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.UIHint(HutongGames.PlayMaker.UIHint.Variable)]
        [HutongGames.PlayMaker.ObjectType(typeof(OpenCVForUnityPlayMakerActions.Mat))]
        public HutongGames.PlayMaker.FsmObject chainBBs;
        ...
        void DoProcess()
        {
            ...
            if (!(chainBBs.Value is OpenCVForUnityPlayMakerActions.Mat))
            {
                LogError("chainBBs is not initialized. Add Action \"newMat\".");
                return;
            }
            OpenCVForUnity.CoreModule.Mat wrapped_chainBBs = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.CoreModule.Mat>(chainBBs);

            OpenCVForUnity.TextModule.Text.detectTextSWT(wrapped_input, wrapped_result, dark_on_light.Value, wrapped_draw, wrapped_chainBBs);
