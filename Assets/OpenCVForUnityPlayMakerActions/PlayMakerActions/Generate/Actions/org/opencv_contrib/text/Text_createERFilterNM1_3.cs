...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Text_createERFilterNM1_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ERFilter)storeResult.Value).wrappedObject = OpenCVForUnity.Text.createERFilterNM1 (filename.Value, thresholdDelta.Value, minArea.Value, maxArea.Value);
