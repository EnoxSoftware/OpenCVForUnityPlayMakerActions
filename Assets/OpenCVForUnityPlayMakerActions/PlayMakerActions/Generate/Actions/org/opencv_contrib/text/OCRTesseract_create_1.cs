...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static OCRTesseract create(string datapath, string language, string char_whitelist, int oem)")]
    ...
    public class OCRTesseract_create_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.OCRTesseract)storeResult.Value).wrappedObject = OpenCVForUnity.TextModule.OCRTesseract.create(datapath.Value, language.Value, char_whitelist.Value, oem.Value);
