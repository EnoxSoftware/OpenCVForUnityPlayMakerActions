...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class BaseOCR_getNativeObjAddr : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.BaseOCR wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.BaseOCR, OpenCVForUnity.BaseOCR> (owner);
