...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Callback_getNativeObjAddr : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.TextModule.Callback wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Callback, OpenCVForUnity.TextModule.Callback> (owner);
