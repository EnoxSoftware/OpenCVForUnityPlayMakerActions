...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class ClassifierCallback_getNativeObjAddr : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.TextModule.ClassifierCallback wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.ClassifierCallback, OpenCVForUnity.TextModule.ClassifierCallback> (owner);
