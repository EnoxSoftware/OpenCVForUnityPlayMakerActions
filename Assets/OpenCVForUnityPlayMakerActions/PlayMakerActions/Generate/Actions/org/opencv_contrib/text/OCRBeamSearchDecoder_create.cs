...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class OCRBeamSearchDecoder_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.OCRBeamSearchDecoder)storeResult.Value).wrappedObject = OpenCVForUnity.OCRBeamSearchDecoder.create (filename.Value, vocabulary.Value, wrapped_transition_probabilities_table, wrapped_emission_probabilities_table, mode.Value, beam_size.Value);
