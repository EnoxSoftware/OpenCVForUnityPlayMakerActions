...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static OCRBeamSearchDecoder create(string filename, string vocabulary, Mat transition_probabilities_table, Mat emission_probabilities_table, int mode, int beam_size)")]
    ...
    public class OCRBeamSearchDecoder_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.OCRBeamSearchDecoder)storeResult.Value).wrappedObject = OpenCVForUnity.TextModule.OCRBeamSearchDecoder.create(filename.Value, vocabulary.Value, wrapped_transition_probabilities_table, wrapped_emission_probabilities_table, mode.Value, beam_size.Value);
