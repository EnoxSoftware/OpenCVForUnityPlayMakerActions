...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static ERFilter_Callback loadClassifierNM1(string filename)")]
    ...
    public class Text_loadClassifierNM1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ERFilter_Callback)storeResult.Value).wrappedObject = OpenCVForUnity.TextModule.Text.loadClassifierNM1(filename.Value);
