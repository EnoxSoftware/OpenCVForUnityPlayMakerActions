...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Text_createERFilterNM1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.ERFilter)storeResult.Value).wrappedObject = OpenCVForUnity.Text.createERFilterNM1 (filename.Value, thresholdDelta.Value, minArea.Value, maxArea.Value, minProbability.Value, nonMaxSuppression.Value, minProbabilityDiff.Value);
