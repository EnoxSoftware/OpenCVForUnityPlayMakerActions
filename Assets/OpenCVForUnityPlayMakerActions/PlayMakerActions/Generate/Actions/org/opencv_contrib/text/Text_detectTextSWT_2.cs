...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void detectTextSWT(Mat input, MatOfRect result, bool dark_on_light)")]
    ...
    public class Text_detectTextSWT_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.TextModule.Text.detectTextSWT(wrapped_input, wrapped_result, dark_on_light.Value);
