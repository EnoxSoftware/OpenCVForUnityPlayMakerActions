...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static OCRHMMDecoder create(OCRHMMDecoder_ClassifierCallback classifier, string vocabulary, Mat transition_probabilities_table, Mat emission_probabilities_table)")]
    ...
    public class OCRHMMDecoder_create_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.OCRHMMDecoder)storeResult.Value).wrappedObject = OpenCVForUnity.TextModule.OCRHMMDecoder.create(wrapped_classifier, vocabulary.Value, wrapped_transition_probabilities_table, wrapped_emission_probabilities_table);
