...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_use_segmentation(bool use_segmentation)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "use_segmentation")]
    public class TrackerCSRT_Params_set_use_segmentation : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool use_segmentation;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_use_segmentation(use_segmentation.Value);
