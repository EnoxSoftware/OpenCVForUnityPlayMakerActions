...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public  bool add (Mat image, MatOfRect2d boundingBox)")]
    ...
    public class MultiTracker_add_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.ActionSection ("[arg2] MatOfRect2d")]
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.UIHint (HutongGames.PlayMaker.UIHint.Variable)]
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = wrapped_owner.add (wrapped_image, wrapped_boundingBox);
