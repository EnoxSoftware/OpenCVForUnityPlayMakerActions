...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class MultiTracker_add_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = wrapped_owner.add (trackerType.Value, wrapped_image, wrapped_boundingBox);
