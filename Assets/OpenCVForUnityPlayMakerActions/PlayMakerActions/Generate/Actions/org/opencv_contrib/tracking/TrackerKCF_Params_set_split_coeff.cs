...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_split_coeff(bool split_coeff)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerKCF_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "split_coeff")]
    public class TrackerKCF_Params_set_split_coeff : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool split_coeff;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_split_coeff(split_coeff.Value);
