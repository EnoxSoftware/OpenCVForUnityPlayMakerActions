...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_hog_orientations(float hog_orientations)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "hog_orientations")]
    public class TrackerCSRT_Params_set_hog_orientations : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat hog_orientations;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_hog_orientations(hog_orientations.Value);
