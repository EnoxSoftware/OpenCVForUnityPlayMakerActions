...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_hog_clip(float hog_clip)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "hog_clip")]
    public class TrackerCSRT_Params_set_hog_clip : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat hog_clip;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_hog_clip(hog_clip.Value);
