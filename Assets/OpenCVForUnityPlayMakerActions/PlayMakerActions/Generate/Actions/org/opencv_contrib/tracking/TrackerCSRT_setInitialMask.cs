...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.Mat), "mask")]
    public class TrackerCSRT_setInitialMask : HutongGames.PlayMaker.FsmStateAction
    {

        [HutongGames.PlayMaker.ActionSection("[class] TrackerCSRT")]
        ...
        void DoProcess()
        {
            ...
            if (!(owner.Value is OpenCVForUnityPlayMakerActions.TrackerCSRT))
            {
                LogError("owner is not initialized. Add Action \"newTrackerCSRT\".");
                return;
            }
            OpenCVForUnity.TrackingModule.TrackerCSRT wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.TrackerCSRT, OpenCVForUnity.TrackingModule.TrackerCSRT>(owner);
