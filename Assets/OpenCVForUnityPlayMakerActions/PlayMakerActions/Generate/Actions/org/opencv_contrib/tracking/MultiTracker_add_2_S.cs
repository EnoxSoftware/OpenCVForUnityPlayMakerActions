...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public  bool add (string trackerType, Mat image, Rect2d boundingBox)")]
    ...
    public class MultiTracker_add_2_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = wrapped_owner.add (trackerType.Value, wrapped_image, new OpenCVForUnity.Rect2d ((double)boundingBox_x.Value, (double)boundingBox_y.Value, (double)boundingBox_width.Value, (double)boundingBox_height.Value));
