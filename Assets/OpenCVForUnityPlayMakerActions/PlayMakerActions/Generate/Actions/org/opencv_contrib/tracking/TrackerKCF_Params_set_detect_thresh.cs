...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_detect_thresh(float detect_thresh)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerKCF_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "detect_thresh")]
    public class TrackerKCF_Params_set_detect_thresh : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat detect_thresh;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_detect_thresh(detect_thresh.Value);
