...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_weights_lr(float weights_lr)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "weights_lr")]
    public class TrackerCSRT_Params_set_weights_lr : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat weights_lr;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_weights_lr(weights_lr.Value);
