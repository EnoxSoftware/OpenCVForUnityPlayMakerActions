...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_kaiser_alpha(float kaiser_alpha)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "kaiser_alpha")]
    public class TrackerCSRT_Params_set_kaiser_alpha : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat kaiser_alpha;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_kaiser_alpha(kaiser_alpha.Value);
