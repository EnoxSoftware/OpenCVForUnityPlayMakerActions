...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_use_rgb(bool use_rgb)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "use_rgb")]
    public class TrackerCSRT_Params_set_use_rgb : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool use_rgb;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_use_rgb(use_rgb.Value);
