...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_histogram_lr(float histogram_lr)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "histogram_lr")]
    public class TrackerCSRT_Params_set_histogram_lr : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat histogram_lr;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_histogram_lr(histogram_lr.Value);
