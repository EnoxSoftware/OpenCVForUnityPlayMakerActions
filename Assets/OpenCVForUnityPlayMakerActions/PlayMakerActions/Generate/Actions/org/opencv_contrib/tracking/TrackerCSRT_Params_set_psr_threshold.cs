...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_psr_threshold(float psr_threshold)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "psr_threshold")]
    public class TrackerCSRT_Params_set_psr_threshold : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat psr_threshold;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_psr_threshold(psr_threshold.Value);
