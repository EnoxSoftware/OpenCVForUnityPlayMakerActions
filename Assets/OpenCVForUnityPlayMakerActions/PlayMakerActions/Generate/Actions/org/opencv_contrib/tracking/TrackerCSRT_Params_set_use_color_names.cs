...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_use_color_names(bool use_color_names)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "use_color_names")]
    public class TrackerCSRT_Params_set_use_color_names : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool use_color_names;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_use_color_names(use_color_names.Value);
