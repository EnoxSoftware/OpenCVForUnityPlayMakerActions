...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Tracker_update_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Tracker wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Tracker, OpenCVForUnity.Tracker> (owner);
            ...
            storeResult.Value = wrapped_owner.update (wrapped_image, new OpenCVForUnity.Rect2d ((double)boundingBox_x.Value, (double)boundingBox_y.Value, (double)boundingBox_width.Value, (double)boundingBox_height.Value));
