...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public bool update (Mat image, Rect2d boundingBox)")]
    ...
    public class Tracker_update_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.TrackingModule.Tracker wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Tracker, OpenCVForUnity.TrackingModule.Tracker> (owner);
            ...
            storeResult.Value = wrapped_owner.update (wrapped_image, new OpenCVForUnity.CoreModule.Rect2d ((double)boundingBox_x.Value, (double)boundingBox_y.Value, (double)boundingBox_width.Value, (double)boundingBox_height.Value));
