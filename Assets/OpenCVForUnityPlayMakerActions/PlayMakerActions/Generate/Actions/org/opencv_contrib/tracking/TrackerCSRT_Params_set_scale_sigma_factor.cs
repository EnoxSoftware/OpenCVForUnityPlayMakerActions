...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_scale_sigma_factor(float scale_sigma_factor)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "scale_sigma_factor")]
    public class TrackerCSRT_Params_set_scale_sigma_factor : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat scale_sigma_factor;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_scale_sigma_factor(scale_sigma_factor.Value);
