...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool update(Mat image, MatOfRect2d boundingBox)")]
    ...
    public class legacy_MultiTracker_update : HutongGames.PlayMaker.FsmStateAction
    {
