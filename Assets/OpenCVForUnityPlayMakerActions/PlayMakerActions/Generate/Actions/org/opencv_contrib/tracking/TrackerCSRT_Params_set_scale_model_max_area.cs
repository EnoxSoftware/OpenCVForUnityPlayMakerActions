...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_scale_model_max_area(float scale_model_max_area)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "scale_model_max_area")]
    public class TrackerCSRT_Params_set_scale_model_max_area : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat scale_model_max_area;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_scale_model_max_area(scale_model_max_area.Value);
