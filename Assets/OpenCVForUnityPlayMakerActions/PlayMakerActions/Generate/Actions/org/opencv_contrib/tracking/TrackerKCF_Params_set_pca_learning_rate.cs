...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_pca_learning_rate(float pca_learning_rate)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerKCF_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "pca_learning_rate")]
    public class TrackerKCF_Params_set_pca_learning_rate : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat pca_learning_rate;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_pca_learning_rate(pca_learning_rate.Value);
