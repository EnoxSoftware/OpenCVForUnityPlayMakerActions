...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_desc_npca(int desc_npca)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerKCF_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "desc_npca")]
    public class TrackerKCF_Params_set_desc_npca : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt desc_npca;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_desc_npca(desc_npca.Value);
