...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_compress_feature(bool compress_feature)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerKCF_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "compress_feature")]
    public class TrackerKCF_Params_set_compress_feature : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool compress_feature;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_compress_feature(compress_feature.Value);
