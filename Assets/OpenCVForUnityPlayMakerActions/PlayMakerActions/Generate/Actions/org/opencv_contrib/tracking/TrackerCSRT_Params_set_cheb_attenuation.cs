...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_cheb_attenuation(float cheb_attenuation)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "cheb_attenuation")]
    public class TrackerCSRT_Params_set_cheb_attenuation : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat cheb_attenuation;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_cheb_attenuation(cheb_attenuation.Value);
