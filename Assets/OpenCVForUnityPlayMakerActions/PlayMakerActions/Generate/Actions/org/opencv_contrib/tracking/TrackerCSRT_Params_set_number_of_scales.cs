...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_number_of_scales(int number_of_scales)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerCSRT_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "number_of_scales")]
    public class TrackerCSRT_Params_set_number_of_scales : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt number_of_scales;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_number_of_scales(number_of_scales.Value);
