...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void selectROI (string windowName, Mat img, MatOfRect2d boundingBox)")]
    ...
    public class Tracking_selectROI_5 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Tracking.selectROI (windowName.Value, wrapped_img, wrapped_boundingBox);
