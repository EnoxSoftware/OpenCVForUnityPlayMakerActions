...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_output_sigma_factor(float output_sigma_factor)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.TrackerKCF_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "output_sigma_factor")]
    public class TrackerKCF_Params_set_output_sigma_factor : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat output_sigma_factor;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_output_sigma_factor(output_sigma_factor.Value);
