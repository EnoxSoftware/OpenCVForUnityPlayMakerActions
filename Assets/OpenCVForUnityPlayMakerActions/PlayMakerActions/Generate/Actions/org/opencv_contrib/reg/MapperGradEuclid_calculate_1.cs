...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class MapperGradEuclid_calculate_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.RegModule.MapperGradEuclid wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.MapperGradEuclid, OpenCVForUnity.RegModule.MapperGradEuclid> (owner);
