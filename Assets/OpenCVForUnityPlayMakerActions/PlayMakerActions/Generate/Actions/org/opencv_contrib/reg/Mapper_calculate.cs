...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public virtual Map calculate (Mat img1, Mat img2, Map init)")]
    ...
    public class Mapper_calculate : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.RegModule.Mapper wrapped_owner = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mapper, OpenCVForUnity.RegModule.Mapper> (owner);
