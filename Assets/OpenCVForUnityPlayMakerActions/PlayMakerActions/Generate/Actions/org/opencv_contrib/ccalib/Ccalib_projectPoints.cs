...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ccalib_projectPoints : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Ccalib.projectPoints (wrapped_objectPoints, wrapped_imagePoints, wrapped_rvec, wrapped_tvec, wrapped_K, wrapped_xi, wrapped_D, wrapped_jacobian);
