...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ccalib_initUndistortRectifyMap : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Ccalib.initUndistortRectifyMap (wrapped_K, wrapped_D, wrapped_xi, wrapped_R, wrapped_P, wrapped_size, mltype.Value, wrapped_map1, wrapped_map2, flags.Value);
