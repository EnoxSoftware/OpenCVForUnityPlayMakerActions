...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ccalib_undistortImage_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Ccalib.undistortImage (wrapped_distorted, wrapped_undistorted, wrapped_K, wrapped_D, wrapped_xi, flags.Value, wrapped_Knew, new OpenCVForUnity.Size ((double)new_size_width.Value, (double)new_size_height.Value));
