...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ccalib_undistortImage : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Ccalib.undistortImage (wrapped_distorted, wrapped_undistorted, wrapped_K, wrapped_D, wrapped_xi, flags.Value, wrapped_Knew, wrapped_new_size, wrapped_R);
