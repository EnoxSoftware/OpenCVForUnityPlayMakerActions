...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ccalib_stereoCalibrate_1_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.Ccalib.stereoCalibrate (wrapped_objectPoints, wrapped_imagePoints1, wrapped_imagePoints2, new OpenCVForUnity.Size ((double)imageSize1_width.Value, (double)imageSize1_height.Value), new OpenCVForUnity.Size ((double)imageSize2_width.Value, (double)imageSize2_height.Value), wrapped_K1, wrapped_xi1, wrapped_D1, wrapped_K2, wrapped_xi2, wrapped_D2, wrapped_rvec, wrapped_tvec, wrapped_rvecsL, wrapped_tvecsL, flags.Value, new OpenCVForUnity.TermCriteria ((int)criteria_type.Value, (int)criteria_maxCount.Value, (double)criteria_epsilon.Value));
