...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static double calibrate (List<Mat> objectPoints, List<Mat> imagePoints, Size size, Mat K, Mat xi, Mat D, List<Mat> rvecs, List<Mat> tvecs, int flags, TermCriteria criteria)")]
    ...
    public class Ccalib_calibrate_1_CS : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.Ccalib.calibrate (wrapped_objectPoints, wrapped_imagePoints, new OpenCVForUnity.Size ((double)size_width.Value, (double)size_height.Value), wrapped_K, wrapped_xi, wrapped_D, wrapped_rvecs, wrapped_tvecs, flags.Value, new OpenCVForUnity.TermCriteria ((int)criteria_type.Value, (int)criteria_maxCount.Value, (double)criteria_epsilon.Value));
