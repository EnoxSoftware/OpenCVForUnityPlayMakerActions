...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ccalib_projectPoints_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.CcalibModule.Ccalib.projectPoints (wrapped_objectPoints, wrapped_imagePoints, wrapped_rvec, wrapped_tvec, wrapped_K, (float)xi.Value, wrapped_D);
