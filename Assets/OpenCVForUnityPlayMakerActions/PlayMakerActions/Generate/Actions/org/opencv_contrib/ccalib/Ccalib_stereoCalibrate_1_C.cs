...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static double stereoCalibrate (List<Mat> objectPoints, List<Mat> imagePoints1, List<Mat> imagePoints2, Size imageSize1, Size imageSize2, Mat K1, Mat xi1, Mat D1, Mat K2, Mat xi2, Mat D2, Mat rvec, Mat tvec, List<Mat> rvecsL, List<Mat> tvecsL, int flags, TermCriteria criteria)")]
    ...
    public class Ccalib_stereoCalibrate_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.CoreModule.Size wrapped_imageSize1 = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Size, OpenCVForUnity.CoreModule.Size> (imageSize1);
            ...
            OpenCVForUnity.CoreModule.Size wrapped_imageSize2 = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Size, OpenCVForUnity.CoreModule.Size> (imageSize2);
            ...
            storeResult.Value = (float)OpenCVForUnity.CcalibModule.Ccalib.stereoCalibrate (wrapped_objectPoints, wrapped_imagePoints1, wrapped_imagePoints2, wrapped_imageSize1, wrapped_imageSize2, wrapped_K1, wrapped_xi1, wrapped_D1, wrapped_K2, wrapped_xi2, wrapped_D2, wrapped_rvec, wrapped_tvec, wrapped_rvecsL, wrapped_tvecsL, flags.Value, wrapped_criteria);
