...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ccalib_calibrate_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = (float)OpenCVForUnity.Ccalib.calibrate (wrapped_objectPoints, wrapped_imagePoints, wrapped_size, wrapped_K, wrapped_xi, wrapped_D, wrapped_rvecs, wrapped_tvecs, flags.Value, wrapped_criteria, wrapped_idx);
