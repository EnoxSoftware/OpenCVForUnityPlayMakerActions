...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void stereoReconstruct (Mat image1, Mat image2, Mat K1, Mat D1, Mat xi1, Mat K2, Mat D2, Mat xi2, Mat R, Mat T, int flag, int numDisparities, int SADWindowSize, Mat disparity, Mat image1Rec, Mat image2Rec, Size newSize, Mat Knew, Mat pointCloud, int pointType)")]
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmFloat), "newSize_width")]
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmFloat), "newSize_height")]
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmInt), "pointType")]
    public class Ccalib_stereoReconstruct_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat newSize_width;

        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.ObjectType (typeof (HutongGames.PlayMaker.FsmFloat))]
        public HutongGames.PlayMaker.FsmFloat newSize_height;
        ...
        [HutongGames.PlayMaker.ActionSection ("[arg20] int")]
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.ObjectType (typeof (HutongGames.PlayMaker.FsmInt))]
        public HutongGames.PlayMaker.FsmInt pointType;
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.CoreModule.Mat wrapped_image1 = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.CoreModule.Mat> (image1);
            ...
            OpenCVForUnity.CoreModule.Mat wrapped_image2 = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.CoreModule.Mat> (image2);
            ...
            OpenCVForUnity.CoreModule.Mat wrapped_image1Rec = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.CoreModule.Mat> (image1Rec);
            ...
            OpenCVForUnity.CoreModule.Mat wrapped_image2Rec = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.CoreModule.Mat> (image2Rec);
            ...
            OpenCVForUnity.CoreModule.Mat wrapped_pointCloud = OpenCVForUnityPlayMakerActionsUtils.GetWrappedObject<OpenCVForUnityPlayMakerActions.Mat, OpenCVForUnity.CoreModule.Mat> (pointCloud);

            OpenCVForUnity.CcalibModule.Ccalib.stereoReconstruct (wrapped_image1, wrapped_image2, wrapped_K1, wrapped_D1, wrapped_xi1, wrapped_K2, wrapped_D2, wrapped_xi2, wrapped_R, wrapped_T, flag.Value, numDisparities.Value, SADWindowSize.Value, wrapped_disparity, wrapped_image1Rec, wrapped_image2Rec, new OpenCVForUnity.CoreModule.Size ((double)newSize_width.Value, (double)newSize_height.Value), wrapped_Knew, wrapped_pointCloud, pointType.Value);
