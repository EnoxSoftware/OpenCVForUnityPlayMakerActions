...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Ccalib_stereoReconstruct_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Ccalib.stereoReconstruct (wrapped_image1, wrapped_image2, wrapped_K1, wrapped_D1, wrapped_xi1, wrapped_K2, wrapped_D2, wrapped_xi2, wrapped_R, wrapped_T, flag.Value, numDisparities.Value, SADWindowSize.Value, wrapped_disparity, wrapped_image1Rec, wrapped_image2Rec, new OpenCVForUnity.Size ((double)newSize_width.Value, (double)newSize_height.Value), wrapped_Knew, wrapped_pointCloud, pointType.Value);
