...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setGradientDescentIterations (int val)")]
    ...
    public class DISOpticalFlow_setGradientDescentIterations : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setGradientDescentIterations (val.Value);
