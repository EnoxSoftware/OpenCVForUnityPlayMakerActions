...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setInnerIterations (int val)")]
    ...
    public class DualTVL1OpticalFlow_setInnerIterations : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setInnerIterations (val.Value);
