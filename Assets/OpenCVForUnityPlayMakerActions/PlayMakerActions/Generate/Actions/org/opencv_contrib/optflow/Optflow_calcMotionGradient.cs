...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Optflow_calcMotionGradient : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.OptflowModule.Optflow.calcMotionGradient (wrapped_mhi, wrapped_mask, wrapped_orientation, wrapped_delta1, wrapped_delta2, apertureSize.Value);
