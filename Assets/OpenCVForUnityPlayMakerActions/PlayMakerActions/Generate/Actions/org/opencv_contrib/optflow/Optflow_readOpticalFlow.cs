...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Optflow_readOpticalFlow : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = OpenCVForUnity.Optflow.readOpticalFlow (path.Value);
