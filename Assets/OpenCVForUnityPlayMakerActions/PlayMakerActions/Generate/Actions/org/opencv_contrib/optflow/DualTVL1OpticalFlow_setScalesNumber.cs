...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setScalesNumber (int val)")]
    ...
    public class DualTVL1OpticalFlow_setScalesNumber : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setScalesNumber (val.Value);
