...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static DenseOpticalFlow createOptFlow_SparseToDense ()")]
    [HutongGames.PlayMaker.ActionTarget (typeof (OpenCVForUnityPlayMakerActions.DenseOpticalFlow), "storeResult")]
    public class Optflow_createOptFlow_SparseToDense : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.DenseOpticalFlow)storeResult.Value).wrappedObject = OpenCVForUnity.OptflowModule.Optflow.createOptFlow_SparseToDense ();
