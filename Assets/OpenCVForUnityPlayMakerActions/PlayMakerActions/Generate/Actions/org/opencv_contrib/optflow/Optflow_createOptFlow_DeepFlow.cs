...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static DenseOpticalFlow createOptFlow_DeepFlow ()")]
    [HutongGames.PlayMaker.ActionTarget (typeof (OpenCVForUnityPlayMakerActions.DenseOpticalFlow), "storeResult")]
    public class Optflow_createOptFlow_DeepFlow : HutongGames.PlayMaker.FsmStateAction
    {
