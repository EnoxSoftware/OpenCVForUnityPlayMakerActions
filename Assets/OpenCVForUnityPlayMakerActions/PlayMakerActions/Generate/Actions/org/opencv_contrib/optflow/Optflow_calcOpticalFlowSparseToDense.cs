...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void calcOpticalFlowSparseToDense (Mat from, Mat to, Mat flow, int grid_step, int k, float sigma, bool use_post_proc, float fgs_lambda, float fgs_sigma)")]
    ...
    [HutongGames.PlayMaker.ActionTarget (typeof (HutongGames.PlayMaker.FsmFloat), "fgs_sigma")]
    public class Optflow_calcOpticalFlowSparseToDense : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.RequiredField]
        [HutongGames.PlayMaker.ObjectType (typeof (HutongGames.PlayMaker.FsmFloat))]
        public HutongGames.PlayMaker.FsmFloat fgs_sigma;
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.OptflowModule.Optflow.calcOpticalFlowSparseToDense (wrapped_from, wrapped_to, wrapped_flow, grid_step.Value, k.Value, sigma.Value, use_post_proc.Value, fgs_lambda.Value, fgs_sigma.Value);
