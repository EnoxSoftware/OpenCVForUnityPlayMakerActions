...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Optflow_calcOpticalFlowSparseToDense : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Optflow.calcOpticalFlowSparseToDense (wrapped_from, wrapped_to, wrapped_flow, grid_step.Value, k.Value, sigma.Value, use_post_proc.Value, fgs_lambda.Value, fgs_sigma.Value);
