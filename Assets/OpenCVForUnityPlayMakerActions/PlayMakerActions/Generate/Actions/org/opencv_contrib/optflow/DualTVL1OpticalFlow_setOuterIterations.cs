...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setOuterIterations (int val)")]
    ...
    public class DualTVL1OpticalFlow_setOuterIterations : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setOuterIterations (val.Value);
