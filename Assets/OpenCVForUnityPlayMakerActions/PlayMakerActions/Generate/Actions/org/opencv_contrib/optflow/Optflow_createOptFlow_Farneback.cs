...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static DenseOpticalFlow createOptFlow_Farneback ()")]
    [HutongGames.PlayMaker.ActionTarget (typeof (OpenCVForUnityPlayMakerActions.DenseOpticalFlow), "storeResult")]
    public class Optflow_createOptFlow_Farneback : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.DenseOpticalFlow)storeResult.Value).wrappedObject = OpenCVForUnity.OptflowModule.Optflow.createOptFlow_Farneback ();
