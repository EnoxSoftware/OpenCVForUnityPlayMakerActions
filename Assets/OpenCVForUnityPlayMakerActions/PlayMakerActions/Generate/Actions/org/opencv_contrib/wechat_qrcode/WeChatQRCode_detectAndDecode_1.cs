...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public List<string> detectAndDecode(Mat img)")]
    ...
    public class WeChatQRCode_detectAndDecode_1 : HutongGames.PlayMaker.FsmStateAction
    {
