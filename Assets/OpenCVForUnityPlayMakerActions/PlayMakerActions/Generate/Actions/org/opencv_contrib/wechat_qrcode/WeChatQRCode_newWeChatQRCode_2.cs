...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public WeChatQRCode(string detector_prototxt_path, string detector_caffe_model_path)")]
    ...
    public class WeChatQRCode_newWeChatQRCode_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.WeChatQRCode)storeResult.Value).wrappedObject = new OpenCVForUnity.Wechat_qrcodeModule.WeChatQRCode(detector_prototxt_path.Value, detector_caffe_model_path.Value);
