...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void FT12D_components (Mat matrix, Mat kernel, Mat components)")]
    ...
    public class Fuzzy_FT12D_components : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.FuzzyModule.Fuzzy.FT12D_components (wrapped_matrix, wrapped_kernel, wrapped_components);
