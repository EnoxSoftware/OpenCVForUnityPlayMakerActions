...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void FT02D_FL_process (Mat matrix, int radius, Mat output)")]
    ...
    public class Fuzzy_FT02D_FL_process : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.FuzzyModule.Fuzzy.FT02D_FL_process (wrapped_matrix, radius.Value, wrapped_output);
