...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Fuzzy_FT02D_components_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.FuzzyModule.Fuzzy.FT02D_components (wrapped_matrix, wrapped_kernel, wrapped_components);
