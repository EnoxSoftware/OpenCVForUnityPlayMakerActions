...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void FT02D_inverseFT (Mat components, Mat kernel, Mat output, int width, int height)")]
    ...
    public class Fuzzy_FT02D_inverseFT : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.FuzzyModule.Fuzzy.FT02D_inverseFT (wrapped_components, wrapped_kernel, wrapped_output, width.Value, height.Value);
