...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void FT12D_process (Mat matrix, Mat kernel, Mat output)")]
    ...
    public class Fuzzy_FT12D_process_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.FuzzyModule.Fuzzy.FT12D_process (wrapped_matrix, wrapped_kernel, wrapped_output);
