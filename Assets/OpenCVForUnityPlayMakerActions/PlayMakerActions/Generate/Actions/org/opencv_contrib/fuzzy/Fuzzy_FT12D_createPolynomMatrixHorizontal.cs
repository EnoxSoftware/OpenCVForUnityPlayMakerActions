...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void FT12D_createPolynomMatrixHorizontal (int radius, Mat matrix, int chn)")]
    ...
    public class Fuzzy_FT12D_createPolynomMatrixHorizontal : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.FuzzyModule.Fuzzy.FT12D_createPolynomMatrixHorizontal (radius.Value, wrapped_matrix, chn.Value);
