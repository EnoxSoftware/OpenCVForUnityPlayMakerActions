...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void inpaint (Mat image, Mat mask, Mat output, int radius, int function, int algorithm)")]
    ...
    public class Fuzzy_inpaint : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Fuzzy.inpaint (wrapped_image, wrapped_mask, wrapped_output, radius.Value, function.Value, algorithm.Value);
