...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void radialVarianceHash(Mat inputArr, Mat outputArr)")]
    ...
    public class Img_hash_radialVarianceHash_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Img_hashModule.Img_hash.radialVarianceHash(wrapped_inputArr, wrapped_outputArr);
