...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void colorMomentHash (Mat inputArr, Mat outputArr)")]
    ...
    public class Img_hash_colorMomentHash : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            OpenCVForUnity.Img_hashModule.Img_hash.colorMomentHash (wrapped_inputArr, wrapped_outputArr);
