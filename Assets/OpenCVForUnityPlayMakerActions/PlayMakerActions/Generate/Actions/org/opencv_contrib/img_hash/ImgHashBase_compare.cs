...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class ImgHashBase_compare : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = wrapped_owner.compare(wrapped_hashOne, wrapped_hashTwo);
