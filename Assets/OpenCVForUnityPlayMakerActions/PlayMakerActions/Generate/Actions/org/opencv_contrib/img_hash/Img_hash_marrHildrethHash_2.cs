...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Img_hash_marrHildrethHash_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Img_hashModule.Img_hash.marrHildrethHash(wrapped_inputArr, wrapped_outputArr);
