...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void averageHash(Mat inputArr, Mat outputArr)")]
    ...
    public class Img_hash_averageHash : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.Img_hashModule.Img_hash.averageHash(wrapped_inputArr, wrapped_outputArr);
