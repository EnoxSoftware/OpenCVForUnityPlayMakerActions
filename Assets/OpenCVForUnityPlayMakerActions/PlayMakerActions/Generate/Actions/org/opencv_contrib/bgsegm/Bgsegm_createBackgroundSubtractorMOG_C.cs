...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Bgsegm_createBackgroundSubtractorMOG_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.BackgroundSubtractorMOG)storeResult.Value).wrappedObject = OpenCVForUnity.Bgsegm.createBackgroundSubtractorMOG (history.Value, nmixtures.Value, (float)backgroundRatio.Value, (float)noiseSigma.Value);
