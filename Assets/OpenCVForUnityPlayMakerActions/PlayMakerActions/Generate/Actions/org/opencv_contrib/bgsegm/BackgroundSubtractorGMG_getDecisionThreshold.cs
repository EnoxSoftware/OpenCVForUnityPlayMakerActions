...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class BackgroundSubtractorGMG_getDecisionThreshold : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Double)storeResult.Value).wrappedObject = wrapped_owner.getDecisionThreshold ();
