...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setMinVal (double val)")]
    ...
    public class BackgroundSubtractorGMG_setMinVal_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setMinVal ((float)val.Value);
