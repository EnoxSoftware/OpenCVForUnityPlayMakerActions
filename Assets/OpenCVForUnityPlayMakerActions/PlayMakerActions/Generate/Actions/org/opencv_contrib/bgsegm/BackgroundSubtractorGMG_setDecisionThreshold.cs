...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void setDecisionThreshold(double thresh)")]
    ...
    public class BackgroundSubtractorGMG_setDecisionThreshold : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.setDecisionThreshold(wrapped_thresh);
