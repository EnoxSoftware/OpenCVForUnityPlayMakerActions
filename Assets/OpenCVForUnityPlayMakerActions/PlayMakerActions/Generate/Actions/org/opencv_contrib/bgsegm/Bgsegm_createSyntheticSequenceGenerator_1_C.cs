...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Bgsegm_createSyntheticSequenceGenerator_1_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SyntheticSequenceGenerator)storeResult.Value).wrappedObject = OpenCVForUnity.Bgsegm.createSyntheticSequenceGenerator (wrapped_background, wrapped__object, (float)amplitude.Value, (float)wavelength.Value, (float)wavespeed.Value);
