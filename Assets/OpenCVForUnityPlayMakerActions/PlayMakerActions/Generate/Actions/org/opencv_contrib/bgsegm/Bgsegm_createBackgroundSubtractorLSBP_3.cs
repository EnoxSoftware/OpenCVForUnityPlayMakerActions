...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP (int mc, int nSamples, int LSBPRadius, float Tlower, float Tupper, float Tinc, float Tdec, float Rscale, float Rincdec, float noiseRemovalThresholdFacBG)")]
    ...
    public class Bgsegm_createBackgroundSubtractorLSBP_3 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.BackgroundSubtractorLSBP)storeResult.Value).wrappedObject = OpenCVForUnity.Bgsegm.createBackgroundSubtractorLSBP (mc.Value, nSamples.Value, LSBPRadius.Value, Tlower.Value, Tupper.Value, Tinc.Value, Tdec.Value, Rscale.Value, Rincdec.Value, noiseRemovalThresholdFacBG.Value);
