...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Bgsegm_createSyntheticSequenceGenerator_4 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.SyntheticSequenceGenerator)storeResult.Value).wrappedObject = OpenCVForUnity.BgsegmModule.Bgsegm.createSyntheticSequenceGenerator(wrapped_background, wrapped__object);
