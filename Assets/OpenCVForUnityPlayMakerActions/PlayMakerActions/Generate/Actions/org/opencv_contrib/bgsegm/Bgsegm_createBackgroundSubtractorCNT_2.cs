...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Bgsegm_createBackgroundSubtractorCNT_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.BackgroundSubtractorCNT)storeResult.Value).wrappedObject = OpenCVForUnity.Bgsegm.createBackgroundSubtractorCNT (minPixelStability.Value, useHistory.Value);
