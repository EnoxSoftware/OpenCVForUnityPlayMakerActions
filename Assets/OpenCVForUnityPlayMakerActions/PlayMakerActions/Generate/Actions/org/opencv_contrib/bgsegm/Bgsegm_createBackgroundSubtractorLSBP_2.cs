...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Bgsegm_createBackgroundSubtractorLSBP_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.BackgroundSubtractorLSBP)storeResult.Value).wrappedObject = OpenCVForUnity.Bgsegm.createBackgroundSubtractorLSBP (mc.Value, nSamples.Value, LSBPRadius.Value, Tlower.Value, Tupper.Value, Tinc.Value, Tdec.Value, Rscale.Value, Rincdec.Value, noiseRemovalThresholdFacBG.Value, noiseRemovalThresholdFacFG.Value);
