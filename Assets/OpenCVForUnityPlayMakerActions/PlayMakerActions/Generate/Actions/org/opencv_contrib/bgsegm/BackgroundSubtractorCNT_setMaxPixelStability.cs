...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public void setMaxPixelStability (int value)")]
    ...
    public class BackgroundSubtractorCNT_setMaxPixelStability : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.setMaxPixelStability (value.Value);
