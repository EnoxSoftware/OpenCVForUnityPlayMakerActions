...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class BackgroundSubtractorGMG_getBackgroundPrior_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = (float)wrapped_owner.getBackgroundPrior();
