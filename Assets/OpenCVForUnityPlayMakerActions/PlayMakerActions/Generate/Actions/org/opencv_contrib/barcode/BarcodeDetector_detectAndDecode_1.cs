...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool detectAndDecode(Mat img, List<string> decoded_info, List<int> decoded_type)")]
    ...
    public class BarcodeDetector_detectAndDecode_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.ActionSection("[arg3] List<int>(Array(int))")]
        [HutongGames.PlayMaker.RequiredField]
        ...
        void DoProcess()
        {
            ...
            storeResult.Value = wrapped_owner.detectAndDecode(wrapped_img, wrapped_decoded_info, wrapped_decoded_type);
