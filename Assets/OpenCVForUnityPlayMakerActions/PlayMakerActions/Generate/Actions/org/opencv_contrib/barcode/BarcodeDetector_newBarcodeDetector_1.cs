...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public BarcodeDetector(string prototxt_path)")]
    ...
    public class BarcodeDetector_newBarcodeDetector_1 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.BarcodeDetector)storeResult.Value).wrappedObject = new OpenCVForUnity.BarcodeModule.BarcodeDetector(prototxt_path.Value);
