...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public bool detectAndDecode(Mat img, List<string> decoded_info, List<int> decoded_type, Mat points)")]
    ...
    public class BarcodeDetector_detectAndDecode : HutongGames.PlayMaker.FsmStateAction
    {
