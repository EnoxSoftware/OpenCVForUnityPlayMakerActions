...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Face_drawFacemarks : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            OpenCVForUnity.FaceModule.Face.drawFacemarks(wrapped_image, wrapped_points, wrapped_color);
