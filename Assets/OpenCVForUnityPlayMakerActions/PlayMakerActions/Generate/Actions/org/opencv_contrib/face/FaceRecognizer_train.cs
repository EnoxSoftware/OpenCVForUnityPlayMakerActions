...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void train(List<Mat> src, Mat labels)")]
    ...
    public class FaceRecognizer_train : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.train(wrapped_src, wrapped_labels);
