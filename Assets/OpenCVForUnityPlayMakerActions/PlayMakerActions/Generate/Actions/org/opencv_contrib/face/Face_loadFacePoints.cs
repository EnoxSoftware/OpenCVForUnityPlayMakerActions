...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static bool loadFacePoints (string filename, Mat points, float offset)")]
    ...
    public class Face_loadFacePoints : HutongGames.PlayMaker.FsmStateAction
    {
