...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Face_createEigenFaceRecognizer_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.BasicFaceRecognizer)storeResult.Value).wrappedObject = OpenCVForUnity.Face.createEigenFaceRecognizer (num_components.Value, (float)threshold.Value);
