...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static MACE load(string filename, string objname)")]
    ...
    public class MACE_load : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.MACE)storeResult.Value).wrappedObject = OpenCVForUnity.FaceModule.MACE.load(filename.Value, objname.Value);
