...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Face_createFisherFaceRecognizer : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.BasicFaceRecognizer)storeResult.Value).wrappedObject = OpenCVForUnity.Face.createFisherFaceRecognizer (num_components.Value, wrapped_threshold);
