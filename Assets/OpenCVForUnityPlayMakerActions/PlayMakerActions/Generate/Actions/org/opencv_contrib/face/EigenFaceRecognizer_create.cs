...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class EigenFaceRecognizer_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.EigenFaceRecognizer)storeResult.Value).wrappedObject = OpenCVForUnity.EigenFaceRecognizer.create (num_components.Value, wrapped_threshold);
