...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class Face_createLBPHFaceRecognizer : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.LBPHFaceRecognizer)storeResult.Value).wrappedObject = OpenCVForUnity.Face.createLBPHFaceRecognizer (radius.Value, neighbors.Value, grid_x.Value, grid_y.Value, wrapped_threshold);
