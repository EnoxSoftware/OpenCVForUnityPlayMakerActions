...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class LBPHFaceRecognizer_create_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.LBPHFaceRecognizer)storeResult.Value).wrappedObject = OpenCVForUnity.LBPHFaceRecognizer.create (radius.Value, neighbors.Value, grid_x.Value);
