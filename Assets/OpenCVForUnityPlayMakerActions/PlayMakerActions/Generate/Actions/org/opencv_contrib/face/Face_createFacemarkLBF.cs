...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static Facemark createFacemarkLBF ()")]
    [HutongGames.PlayMaker.ActionTarget (typeof (OpenCVForUnityPlayMakerActions.Facemark), "storeResult")]
    public class Face_createFacemarkLBF : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Facemark)storeResult.Value).wrappedObject = OpenCVForUnity.FaceModule.Face.createFacemarkLBF ();
