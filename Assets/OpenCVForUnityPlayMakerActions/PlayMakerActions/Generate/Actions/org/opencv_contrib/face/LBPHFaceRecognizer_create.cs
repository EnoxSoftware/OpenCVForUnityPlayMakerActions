...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class LBPHFaceRecognizer_create : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.LBPHFaceRecognizer)storeResult.Value).wrappedObject = OpenCVForUnity.LBPHFaceRecognizer.create (radius.Value, neighbors.Value, grid_x.Value, grid_y.Value, wrapped_threshold);
