...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class FisherFaceRecognizer_create_C : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.FisherFaceRecognizer)storeResult.Value).wrappedObject = OpenCVForUnity.FisherFaceRecognizer.create (num_components.Value, (float)threshold.Value);
