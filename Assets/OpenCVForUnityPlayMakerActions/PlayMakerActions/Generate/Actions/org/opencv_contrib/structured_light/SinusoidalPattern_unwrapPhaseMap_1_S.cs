...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class SinusoidalPattern_unwrapPhaseMap_1_S : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            wrapped_owner.unwrapPhaseMap (wrapped_wrappedPhaseMap, wrapped_unwrappedPhaseMap, new OpenCVForUnity.Size ((double)camSize_width.Value, (double)camSize_height.Value));
