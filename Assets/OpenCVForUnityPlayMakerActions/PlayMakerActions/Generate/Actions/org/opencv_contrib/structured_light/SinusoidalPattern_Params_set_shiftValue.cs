...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_shiftValue(float shiftValue)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.SinusoidalPattern_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmFloat), "shiftValue")]
    public class SinusoidalPattern_Params_set_shiftValue : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmFloat shiftValue;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_shiftValue(shiftValue.Value);
