...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_setMarkers(bool setMarkers)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.SinusoidalPattern_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmBool), "setMarkers")]
    public class SinusoidalPattern_Params_set_setMarkers : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmBool setMarkers;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_setMarkers(setMarkers.Value);
