...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public void set_nbrOfPixelsBetweenMarkers(int nbrOfPixelsBetweenMarkers)")]
    [HutongGames.PlayMaker.ActionTarget(typeof(OpenCVForUnityPlayMakerActions.SinusoidalPattern_Params), "owner")]
    [HutongGames.PlayMaker.ActionTarget(typeof(HutongGames.PlayMaker.FsmInt), "nbrOfPixelsBetweenMarkers")]
    public class SinusoidalPattern_Params_set_nbrOfPixelsBetweenMarkers : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        public HutongGames.PlayMaker.FsmInt nbrOfPixelsBetweenMarkers;
        ...
        void DoProcess()
        {
            ...
            wrapped_owner.set_nbrOfPixelsBetweenMarkers(nbrOfPixelsBetweenMarkers.Value);
