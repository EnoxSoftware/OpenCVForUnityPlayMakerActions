...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void texture2DToMat (Texture2D texture2D, Mat mat)")]
    ...
    public class Utils_texture2DToMat : HutongGames.PlayMaker.FsmStateAction
    {
