...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip("public static void matToTexture2D (Mat mat, Texture2D texture2D)")]
    ...
    public class Utils_matToTexture2D : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess()
        {
            ...
            Utils.matToTexture2D(wrapped_mat, texture2D.Value as Texture2D);
