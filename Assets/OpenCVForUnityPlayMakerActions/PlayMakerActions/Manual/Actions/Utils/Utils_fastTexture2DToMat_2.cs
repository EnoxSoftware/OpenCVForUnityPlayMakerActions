...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    [HutongGames.PlayMaker.Tooltip ("public static void fastTexture2DToMat (Texture2D texture2D, Mat mat, bool flip = true, int flipCode = 0)")]
    ...
    public class Utils_fastTexture2DToMat_2 : HutongGames.PlayMaker.FsmStateAction
    {
        ...
        void DoProcess ()
        {
            ...
            Utils.fastTexture2DToMat (texture2D.Value as Texture2D, wrapped_mat, flip.Value, flipCode.Value);
