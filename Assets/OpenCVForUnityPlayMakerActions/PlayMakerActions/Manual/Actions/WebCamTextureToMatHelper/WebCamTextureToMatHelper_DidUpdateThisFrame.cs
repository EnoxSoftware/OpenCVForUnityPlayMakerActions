...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class WebCamTextureToMatHelper_DidUpdateThisFrame : WebCamTextureToHelperComponentAction<WebCamTextureToMatHelper>
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = webCamTextureToMatHelper.DidUpdateThisFrame ();
