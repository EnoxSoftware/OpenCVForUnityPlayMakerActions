...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class OptimizationWebCamTextureToMatHelper_Initialize_1 : OptimizationWebCamTextureToHelperComponentAction<OptimizationWebCamTextureToMatHelper>
    {
        ...
        void DoProcess ()
        {
            ...
            optimizationWebCamTextureToMatHelper.Initialize (deviceName.Value, requestedWidth.Value, requestedHeight.Value, requestedIsFrontFacing.Value, requestedFPS.Value);
