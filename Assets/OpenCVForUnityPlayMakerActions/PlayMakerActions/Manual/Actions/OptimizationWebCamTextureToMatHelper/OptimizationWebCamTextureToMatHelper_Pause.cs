...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class OptimizationWebCamTextureToMatHelper_Pause : OptimizationWebCamTextureToHelperComponentAction<OptimizationWebCamTextureToMatHelper>
    {
        ...
        void DoProcess ()
        {
            ...
            optimizationWebCamTextureToMatHelper.Pause ();
