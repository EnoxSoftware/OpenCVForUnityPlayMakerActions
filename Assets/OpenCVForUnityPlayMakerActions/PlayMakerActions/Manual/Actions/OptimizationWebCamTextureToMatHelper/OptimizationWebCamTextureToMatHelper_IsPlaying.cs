...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class OptimizationWebCamTextureToMatHelper_IsPlaying : OptimizationWebCamTextureToHelperComponentAction<OptimizationWebCamTextureToMatHelper>
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = optimizationWebCamTextureToMatHelper.IsPlaying ();
