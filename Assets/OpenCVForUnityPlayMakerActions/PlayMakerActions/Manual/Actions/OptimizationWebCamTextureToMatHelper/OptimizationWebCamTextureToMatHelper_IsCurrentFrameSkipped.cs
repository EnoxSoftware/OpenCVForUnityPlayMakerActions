...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class OptimizationWebCamTextureToMatHelper_IsCurrentFrameSkipped : OptimizationWebCamTextureToHelperComponentAction<OptimizationWebCamTextureToMatHelper>
    {
        ...
        void DoProcess ()
        {
            ...
            storeResult.Value = optimizationWebCamTextureToMatHelper.IsCurrentFrameSkipped ();
