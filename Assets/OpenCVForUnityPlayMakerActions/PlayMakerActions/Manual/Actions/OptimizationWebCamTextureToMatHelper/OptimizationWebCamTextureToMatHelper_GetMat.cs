...
namespace OpenCVForUnityPlayMakerActions
{
    ...
    public class OptimizationWebCamTextureToMatHelper_GetMat : OptimizationWebCamTextureToHelperComponentAction<OptimizationWebCamTextureToMatHelper>
    {
        ...
        void DoProcess ()
        {
            ...
            ((OpenCVForUnityPlayMakerActions.Mat)storeResult.Value).wrappedObject = optimizationWebCamTextureToMatHelper.GetMat ();
